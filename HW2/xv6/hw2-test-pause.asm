...
_hw2-test-pause:     file format elf32-i386
...
inline void handle_error(const char *msg) {
  ...
  45:	a1 28 09 00 00       	mov    0x928,%eax
...
inline void check_arg_integer(const struct record *r, int v) {
  ...
  69:	83 38 01             	cmpl   $0x1,(%eax)
  6c:	75 08                	jne    76 <check_arg_integer+0x16>
  6e:	8b 55 0c             	mov    0xc(%ebp),%edx
  71:	39 50 04             	cmp    %edx,0x4(%eax)
  74:	74 22                	je     98 <check_arg_integer+0x38>
  // corresponding system call.
  return 0;
}
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
  76:	a1 28 09 00 00       	mov    0x928,%eax
  7b:	c7 44 24 08 69 08 00 	movl   $0x869,0x8(%esp)
  82:	00 
  83:	c7 44 24 04 65 08 00 	movl   $0x865,0x4(%esp)
  8a:	00 
  8b:	89 04 24             	mov    %eax,(%esp)
  8e:	e8 fd 04 00 00       	call   590 <printf>
  exit();
  93:	e8 a0 03 00 00       	call   438 <exit>
}
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
  b7:	a1 28 09 00 00       	mov    0x928,%eax
  bc:	c7 44 24 08 81 08 00 	movl   $0x881,0x8(%esp)
  c3:	00 
  c4:	c7 44 24 04 65 08 00 	movl   $0x865,0x4(%esp)
  cb:	00 
  cc:	89 04 24             	mov    %eax,(%esp)
  cf:	e8 bc 04 00 00       	call   590 <printf>
  exit();
  d4:	e8 5f 03 00 00       	call   438 <exit>
...
inline void check_ret_value(const struct record *r, int v) {
  ...
  if (r->type != RET_VALUE || r->value.intval != v)
  f9:	83 38 04             	cmpl   $0x4,(%eax)
  fc:	75 08                	jne    106 <check_ret_value+0x16>
  fe:	8b 55 0c             	mov    0xc(%ebp),%edx
 101:	39 50 04             	cmp    %edx,0x4(%eax)
 104:	74 22                	je     128 <check_ret_value+0x38>
  // corresponding system call.
  return 0;
}
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
 106:	a1 28 09 00 00       	mov    0x928,%eax
 10b:	c7 44 24 08 98 08 00 	movl   $0x898,0x8(%esp)
 112:	00 
 113:	c7 44 24 04 65 08 00 	movl   $0x865,0x4(%esp)
 11a:	00 
 11b:	89 04 24             	mov    %eax,(%esp)
 11e:	e8 6d 04 00 00       	call   590 <printf>
  exit();
 123:	e8 10 03 00 00       	call   438 <exit>
}
...
inline void check_arg_string(const struct record *r, char *s) {
 ...
 14b:	e8 10 01 00 00       	call   260 <strcmp>
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
 154:	a1 28 09 00 00       	mov    0x928,%eax
 159:	c7 44 24 08 ae 08 00 	movl   $0x8ae,0x8(%esp)
 160:	00 
 161:	c7 44 24 04 65 08 00 	movl   $0x865,0x4(%esp)
 168:	00 
 169:	89 04 24             	mov    %eax,(%esp)
 16c:	e8 1f 04 00 00       	call   590 <printf>
  exit();
 171:	e8 c2 02 00 00       	call   438 <exit>
}
...
inline void check_arg_pointer(const struct record *r, void *p) {
 ...
 19a:	c7 44 24 04 c5 08 00 	movl   $0x8c5,0x4(%esp)
 1a1:	00 
 1a2:	89 44 24 08          	mov    %eax,0x8(%esp)
 1a6:	a1 28 09 00 00       	mov    0x928,%eax
 1ab:	89 04 24             	mov    %eax,(%esp)
 1ae:	e8 dd 03 00 00       	call   590 <printf>
  // corresponding system call.
  return 0;
}
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
 1b3:	a1 28 09 00 00       	mov    0x928,%eax
 1b8:	c7 44 24 08 dd 08 00 	movl   $0x8dd,0x8(%esp)
 1bf:	00 
 1c0:	c7 44 24 04 65 08 00 	movl   $0x865,0x4(%esp)
 1c7:	00 
 1c8:	89 04 24             	mov    %eax,(%esp)
 1cb:	e8 c0 03 00 00       	call   590 <printf>
  exit();
 1d0:	e8 63 02 00 00       	call   438 <exit>
...
int main(int argc, char *argv[]) {
 ...
 1ee:	83 ec 14             	sub    $0x14,%esp
  ...
  pid = getpid();
 1f1:	e8 c2 02 00 00       	call   4b8 <getpid>
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
 202:	a1 28 09 00 00       	mov    0x928,%eax
 207:	c7 44 24 08 f5 08 00 	movl   $0x8f5,0x8(%esp)
 20e:	00 
 20f:	c7 44 24 04 65 08 00 	movl   $0x865,0x4(%esp)
 216:	00 
 217:	89 04 24             	mov    %eax,(%esp)
 21a:	e8 71 03 00 00       	call   590 <printf>
  exit();
 21f:	e8 14 02 00 00       	call   438 <exit>
 224:	90                   	nop    
 225:	90                   	nop    
 226:	90                   	nop    
 227:	90                   	nop    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 53d:	0f b6 82 13 09 00 00 	movzbl 0x913(%edx),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 678:	89 4d f0             	mov    %ecx,-0x10(%ebp)
        if(s == 0)
 67b:	b9 0c 09 00 00       	mov    $0x90c,%ecx
...
free(void *ap)
{
 ...
 711:	8b 0d 34 09 00 00    	mov    0x934,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 75c:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 75d:	89 0d 34 09 00 00    	mov    %ecx,0x934
}
 763:	c3                   	ret    
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 ...
 784:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 785:	89 0d 34 09 00 00    	mov    %ecx,0x934
}
 78b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 15 34 09 00 00    	mov    0x934,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
malloc(uint nbytes)
{
 ...
 7bc:	8d 3c dd 00 00 00 00 	lea    0x0(,%ebx,8),%edi
    ...
    if(p == freep)
 7c3:	3b 0d 34 09 00 00    	cmp    0x934,%ecx
 ...
 7e2:	89 59 04             	mov    %ebx,0x4(%ecx)
      ...
      freep = prevp;
 7e5:	89 15 34 09 00 00    	mov    %edx,0x934
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 818:	e8 f3 fe ff ff       	call   710 <free>
  return freep;
 81d:	8b 15 34 09 00 00    	mov    0x934,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
...
morecore(uint nu)
{
 ...
 83b:	eb a8                	jmp    7e5 <malloc+0x55>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 83d:	ba 2c 09 00 00       	mov    $0x92c,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 842:	c7 05 34 09 00 00 2c 	movl   $0x92c,0x934
 849:	09 00 00 
 84c:	c7 05 2c 09 00 00 2c 	movl   $0x92c,0x92c
 853:	09 00 00 
    base.s.size = 0;
 856:	c7 05 30 09 00 00 00 	movl   $0x0,0x930
 85d:	00 00 00 
