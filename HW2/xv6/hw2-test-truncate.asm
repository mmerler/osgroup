...
_hw2-test-truncate:     file format elf32-i386
...
inline void handle_error(const char *msg) {
  ...
  39:	c7 44 24 04 55 08 00 	movl   $0x855,0x4(%esp)
  40:	00 
  41:	89 44 24 08          	mov    %eax,0x8(%esp)
  45:	a1 18 09 00 00       	mov    0x918,%eax
...
inline void check_arg_string(const struct record *r, char *s) {
  ...
  7b:	e8 d0 01 00 00       	call   250 <strcmp>
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
  84:	a1 18 09 00 00       	mov    0x918,%eax
  89:	c7 44 24 08 59 08 00 	movl   $0x859,0x8(%esp)
  90:	00 
  91:	c7 44 24 04 55 08 00 	movl   $0x855,0x4(%esp)
  98:	00 
  99:	89 04 24             	mov    %eax,(%esp)
  9c:	e8 df 04 00 00       	call   580 <printf>
  exit();
  a1:	e8 82 03 00 00       	call   428 <exit>
}
...
inline void check_arg_pointer(const struct record *r, void *p) {
  ...
  ca:	c7 44 24 04 70 08 00 	movl   $0x870,0x4(%esp)
  d1:	00 
  d2:	89 44 24 08          	mov    %eax,0x8(%esp)
  d6:	a1 18 09 00 00       	mov    0x918,%eax
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
  e3:	a1 18 09 00 00       	mov    0x918,%eax
  e8:	c7 44 24 08 88 08 00 	movl   $0x888,0x8(%esp)
  ef:	00 
  f0:	c7 44 24 04 55 08 00 	movl   $0x855,0x4(%esp)
  f7:	00 
  f8:	89 04 24             	mov    %eax,(%esp)
  fb:	e8 80 04 00 00       	call   580 <printf>
  exit();
 100:	e8 23 03 00 00       	call   428 <exit>
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
 126:	a1 18 09 00 00       	mov    0x918,%eax
 12b:	c7 44 24 08 a0 08 00 	movl   $0x8a0,0x8(%esp)
 132:	00 
 133:	c7 44 24 04 55 08 00 	movl   $0x855,0x4(%esp)
 13a:	00 
 13b:	89 04 24             	mov    %eax,(%esp)
 13e:	e8 3d 04 00 00       	call   580 <printf>
  exit();
 143:	e8 e0 02 00 00       	call   428 <exit>
}
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
 166:	a1 18 09 00 00       	mov    0x918,%eax
 16b:	c7 44 24 08 b8 08 00 	movl   $0x8b8,0x8(%esp)
 172:	00 
 173:	c7 44 24 04 55 08 00 	movl   $0x855,0x4(%esp)
 17a:	00 
 17b:	89 04 24             	mov    %eax,(%esp)
 17e:	e8 fd 03 00 00       	call   580 <printf>
  exit();
 183:	e8 a0 02 00 00       	call   428 <exit>
}
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
 1a7:	a1 18 09 00 00       	mov    0x918,%eax
 1ac:	c7 44 24 08 ce 08 00 	movl   $0x8ce,0x8(%esp)
 1b3:	00 
 1b4:	c7 44 24 04 55 08 00 	movl   $0x855,0x4(%esp)
 1bb:	00 
 1bc:	89 04 24             	mov    %eax,(%esp)
 1bf:	e8 bc 03 00 00       	call   580 <printf>
  exit();
 1c4:	e8 5f 02 00 00       	call   428 <exit>
...
int main(int argc, char *argv[]) {
 ...
 1ee:	83 ec 14             	sub    $0x14,%esp
  ...
  pid = getpid();
 1f1:	e8 b2 02 00 00       	call   4a8 <getpid>
  // corresponding system call.
  return 0;
}
...
inline void handle_error(const char *msg) {
  printf(stderr, "%s\n", msg);
 1f6:	a1 18 09 00 00       	mov    0x918,%eax
 1fb:	c7 44 24 08 e5 08 00 	movl   $0x8e5,0x8(%esp)
 202:	00 
 203:	c7 44 24 04 55 08 00 	movl   $0x855,0x4(%esp)
 20a:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 52d:	0f b6 82 03 09 00 00 	movzbl 0x903(%edx),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 668:	89 4d f0             	mov    %ecx,-0x10(%ebp)
        if(s == 0)
 66b:	b9 fc 08 00 00       	mov    $0x8fc,%ecx
...
free(void *ap)
{
 ...
 701:	8b 0d 24 09 00 00    	mov    0x924,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 74c:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 74d:	89 0d 24 09 00 00    	mov    %ecx,0x924
}
 753:	c3                   	ret    
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 ...
 774:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 775:	89 0d 24 09 00 00    	mov    %ecx,0x924
}
 77b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7ac:	8d 3c dd 00 00 00 00 	lea    0x0(,%ebx,8),%edi
    ...
    if(p == freep)
 7b3:	3b 0d 24 09 00 00    	cmp    0x924,%ecx
 ...
 7d2:	89 59 04             	mov    %ebx,0x4(%ecx)
      ...
      freep = prevp;
 7d5:	89 15 24 09 00 00    	mov    %edx,0x924
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 808:	e8 f3 fe ff ff       	call   700 <free>
  return freep;
 80d:	8b 15 24 09 00 00    	mov    0x924,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
...
morecore(uint nu)
{
 ...
 82b:	eb a8                	jmp    7d5 <malloc+0x55>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 82d:	ba 1c 09 00 00       	mov    $0x91c,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 832:	c7 05 24 09 00 00 1c 	movl   $0x91c,0x924
 839:	09 00 00 
 83c:	c7 05 1c 09 00 00 1c 	movl   $0x91c,0x91c
 843:	09 00 00 
    base.s.size = 0;
 846:	c7 05 20 09 00 00 00 	movl   $0x0,0x920
 84d:	00 00 00 
