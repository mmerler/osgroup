...
_hw5-test-simple:     file format elf32-i386
...
inline __attribute__((noreturn)) void panic(const char *msg) {
  ...
  15:	a1 f0 07 00 00       	mov    0x7f0,%eax
...
int main(int argc, char *argv[]) {
  ...
  40:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  43:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  46:	89 75 fc             	mov    %esi,-0x4(%ebp)
  int pid;
  int child_pid;
  
  pid = getpid();
  49:	e8 4a 03 00 00       	call   398 <getpid>
  4e:	89 c6                	mov    %eax,%esi
  child_pid = fork();
  50:	e8 bb 02 00 00       	call   310 <fork>
...
int main(int argc, char *argv[]) {
  ...
  if (child_pid == -1)
  5a:	74 4c                	je     a8 <main+0x78>
    panic("fork");

  if (child_pid == 0) {
  5c:	85 c0                	test   %eax,%eax
  5e:	74 52                	je     b2 <main+0x82>
...
inline __attribute__((noreturn)) void panic(const char *msg) {
  printf(stderr, "[panic] %s\n", msg);
  86:	c7 44 24 08 ac 07 00 	movl   $0x7ac,0x8(%esp)
  8d:	00 
  exit();
  8e:	a1 f0 07 00 00       	mov    0x7f0,%eax
  93:	c7 44 24 04 48 07 00 	movl   $0x748,0x4(%esp)
  9a:	00 
  9b:	89 04 24             	mov    %eax,(%esp)
  9e:	e8 cd 03 00 00       	call   470 <printf>
...
inline __attribute__((noreturn)) void panic(const char *msg) {
  printf(stderr, "[panic] %s\n", msg);
  a8:	c7 44 24 08 54 07 00 	movl   $0x754,0x8(%esp)
  af:	00 
  b0:	eb dc                	jmp    8e <main+0x5e>
    panic("fork");
  ...
  if (child_pid == 0) {
    ...
    int fd = open("child-succ", O_CREATE);
  b2:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
  b9:	00 
  ba:	c7 04 24 59 07 00 00 	movl   $0x759,(%esp)
  c1:	e8 92 02 00 00       	call   358 <open>
    close(fd);
  c6:	89 04 24             	mov    %eax,(%esp)
  c9:	e8 72 02 00 00       	call   340 <close>
    exit();
  ce:	e8 45 02 00 00       	call   318 <exit>
  d3:	c7 44 24 08 64 07 00 	movl   $0x764,0x8(%esp)
  da:	00 
  db:	eb b1                	jmp    8e <main+0x5e>
  ...
  close(fd);
  dd:	c7 44 24 08 82 07 00 	movl   $0x782,0x8(%esp)
  e4:	00 
  e5:	eb a7                	jmp    8e <main+0x5e>
  e7:	89 04 24             	mov    %eax,(%esp)
  ea:	e8 51 02 00 00       	call   340 <close>
  printf(stdout, "hw5-test-simple succeeded\n");
  ef:	a1 ec 07 00 00       	mov    0x7ec,%eax
  f4:	c7 44 24 04 8e 07 00 	movl   $0x78e,0x4(%esp)
  fb:	00 
  fc:	89 04 24             	mov    %eax,(%esp)
  ff:	e8 6c 03 00 00       	call   470 <printf>

  exit();
 104:	e8 0f 02 00 00       	call   318 <exit>
 109:	90                   	nop    
 10a:	90                   	nop    
 10b:	90                   	nop    
 10c:	90                   	nop    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41d:	0f b6 82 db 07 00 00 	movzbl 0x7db(%edx),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 558:	89 4d f0             	mov    %ecx,-0x10(%ebp)
        if(s == 0)
 55b:	b9 d4 07 00 00       	mov    $0x7d4,%ecx
...
free(void *ap)
{
 ...
 5f1:	8b 0d 00 08 00 00    	mov    0x800,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 63c:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	89 0d 00 08 00 00    	mov    %ecx,0x800
}
 643:	c3                   	ret    
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 ...
 664:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 665:	89 0d 00 08 00 00    	mov    %ecx,0x800
}
 66b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 00 08 00 00    	mov    0x800,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
malloc(uint nbytes)
{
 ...
 69c:	8d 3c dd 00 00 00 00 	lea    0x0(,%ebx,8),%edi
    ...
    if(p == freep)
 6a3:	3b 0d 00 08 00 00    	cmp    0x800,%ecx
 ...
 6c2:	89 59 04             	mov    %ebx,0x4(%ecx)
      ...
      freep = prevp;
 6c5:	89 15 00 08 00 00    	mov    %edx,0x800
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 6f8:	e8 f3 fe ff ff       	call   5f0 <free>
  return freep;
 6fd:	8b 15 00 08 00 00    	mov    0x800,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
...
morecore(uint nu)
{
 ...
 71b:	eb a8                	jmp    6c5 <malloc+0x55>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 71d:	ba f8 07 00 00       	mov    $0x7f8,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 722:	c7 05 00 08 00 00 f8 	movl   $0x7f8,0x800
 729:	07 00 00 
 72c:	c7 05 f8 07 00 00 f8 	movl   $0x7f8,0x7f8
 733:	07 00 00 
    base.s.size = 0;
 736:	c7 05 fc 07 00 00 00 	movl   $0x0,0x7fc
 73d:	00 00 00 
