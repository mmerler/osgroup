...
main(int argc, char *argv[])
{
  ...
  35:	e8 a6 03 00 00       	call   3e0 <printf>
    exit();
  ...
  4c:	e8 9f 02 00 00       	call   2f0 <mkdir>
  ...
  exit();
  5f:	e8 24 02 00 00       	call   288 <exit>
    exit();
  }
  ...
  66:	c7 44 24 04 cc 06 00 	movl   $0x6cc,0x4(%esp)
  6d:	00 
  6e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  75:	89 44 24 08          	mov    %eax,0x8(%esp)
  79:	e8 62 03 00 00       	call   3e0 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38d:	0f b6 82 ef 06 00 00 	movzbl 0x6ef(%edx),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 4c8:	89 4d f0             	mov    %ecx,-0x10(%ebp)
        if(s == 0)
 4cb:	b9 e8 06 00 00       	mov    $0x6e8,%ecx
...
free(void *ap)
{
 ...
 561:	8b 0d 08 07 00 00    	mov    0x708,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5ac:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 5ad:	89 0d 08 07 00 00    	mov    %ecx,0x708
}
 5b3:	c3                   	ret    
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 ...
 5d4:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 5d5:	89 0d 08 07 00 00    	mov    %ecx,0x708
}
 5db:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 5e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5ec:	8b 15 08 07 00 00    	mov    0x708,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
malloc(uint nbytes)
{
 ...
 60c:	8d 3c dd 00 00 00 00 	lea    0x0(,%ebx,8),%edi
    ...
    if(p == freep)
 613:	3b 0d 08 07 00 00    	cmp    0x708,%ecx
 ...
 632:	89 59 04             	mov    %ebx,0x4(%ecx)
      ...
      freep = prevp;
 635:	89 15 08 07 00 00    	mov    %edx,0x708
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 668:	e8 f3 fe ff ff       	call   560 <free>
  return freep;
 66d:	8b 15 08 07 00 00    	mov    0x708,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
...
morecore(uint nu)
{
 ...
 68b:	eb a8                	jmp    635 <malloc+0x55>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 68d:	ba 00 07 00 00       	mov    $0x700,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 692:	c7 05 08 07 00 00 00 	movl   $0x700,0x708
 699:	07 00 00 
 69c:	c7 05 00 07 00 00 00 	movl   $0x700,0x700
 6a3:	07 00 00 
    base.s.size = 0;
 6a6:	c7 05 04 07 00 00 00 	movl   $0x0,0x704
 6ad:	00 00 00 
