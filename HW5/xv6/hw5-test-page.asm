...
_hw5-test-page:     file format elf32-i386
...
inline __attribute__((noreturn)) void panic(const char *msg) {
  ...
  printf(stderr, "[panic] %s\n", msg);
   ...
   9:	c7 44 24 04 48 07 00 	movl   $0x748,0x4(%esp)
  10:	00 
  11:	89 44 24 08          	mov    %eax,0x8(%esp)
  15:	a1 04 08 00 00       	mov    0x804,%eax
  1a:	89 04 24             	mov    %eax,(%esp)
  1d:	e8 4e 04 00 00       	call   470 <printf>
  exit();
  22:	e8 f1 02 00 00       	call   318 <exit>
...
int main() {
  ...
  44:	e8 6f 03 00 00       	call   3b8 <freepages>
  49:	89 c6                	mov    %eax,%esi
  child_pid = fork();
  4b:	e8 c0 02 00 00       	call   310 <fork>
  if (child_pid == -1)
  50:	83 f8 ff             	cmp    $0xffffffff,%eax
  ...
  if (child_pid == -1)
  55:	74 0b                	je     62 <main+0x32>
    panic("fork");
  if (child_pid == 0) {
  57:	85 c0                	test   %eax,%eax
  59:	75 29                	jne    84 <main+0x54>
  5b:	90                   	nop    
  5c:	8d 74 26 00          	lea    0x0(%esi),%esi
  60:	eb f9                	jmp    5b <main+0x2b>
int stdin = 0;
int stdout = 1;
int stderr = 2;
...
inline __attribute__((noreturn)) void panic(const char *msg) {
  printf(stderr, "[panic] %s\n", msg);
  62:	c7 44 24 08 54 07 00 	movl   $0x754,0x8(%esp)
  69:	00 
  exit();
  6a:	a1 04 08 00 00       	mov    0x804,%eax
  6f:	c7 44 24 04 48 07 00 	movl   $0x748,0x4(%esp)
  76:	00 
  77:	89 04 24             	mov    %eax,(%esp)
  7a:	e8 f1 03 00 00       	call   470 <printf>
  7f:	e8 94 02 00 00       	call   318 <exit>
    // Never exits. 
    while (1);
    exit();
  }
  num_after = freepages();
  84:	e8 2f 03 00 00       	call   3b8 <freepages>
  ...
  kill(child_pid);
  8e:	e8 b5 02 00 00       	call   348 <kill>
  if (wait() < 0)
  93:	e8 88 02 00 00       	call   320 <wait>
  98:	85 c0                	test   %eax,%eax
  9a:	79 0a                	jns    a6 <main+0x76>
int stdin = 0;
int stdout = 1;
int stderr = 2;
...
inline __attribute__((noreturn)) void panic(const char *msg) {
  printf(stderr, "[panic] %s\n", msg);
  9c:	c7 44 24 08 59 07 00 	movl   $0x759,0x8(%esp)
  a3:	00 
  a4:	eb c4                	jmp    6a <main+0x3a>
    panic("wait");

  printf(stdout, "# of free pages before fork() = %d\n", num_before);
  a6:	a1 00 08 00 00       	mov    0x800,%eax
  ab:	89 74 24 08          	mov    %esi,0x8(%esp)
  printf(stdout, "# of free pages after fork() = %d\n", num_after);
  if (num_before - num_after > 20)
  af:	29 fe                	sub    %edi,%esi
  ...
  printf(stdout, "# of free pages before fork() = %d\n", num_before);
  b1:	c7 44 24 04 78 07 00 	movl   $0x778,0x4(%esp)
  b8:	00 
  b9:	89 04 24             	mov    %eax,(%esp)
  bc:	e8 af 03 00 00       	call   470 <printf>
  printf(stdout, "# of free pages after fork() = %d\n", num_after);
  c1:	a1 00 08 00 00       	mov    0x800,%eax
  c6:	89 7c 24 08          	mov    %edi,0x8(%esp)
  ca:	c7 44 24 04 9c 07 00 	movl   $0x79c,0x4(%esp)
  d1:	00 
  d2:	89 04 24             	mov    %eax,(%esp)
  d5:	e8 96 03 00 00       	call   470 <printf>
  if (num_before - num_after > 20)
  da:	83 fe 14             	cmp    $0x14,%esi
  dd:	7e 17                	jle    f6 <main+0xc6>
    printf(stdout, "Too many pages allocated when forking.\n");
  df:	a1 00 08 00 00       	mov    0x800,%eax
  e4:	c7 44 24 04 c0 07 00 	movl   $0x7c0,0x4(%esp)
  eb:	00 
  ec:	89 04 24             	mov    %eax,(%esp)
  ef:	e8 7c 03 00 00       	call   470 <printf>
  f4:	eb 89                	jmp    7f <main+0x4f>
  else
    printf(stdout, "hw5-test-page succeeded\n");
  f6:	a1 00 08 00 00       	mov    0x800,%eax
  fb:	c7 44 24 04 5e 07 00 	movl   $0x75e,0x4(%esp)
 102:	00 
 103:	89 04 24             	mov    %eax,(%esp)
 106:	e8 65 03 00 00       	call   470 <printf>
 10b:	e9 6f ff ff ff       	jmp    7f <main+0x4f>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41d:	0f b6 82 ef 07 00 00 	movzbl 0x7ef(%edx),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 558:	89 4d f0             	mov    %ecx,-0x10(%ebp)
        if(s == 0)
 55b:	b9 e8 07 00 00       	mov    $0x7e8,%ecx
...
free(void *ap)
{
 ...
 5f1:	8b 0d 2c 08 00 00    	mov    0x82c,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 63c:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	89 0d 2c 08 00 00    	mov    %ecx,0x82c
}
 643:	c3                   	ret    
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 ...
 664:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 665:	89 0d 2c 08 00 00    	mov    %ecx,0x82c
}
 66b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 2c 08 00 00    	mov    0x82c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
malloc(uint nbytes)
{
 ...
 69c:	8d 3c dd 00 00 00 00 	lea    0x0(,%ebx,8),%edi
    ...
    if(p == freep)
 6a3:	3b 0d 2c 08 00 00    	cmp    0x82c,%ecx
 ...
 6c2:	89 59 04             	mov    %ebx,0x4(%ecx)
      ...
      freep = prevp;
 6c5:	89 15 2c 08 00 00    	mov    %edx,0x82c
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 6f8:	e8 f3 fe ff ff       	call   5f0 <free>
  return freep;
 6fd:	8b 15 2c 08 00 00    	mov    0x82c,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
...
morecore(uint nu)
{
 ...
 71b:	eb a8                	jmp    6c5 <malloc+0x55>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 71d:	ba 24 08 00 00       	mov    $0x824,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 722:	c7 05 2c 08 00 00 24 	movl   $0x824,0x82c
 729:	08 00 00 
 72c:	c7 05 24 08 00 00 24 	movl   $0x824,0x824
 733:	08 00 00 
    base.s.size = 0;
 736:	c7 05 28 08 00 00 00 	movl   $0x0,0x828
 73d:	00 00 00 
