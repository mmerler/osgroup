...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 ec 06 00 	movl   $0x6ec,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ad:	0f b6 82 0f 07 00 00 	movzbl 0x70f(%edx),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 4e8:	89 4d f0             	mov    %ecx,-0x10(%ebp)
        if(s == 0)
 4eb:	b9 08 07 00 00       	mov    $0x708,%ecx
...
free(void *ap)
{
 ...
 581:	8b 0d 28 07 00 00    	mov    0x728,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5cc:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 5cd:	89 0d 28 07 00 00    	mov    %ecx,0x728
}
 5d3:	c3                   	ret    
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 ...
 5f4:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 5f5:	89 0d 28 07 00 00    	mov    %ecx,0x728
}
 5fb:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 609:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 60c:	8b 15 28 07 00 00    	mov    0x728,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
malloc(uint nbytes)
{
 ...
 62c:	8d 3c dd 00 00 00 00 	lea    0x0(,%ebx,8),%edi
    ...
    if(p == freep)
 633:	3b 0d 28 07 00 00    	cmp    0x728,%ecx
 ...
 652:	89 59 04             	mov    %ebx,0x4(%ecx)
      ...
      freep = prevp;
 655:	89 15 28 07 00 00    	mov    %edx,0x728
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 688:	e8 f3 fe ff ff       	call   580 <free>
  return freep;
 68d:	8b 15 28 07 00 00    	mov    0x728,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
...
morecore(uint nu)
{
 ...
 6ab:	eb a8                	jmp    655 <malloc+0x55>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 6ad:	ba 20 07 00 00       	mov    $0x720,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6b2:	c7 05 28 07 00 00 20 	movl   $0x720,0x728
 6b9:	07 00 00 
 6bc:	c7 05 20 07 00 00 20 	movl   $0x720,0x720
 6c3:	07 00 00 
    base.s.size = 0;
 6c6:	c7 05 24 07 00 00 00 	movl   $0x0,0x724
 6cd:	00 00 00 
