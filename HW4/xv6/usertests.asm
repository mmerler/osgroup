...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
      16:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
      1b:	c7 44 24 04 58 37 00 	movl   $0x3758,0x4(%esp)
      22:	00 
      23:	89 04 24             	mov    %eax,(%esp)
      26:	e8 55 34 00 00       	call   3480 <printf>
  fd = open("echo", 0);
      2b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
      32:	00 
      33:	c7 04 24 63 37 00 00 	movl   $0x3763,(%esp)
  ...
  fd = open("doesnotexist", 0);
      ...
      52:	00 
      53:	c7 04 24 7b 37 00 00 	movl   $0x377b,(%esp)
  ...
  printf(stdout, "open test ok\n");
      63:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
      68:	c7 44 24 04 a6 37 00 	movl   $0x37a6,0x4(%esp)
      6f:	00 
      70:	89 04 24             	mov    %eax,(%esp)
      73:	e8 08 34 00 00       	call   3480 <printf>
}
      78:	c9                   	leave  
      79:	c3                   	ret    
  int fd;
  ...
  if(fd < 0){
    printf(stdout, "open echo failed!\n");
      7a:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
      7f:	c7 44 24 04 68 37 00 	movl   $0x3768,0x4(%esp)
      86:	00 
      87:	89 04 24             	mov    %eax,(%esp)
      8a:	e8 f1 33 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd >= 0){
    printf(stdout, "open doesnotexist succeeded!\n");
      94:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
      99:	c7 44 24 04 88 37 00 	movl   $0x3788,0x4(%esp)
      a0:	00 
      a1:	89 04 24             	mov    %eax,(%esp)
      a4:	e8 d7 33 00 00       	call   3480 <printf>
    exit();
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
      b9:	c7 44 24 04 b4 37 00 	movl   $0x37b4,0x4(%esp)
      c0:	00 
      c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
      c8:	e8 b3 33 00 00       	call   3480 <printf>
      ...
      d0:	74 68                	je     13a <forktest+0x8a>
{
  ...
  printf(1, "fork test OK\n");
     10c:	c7 44 24 04 e6 37 00 	movl   $0x37e6,0x4(%esp)
     113:	00 
     114:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     11b:	e8 60 33 00 00       	call   3480 <printf>
}
  ...
  for(; n > 0; n--){
    if(wait() < 0){
      printf(1, "wait stopped early\n");
     126:	c7 44 24 04 bf 37 00 	movl   $0x37bf,0x4(%esp)
     12d:	00 
     12e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     135:	e8 46 33 00 00       	call   3480 <printf>
      exit();
  ...
  if(n == 1000){
    printf(1, "fork claimed to work 1000 times!\n");
     13f:	c7 44 24 04 30 45 00 	movl   $0x4530,0x4(%esp)
     146:	00 
     147:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     14e:	e8 2d 33 00 00       	call   3480 <printf>
  }
  ...
  if(wait() != -1){
    printf(1, "wait got too many\n");
     158:	c7 44 24 04 d3 37 00 	movl   $0x37d3,0x4(%esp)
     15f:	00 
     160:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     167:	e8 14 33 00 00       	call   3480 <printf>
    exit();
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     1ad:	7d e1                	jge    190 <exitwait+0x10>
      printf(1, "fork failed\n");
     1af:	c7 44 24 04 81 38 00 	movl   $0x3881,0x4(%esp)
     1b6:	00 
     1b7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     1be:	e8 bd 32 00 00       	call   3480 <printf>
    } else {
      exit();
    }
  }
  printf(1, "exitwait ok\n");
    ...
    if(pid){
     ...
     1ca:	c7 44 24 04 f4 37 00 	movl   $0x37f4,0x4(%esp)
     1d1:	00 
     1d2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     1d9:	e8 a2 32 00 00       	call   3480 <printf>
    } else {
      exit();
    }
  }
  ...
  printf(1, "exitwait ok\n");
     1ea:	c7 44 24 04 04 38 00 	movl   $0x3804,0x4(%esp)
     1f1:	00 
     1f2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     1f9:	e8 82 32 00 00       	call   3480 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
     21a:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     21f:	c7 44 24 04 11 38 00 	movl   $0x3811,0x4(%esp)
     226:	00 
     227:	89 04 24             	mov    %eax,(%esp)
     22a:	e8 51 32 00 00       	call   3480 <printf>
    ...
    if (link("nosuchfile", (char*)p) != -1) {
     ...
     25a:	c7 04 24 20 38 00 00 	movl   $0x3820,(%esp)
  ...
  for (p = 0; p <= (uint)hi; p += 4096) {
    ...
    if (link("nosuchfile", (char*)p) != -1) {
      printf(stdout, "link should not succeed\n");
     289:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     28e:	c7 44 24 04 2b 38 00 	movl   $0x382b,0x4(%esp)
     295:	00 
     296:	89 04 24             	mov    %eax,(%esp)
     299:	e8 e2 31 00 00       	call   3480 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
     2a3:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     2a8:	c7 44 24 04 44 38 00 	movl   $0x3844,0x4(%esp)
     2af:	00 
     2b0:	89 04 24             	mov    %eax,(%esp)
     2b3:	e8 c8 31 00 00       	call   3480 <printf>
}
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
     2da:	c7 44 24 04 51 38 00 	movl   $0x3851,0x4(%esp)
     2e1:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
     2e4:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     2e9:	89 04 24             	mov    %eax,(%esp)
     2ec:	e8 8f 31 00 00       	call   3480 <printf>
  ...
  for(i = 0; i < 5000; i++){
    ...
    if(b != a){
     ...
     326:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     32b:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
     32f:	89 74 24 08          	mov    %esi,0x8(%esp)
     333:	c7 44 24 04 5c 38 00 	movl   $0x385c,0x4(%esp)
     33a:	00 
     33b:	89 04 24             	mov    %eax,(%esp)
     33e:	e8 3d 31 00 00       	call   3480 <printf>
      exit();
  ...
  *lastaddr = 99;
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
     43d:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     442:	89 74 24 0c          	mov    %esi,0xc(%esp)
     446:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     44a:	c7 44 24 04 dc 45 00 	movl   $0x45dc,0x4(%esp)
     451:	00 
     452:	89 04 24             	mov    %eax,(%esp)
     455:	e8 26 30 00 00       	call   3480 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    if((pids[i] = fork()) == 0) {
     ...
     543:	00 
     544:	c7 44 24 04 1a 3e 00 	movl   $0x3e1a,0x4(%esp)
     54b:	00 
  ...
  printf(stdout, "sbrk test OK\n");
     5b3:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     5b8:	c7 44 24 04 08 39 00 	movl   $0x3908,0x4(%esp)
     5bf:	00 
     5c0:	89 04 24             	mov    %eax,(%esp)
     5c3:	e8 b8 2e 00 00       	call   3480 <printf>
}
  ...
  if(*lastaddr == 99){
    // should be zero
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
     5d3:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     5d8:	c7 44 24 04 04 46 00 	movl   $0x4604,0x4(%esp)
     5df:	00 
     5e0:	89 04 24             	mov    %eax,(%esp)
     5e3:	e8 98 2e 00 00       	call   3480 <printf>
    exit();
  ...
  if(pid < 0){
    printf(stdout, "sbrk test fork failed\n");
     5ed:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     5f2:	c7 44 24 04 77 38 00 	movl   $0x3877,0x4(%esp)
     5f9:	00 
     5fa:	89 04 24             	mov    %eax,(%esp)
     5fd:	e8 7e 2e 00 00       	call   3480 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c != (char *) 0xffffffff){
    printf(stdout, "sbrk allocated more than 640K, c %x\n", c);
     ...
     60b:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     610:	c7 44 24 04 7c 45 00 	movl   $0x457c,0x4(%esp)
     617:	00 
     618:	89 04 24             	mov    %eax,(%esp)
     61b:	e8 60 2e 00 00       	call   3480 <printf>
    exit();
  ...
  if(c != a + 1){
    printf(stdout, "sbrk test failed post-fork\n");
     625:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     62a:	c7 44 24 04 8e 38 00 	movl   $0x388e,0x4(%esp)
     631:	00 
     632:	89 04 24             	mov    %eax,(%esp)
     635:	e8 46 2e 00 00       	call   3480 <printf>
    exit();
  ...
  if(c != a - 4096){
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
     63f:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     644:	89 54 24 0c          	mov    %edx,0xc(%esp)
     648:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     64c:	c7 44 24 04 a4 45 00 	movl   $0x45a4,0x4(%esp)
     653:	00 
     654:	89 04 24             	mov    %eax,(%esp)
     657:	e8 24 2e 00 00       	call   3480 <printf>
    exit();
  ...
  if(c == (char *) 0xffffffff){
    printf(stdout, "sbrk could not deallocate\n");
     661:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     666:	c7 44 24 04 aa 38 00 	movl   $0x38aa,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 0a 2e 00 00       	call   3480 <printf>
    exit();
  ...
  if(p != a){
    printf(stdout, "sbrk test failed 640K test, p %x a %x\n", p, a);
     ...
     67f:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     684:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
     688:	c7 44 24 04 54 45 00 	movl   $0x4554,0x4(%esp)
     68f:	00 
     690:	89 04 24             	mov    %eax,(%esp)
     693:	e8 e8 2d 00 00       	call   3480 <printf>
  ...
  if(c == (char*)0xffffffff) {
    printf(stdout, "failed sbrk leaked memory\n");
     6b5:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     6ba:	c7 44 24 04 ed 38 00 	movl   $0x38ed,0x4(%esp)
     6c1:	00 
     6c2:	89 04 24             	mov    %eax,(%esp)
     6c5:	e8 b6 2d 00 00       	call   3480 <printf>
    exit();
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
     6cf:	c7 44 24 04 de 38 00 	movl   $0x38de,0x4(%esp)
     6d6:	00 
     6d7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6de:	e8 9d 2d 00 00       	call   3480 <printf>
    exit();
    ...
    if(pid == 0){
     ...
     6ef:	c7 44 24 04 c5 38 00 	movl   $0x38c5,0x4(%esp)
     6f6:	00 
     6f7:	89 44 24 0c          	mov    %eax,0xc(%esp)
     6fb:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     700:	89 04 24             	mov    %eax,(%esp)
     703:	e8 78 2d 00 00       	call   3480 <printf>
      kill(ppid);
  ...
  for(a = (char*)(640*1024); a < (char *)2000000; a += 50000){
    ...
    if(pid < 0){
      printf(stdout, "fork failed\n");
     715:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     71a:	c7 44 24 04 81 38 00 	movl   $0x3881,0x4(%esp)
     721:	00 
     722:	89 04 24             	mov    %eax,(%esp)
     725:	e8 56 2d 00 00       	call   3480 <printf>
      exit();
  ...
  if(c != (char *) 0xffffffff){
    printf(stdout, "sbrk was able to re-allocate beyond 640K, c %x\n", c);
     ...
     733:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
     738:	c7 44 24 04 34 46 00 	movl   $0x4634,0x4(%esp)
     73f:	00 
     740:	89 04 24             	mov    %eax,(%esp)
     743:	e8 38 2d 00 00       	call   3480 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     759:	c7 44 24 04 16 39 00 	movl   $0x3916,0x4(%esp)
     760:	00 
     761:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     768:	e8 13 2d 00 00       	call   3480 <printf>
  pid1 = fork();
     ...
     772:	85 c0                	test   %eax,%eax
{
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     7b8:	00 
     7b9:	c7 44 24 04 1a 3e 00 	movl   $0x3e1a,0x4(%esp)
     7c0:	00 
     ...
     7ce:	c7 44 24 04 20 39 00 	movl   $0x3920,0x4(%esp)
     7d5:	00 
     7d6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7dd:	e8 9e 2c 00 00       	call   3480 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     804:	00 
     805:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
     80c:	00 
    ...
    printf(1, "preempt read error");
     81a:	c7 44 24 04 34 39 00 	movl   $0x3934,0x4(%esp)
     821:	00 
     822:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     829:	e8 52 2c 00 00       	call   3480 <printf>
  printf(1, "wait... ");
  wait();
  wait();
  wait();
  ...
  printf(1, "kill... ");
     841:	c7 44 24 04 47 39 00 	movl   $0x3947,0x4(%esp)
     848:	00 
     849:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     850:	e8 2b 2c 00 00       	call   3480 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     86d:	c7 44 24 04 50 39 00 	movl   $0x3950,0x4(%esp)
     874:	00 
     875:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     87c:	e8 ff 2b 00 00       	call   3480 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     895:	c7 44 24 04 59 39 00 	movl   $0x3959,0x4(%esp)
     89c:	00 
     89d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8a4:	e8 d7 2b 00 00       	call   3480 <printf>
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     ...
     8e1:	be 01 00 00 00       	mov    $0x1,%esi
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     8f4:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
     8fb:	00 
     ...
     911:	38 9a 00 4c 00 00    	cmp    %bl,0x4c00(%edx)
    ...
    while((n = read(fds[0], buf, cc)) > 0){
      for(i = 0; i < n; i++){
        if((buf[i] & 0xff) != (seq++ & 0xff)){
          printf(1, "pipe1 oops 2\n");
     936:	c7 44 24 04 73 39 00 	movl   $0x3973,0x4(%esp)
     93d:	00 
     93e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     945:	e8 36 2b 00 00       	call   3480 <printf>
  } else {
    printf(1, "fork() failed\n");
    exit();
  }
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     966:	88 1d 00 4c 00 00    	mov    %bl,0x4c00
     96c:	8d 74 26 00          	lea    0x0(%esi),%esi
     970:	8d 04 11             	lea    (%ecx,%edx,1),%eax
     973:	88 82 00 4c 00 00    	mov    %al,0x4c00(%edx)
  pid = fork();
  seq = 0;
  if(pid == 0){
    close(fds[0]);
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     98c:	81 c3 09 04 00 00    	add    $0x409,%ebx
        buf[i] = seq++;
      if(write(fds[1], buf, 1033) != 1033){
     992:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
     999:	00 
  ...
  if(pid == 0){
    ...
    if(total != 5 * 1033)
     ...
     9c6:	c7 44 24 04 81 39 00 	movl   $0x3981,0x4(%esp)
     9cd:	00 
     9ce:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9d5:	e8 a6 2a 00 00       	call   3480 <printf>
    close(fds[0]);
  ...
  printf(1, "pipe1 ok\n");
     9ea:	c7 44 24 04 98 39 00 	movl   $0x3998,0x4(%esp)
     9f1:	00 
     9f2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9f9:	e8 82 2a 00 00       	call   3480 <printf>
}
    ...
    for(n = 0; n < 5; n++){
      ...
      if(write(fds[1], buf, 1033) != 1033){
        printf(1, "pipe1 oops 1\n");
     a06:	c7 44 24 04 65 39 00 	movl   $0x3965,0x4(%esp)
     a0d:	00 
     a0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a15:	e8 66 2a 00 00       	call   3480 <printf>
        exit();
     a1a:	e8 e9 28 00 00       	call   3308 <exit>
{
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
     a1f:	c7 44 24 04 de 38 00 	movl   $0x38de,0x4(%esp)
     a26:	00 
     a27:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a2e:	e8 4d 2a 00 00       	call   3480 <printf>
    exit();
    ...
    printf(1, "fork() failed\n");
     a38:	c7 44 24 04 a2 39 00 	movl   $0x39a2,0x4(%esp)
     a3f:	00 
     a40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a47:	e8 34 2a 00 00       	call   3480 <printf>
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
     a66:	c7 44 24 04 b1 39 00 	movl   $0x39b1,0x4(%esp)
     a6d:	00 
     a6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a75:	e8 06 2a 00 00       	call   3480 <printf>

  if(mkdir("12345678901234") != 0){
     a7a:	c7 04 24 ec 39 00 00 	movl   $0x39ec,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
     a8e:	c7 04 24 64 46 00 00 	movl   $0x4664,(%esp)
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
     ...
     aa9:	00 
     aaa:	c7 04 24 b4 46 00 00 	movl   $0x46b4,(%esp)
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
     ...
     acd:	00 
     ace:	c7 04 24 24 47 00 00 	movl   $0x4724,(%esp)
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
     aea:	c7 04 24 dd 39 00 00 	movl   $0x39dd,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
     afe:	c7 04 24 c0 47 00 00 	movl   $0x47c0,(%esp)
  ...
  printf(1, "fourteen ok\n");
     b12:	c7 44 24 04 fb 39 00 	movl   $0x39fb,0x4(%esp)
     b19:	00 
     b1a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b21:	e8 5a 29 00 00       	call   3480 <printf>
}
     b26:	c9                   	leave  
     b27:	c3                   	ret    
  ...
  if(mkdir("12345678901234") != 0){
    printf(1, "mkdir 12345678901234 failed\n");
     b28:	c7 44 24 04 c0 39 00 	movl   $0x39c0,0x4(%esp)
     b2f:	00 
     b30:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b37:	e8 44 29 00 00       	call   3480 <printf>
    exit();
     b3c:	e8 c7 27 00 00       	call   3308 <exit>
  }
  if(mkdir("12345678901234/123456789012345") != 0){
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
     b41:	c7 44 24 04 84 46 00 	movl   $0x4684,0x4(%esp)
     b48:	00 
     b49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b50:	e8 2b 29 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
     b5a:	c7 44 24 04 e4 46 00 	movl   $0x46e4,0x4(%esp)
     b61:	00 
     b62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b69:	e8 12 29 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
     b73:	c7 44 24 04 54 47 00 	movl   $0x4754,0x4(%esp)
     b7a:	00 
     b7b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b82:	e8 f9 28 00 00       	call   3480 <printf>
    exit();
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
     b8c:	c7 44 24 04 90 47 00 	movl   $0x4790,0x4(%esp)
     b93:	00 
     b94:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b9b:	e8 e0 28 00 00       	call   3480 <printf>
    exit();
     ba0:	e8 63 27 00 00       	call   3308 <exit>
  }
  if(mkdir("123456789012345/12345678901234") == 0){
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
     ba5:	c7 44 24 04 e0 47 00 	movl   $0x47e0,0x4(%esp)
     bac:	00 
     bad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bb4:	e8 c7 28 00 00       	call   3480 <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
     bc9:	c7 44 24 04 08 3a 00 	movl   $0x3a08,0x4(%esp)
     bd0:	00 
     bd1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bd8:	e8 a3 28 00 00       	call   3480 <printf>
     bdd:	8d 76 00             	lea    0x0(%esi),%esi

  // the 50 is NINODE
  for(i = 0; i < 50 + 1; i++){
    if(mkdir("irefd") != 0){
     be0:	c7 04 24 19 3a 00 00 	movl   $0x3a19,(%esp)
    ...
    if(chdir("irefd") != 0){
     bf4:	c7 04 24 19 3a 00 00 	movl   $0x3a19,(%esp)
    ...
    mkdir("");
     c08:	c7 04 24 d4 44 00 00 	movl   $0x44d4,(%esp)
     c0f:	e8 5c 27 00 00       	call   3370 <mkdir>
    link("README", "");
     c14:	c7 44 24 04 d4 44 00 	movl   $0x44d4,0x4(%esp)
     c1b:	00 
     c1c:	c7 04 24 47 3a 00 00 	movl   $0x3a47,(%esp)
     c23:	e8 40 27 00 00       	call   3368 <link>
    fd = open("", O_CREATE);
     c28:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
     c2f:	00 
     c30:	c7 04 24 d4 44 00 00 	movl   $0x44d4,(%esp)
    ...
    fd = open("xx", O_CREATE);
     ...
     c4f:	00 
     c50:	c7 04 24 19 3e 00 00 	movl   $0x3e19,(%esp)
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    if(fd >= 0)
      close(fd);
    unlink("xx");
     c6b:	c7 04 24 19 3e 00 00 	movl   $0x3e19,(%esp)
  ...
  chdir("/");
     c80:	c7 04 24 4e 3a 00 00 	movl   $0x3a4e,(%esp)
     c87:	e8 ec 26 00 00       	call   3378 <chdir>
  printf(1, "empty file name OK\n");
     c8c:	c7 44 24 04 50 3a 00 	movl   $0x3a50,0x4(%esp)
     c93:	00 
     c94:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c9b:	e8 e0 27 00 00       	call   3480 <printf>
}
  ...
  for(i = 0; i < 50 + 1; i++){
    if(mkdir("irefd") != 0){
      printf(1, "mkdir irefd failed\n");
     ca6:	c7 44 24 04 1f 3a 00 	movl   $0x3a1f,0x4(%esp)
     cad:	00 
     cae:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb5:	e8 c6 27 00 00       	call   3480 <printf>
      exit();
     cba:	e8 49 26 00 00       	call   3308 <exit>
    }
    if(chdir("irefd") != 0){
      printf(1, "chdir irefd failed\n");
     cbf:	c7 44 24 04 33 3a 00 	movl   $0x3a33,0x4(%esp)
     cc6:	00 
     cc7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cce:	e8 ad 27 00 00       	call   3480 <printf>
      exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
     ce7:	c7 44 24 04 64 3a 00 	movl   $0x3a64,0x4(%esp)
     cee:	00 
     cef:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cf6:	e8 85 27 00 00       	call   3480 <printf>

  fd = open("dirfile", O_CREATE);
     cfb:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
     d02:	00 
     d03:	c7 04 24 71 3a 00 00 	movl   $0x3a71,(%esp)
  ...
  if(chdir("dirfile") == 0){
     d1f:	c7 04 24 71 3a 00 00 	movl   $0x3a71,(%esp)
  ...
  fd = open("dirfile/xx", 0);
     ...
     d3a:	00 
     d3b:	c7 04 24 aa 3a 00 00 	movl   $0x3aaa,(%esp)
  ...
  fd = open("dirfile/xx", O_CREATE);
     ...
     d56:	00 
     d57:	c7 04 24 aa 3a 00 00 	movl   $0x3aaa,(%esp)
  ...
  if(mkdir("dirfile/xx") == 0){
     d6b:	c7 04 24 aa 3a 00 00 	movl   $0x3aaa,(%esp)
  ...
  if(unlink("dirfile/xx") == 0){
     d7f:	c7 04 24 aa 3a 00 00 	movl   $0x3aaa,(%esp)
  ...
  if(link("README", "dirfile/xx") == 0){
     d93:	c7 44 24 04 aa 3a 00 	movl   $0x3aaa,0x4(%esp)
     d9a:	00 
     d9b:	c7 04 24 47 3a 00 00 	movl   $0x3a47,(%esp)
  ...
  if(unlink("dirfile") != 0){
     daf:	c7 04 24 71 3a 00 00 	movl   $0x3a71,(%esp)
  ...
  fd = open(".", O_RDWR);
     ...
     dca:	00 
     dcb:	c7 04 24 37 3d 00 00 	movl   $0x3d37,(%esp)
  ...
  fd = open(".", 0);
     ...
     de6:	00 
     de7:	c7 04 24 37 3d 00 00 	movl   $0x3d37,(%esp)
     dee:	e8 55 25 00 00       	call   3348 <open>
  if(write(fd, "x", 1) > 0){
     df3:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
     dfa:	00 
     dfb:	c7 44 24 04 1a 3e 00 	movl   $0x3e1a,0x4(%esp)
     e02:	00 
  fd = open(".", O_RDWR);
  if(fd >= 0){
    printf(1, "open . for writing succeeded!\n");
  ...
  printf(1, "dir vs file OK\n");
     e1d:	c7 44 24 04 3a 3b 00 	movl   $0x3b3a,0x4(%esp)
     e24:	00 
     e25:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e2c:	e8 4f 26 00 00       	call   3480 <printf>
}
  ...
  if(fd >= 0){
    printf(1, "create dirfile/xx succeeded!\n");
     e37:	c7 44 24 04 b5 3a 00 	movl   $0x3ab5,0x4(%esp)
     e3e:	00 
     e3f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e46:	e8 35 26 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "create dirfile failed\n");
     e50:	c7 44 24 04 79 3a 00 	movl   $0x3a79,0x4(%esp)
     e57:	00 
     e58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e5f:	e8 1c 26 00 00       	call   3480 <printf>
    exit();
  ...
  if(chdir("dirfile") == 0){
    printf(1, "chdir dirfile succeeded!\n");
     e69:	c7 44 24 04 90 3a 00 	movl   $0x3a90,0x4(%esp)
     e70:	00 
     e71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e78:	e8 03 26 00 00       	call   3480 <printf>
    exit();
  ...
  if(mkdir("dirfile/xx") == 0){
    printf(1, "mkdir dirfile/xx succeeded!\n");
     e82:	c7 44 24 04 d3 3a 00 	movl   $0x3ad3,0x4(%esp)
     e89:	00 
     e8a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e91:	e8 ea 25 00 00       	call   3480 <printf>
    exit();
     e96:	e8 6d 24 00 00       	call   3308 <exit>
  }
  if(unlink("dirfile/xx") == 0){
    printf(1, "unlink dirfile/xx succeeded!\n");
     e9b:	c7 44 24 04 f0 3a 00 	movl   $0x3af0,0x4(%esp)
     ea2:	00 
     ea3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     eaa:	e8 d1 25 00 00       	call   3480 <printf>
    exit();
     eaf:	e8 54 24 00 00       	call   3308 <exit>
  }
  if(link("README", "dirfile/xx") == 0){
    printf(1, "link to dirfile/xx succeeded!\n");
     eb4:	c7 44 24 04 14 48 00 	movl   $0x4814,0x4(%esp)
     ebb:	00 
     ebc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ec3:	e8 b8 25 00 00       	call   3480 <printf>
    exit();
     ec8:	e8 3b 24 00 00       	call   3308 <exit>
  }
  if(unlink("dirfile") != 0){
    printf(1, "unlink dirfile failed!\n");
     ecd:	c7 44 24 04 0e 3b 00 	movl   $0x3b0e,0x4(%esp)
     ed4:	00 
     ed5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     edc:	e8 9f 25 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd >= 0){
    printf(1, "open . for writing succeeded!\n");
     ee6:	c7 44 24 04 34 48 00 	movl   $0x4834,0x4(%esp)
     eed:	00 
     eee:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ef5:	e8 86 25 00 00       	call   3480 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    printf(1, "write . succeeded!\n");
     eff:	c7 44 24 04 26 3b 00 	movl   $0x3b26,0x4(%esp)
     f06:	00 
     f07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f0e:	e8 6d 25 00 00       	call   3480 <printf>
    exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
     f26:	c7 44 24 04 4a 3b 00 	movl   $0x3b4a,0x4(%esp)
     f2d:	00 
     f2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f35:	e8 46 25 00 00       	call   3480 <printf>
  if(mkdir("dots") != 0){
     f3a:	c7 04 24 56 3b 00 00 	movl   $0x3b56,(%esp)
  ...
  if(chdir("dots") != 0){
     f4e:	c7 04 24 56 3b 00 00 	movl   $0x3b56,(%esp)
  ...
  if(unlink(".") == 0){
     f62:	c7 04 24 37 3d 00 00 	movl   $0x3d37,(%esp)
  ...
  if(unlink("..") == 0){
     f76:	c7 04 24 36 3d 00 00 	movl   $0x3d36,(%esp)
  ...
  if(chdir("/") != 0){
     f8a:	c7 04 24 4e 3a 00 00 	movl   $0x3a4e,(%esp)
  ...
  if(unlink("dots/.") == 0){
     f9e:	c7 04 24 ae 3b 00 00 	movl   $0x3bae,(%esp)
  ...
  if(unlink("dots/..") == 0){
     fb2:	c7 04 24 cc 3b 00 00 	movl   $0x3bcc,(%esp)
  ...
  if(unlink("dots") != 0){
     fc6:	c7 04 24 56 3b 00 00 	movl   $0x3b56,(%esp)
  ...
  printf(1, "rmdot ok\n");
     fda:	c7 44 24 04 01 3c 00 	movl   $0x3c01,0x4(%esp)
     fe1:	00 
     fe2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fe9:	e8 92 24 00 00       	call   3480 <printf>
}
     fee:	c9                   	leave  
     fef:	c3                   	ret    
void
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    printf(1, "mkdir dots failed\n");
     ff0:	c7 44 24 04 5b 3b 00 	movl   $0x3b5b,0x4(%esp)
     ff7:	00 
     ff8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fff:	e8 7c 24 00 00       	call   3480 <printf>
    exit();
    1004:	e8 ff 22 00 00       	call   3308 <exit>
  }
  if(chdir("dots") != 0){
    printf(1, "chdir dots failed\n");
    1009:	c7 44 24 04 6e 3b 00 	movl   $0x3b6e,0x4(%esp)
    1010:	00 
    1011:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1018:	e8 63 24 00 00       	call   3480 <printf>
    exit();
    101d:	e8 e6 22 00 00       	call   3308 <exit>
  }
  if(unlink(".") == 0){
    printf(1, "rm . worked!\n");
    1022:	c7 44 24 04 81 3b 00 	movl   $0x3b81,0x4(%esp)
    1029:	00 
    102a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1031:	e8 4a 24 00 00       	call   3480 <printf>
    exit();
    1036:	e8 cd 22 00 00       	call   3308 <exit>
  }
  if(unlink("..") == 0){
    printf(1, "rm .. worked!\n");
    103b:	c7 44 24 04 8f 3b 00 	movl   $0x3b8f,0x4(%esp)
    1042:	00 
    1043:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104a:	e8 31 24 00 00       	call   3480 <printf>
    exit();
    104f:	e8 b4 22 00 00       	call   3308 <exit>
  }
  if(chdir("/") != 0){
    printf(1, "chdir / failed\n");
    1054:	c7 44 24 04 9e 3b 00 	movl   $0x3b9e,0x4(%esp)
    105b:	00 
    105c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1063:	e8 18 24 00 00       	call   3480 <printf>
    exit();
    1068:	e8 9b 22 00 00       	call   3308 <exit>
  }
  if(unlink("dots/.") == 0){
    printf(1, "unlink dots/. worked!\n");
    106d:	c7 44 24 04 b5 3b 00 	movl   $0x3bb5,0x4(%esp)
    1074:	00 
    1075:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    107c:	e8 ff 23 00 00       	call   3480 <printf>
    exit();
    1081:	e8 82 22 00 00       	call   3308 <exit>
  }
  if(unlink("dots/..") == 0){
    printf(1, "unlink dots/.. worked!\n");
    1086:	c7 44 24 04 d4 3b 00 	movl   $0x3bd4,0x4(%esp)
    108d:	00 
    108e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1095:	e8 e6 23 00 00       	call   3480 <printf>
    exit();
    109a:	e8 69 22 00 00       	call   3308 <exit>
  }
  if(unlink("dots") != 0){
    printf(1, "unlink dots failed!\n");
    109f:	c7 44 24 04 ec 3b 00 	movl   $0x3bec,0x4(%esp)
    10a6:	00 
    10a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10ae:	e8 cd 23 00 00       	call   3480 <printf>
    exit();
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    10c7:	c7 44 24 04 0b 3c 00 	movl   $0x3c0b,0x4(%esp)
    10ce:	00 
    10cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10d6:	e8 a5 23 00 00       	call   3480 <printf>

  unlink("ff");
    10db:	c7 04 24 94 3c 00 00 	movl   $0x3c94,(%esp)
    10e2:	e8 71 22 00 00       	call   3358 <unlink>
  if(mkdir("dd") != 0){
    10e7:	c7 04 24 31 3d 00 00 	movl   $0x3d31,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1102:	00 
    1103:	c7 04 24 6a 3c 00 00 	movl   $0x3c6a,(%esp)
  ...
  write(fd, "ff", 2);
    ...
    1120:	00 
    1121:	c7 44 24 04 94 3c 00 	movl   $0x3c94,0x4(%esp)
    1128:	00 
  ...
  if(unlink("dd") >= 0){
    1139:	c7 04 24 31 3d 00 00 	movl   $0x3d31,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    114d:	c7 04 24 45 3c 00 00 	movl   $0x3c45,(%esp)
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1168:	00 
    1169:	c7 04 24 67 3c 00 00 	movl   $0x3c67,(%esp)
  ...
  write(fd, "FF", 2);
    ...
    1186:	00 
    1187:	c7 44 24 04 88 3c 00 	movl   $0x3c88,0x4(%esp)
    118e:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    11a6:	00 
    11a7:	c7 04 24 8b 3c 00 00 	movl   $0x3c8b,(%esp)
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    11c4:	00 
    11c5:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    11cc:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    11da:	80 3d 00 4c 00 00 66 	cmpb   $0x66,0x4c00
    11e1:	74 1d                	je     1200 <subdir+0x140>
    printf(1, "dd/dd/../ff wrong content\n");
    11e3:	c7 44 24 04 b0 3c 00 	movl   $0x3cb0,0x4(%esp)
    11ea:	00 
    11eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11f2:	e8 89 22 00 00       	call   3480 <printf>
    exit();
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1208:	c7 44 24 04 cb 3c 00 	movl   $0x3ccb,0x4(%esp)
    120f:	00 
    1210:	c7 04 24 67 3c 00 00 	movl   $0x3c67,(%esp)
  ...
  if(unlink("dd/dd/ff") != 0){
    1224:	c7 04 24 67 3c 00 00 	movl   $0x3c67,(%esp)
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    123f:	00 
    1240:	c7 04 24 67 3c 00 00 	movl   $0x3c67,(%esp)
  ...
  if(chdir("dd") != 0){
    1254:	c7 04 24 31 3d 00 00 	movl   $0x3d31,(%esp)
  ...
  if(chdir("dd/../../dd") != 0){
    1268:	c7 04 24 ff 3c 00 00 	movl   $0x3cff,(%esp)
  ...
  if(chdir("dd/../../../dd") != 0){
    127c:	c7 04 24 25 3d 00 00 	movl   $0x3d25,(%esp)
  ...
  if(chdir("./..") != 0){
    1290:	c7 04 24 34 3d 00 00 	movl   $0x3d34,(%esp)
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    12ab:	00 
    12ac:	c7 04 24 cb 3c 00 00 	movl   $0x3ccb,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    12c9:	00 
    12ca:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    12d1:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    12f2:	00 
    12f3:	c7 04 24 67 3c 00 00 	movl   $0x3c67,(%esp)
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    130e:	00 
    130f:	c7 04 24 7f 3d 00 00 	movl   $0x3d7f,(%esp)
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    132a:	00 
    132b:	c7 04 24 a4 3d 00 00 	movl   $0x3da4,(%esp)
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1346:	00 
    1347:	c7 04 24 31 3d 00 00 	movl   $0x3d31,(%esp)
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1362:	00 
    1363:	c7 04 24 31 3d 00 00 	movl   $0x3d31,(%esp)
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    137e:	00 
    137f:	c7 04 24 31 3d 00 00 	movl   $0x3d31,(%esp)
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    1393:	c7 44 24 04 13 3e 00 	movl   $0x3e13,0x4(%esp)
    139a:	00 
    139b:	c7 04 24 7f 3d 00 00 	movl   $0x3d7f,(%esp)
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    13af:	c7 44 24 04 13 3e 00 	movl   $0x3e13,0x4(%esp)
    13b6:	00 
    13b7:	c7 04 24 a4 3d 00 00 	movl   $0x3da4,(%esp)
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    13cb:	c7 44 24 04 cb 3c 00 	movl   $0x3ccb,0x4(%esp)
    13d2:	00 
    13d3:	c7 04 24 6a 3c 00 00 	movl   $0x3c6a,(%esp)
  ...
  if(mkdir("dd/ff/ff") == 0){
    13e7:	c7 04 24 7f 3d 00 00 	movl   $0x3d7f,(%esp)
  ...
  if(mkdir("dd/xx/ff") == 0){
    13fb:	c7 04 24 a4 3d 00 00 	movl   $0x3da4,(%esp)
  ...
  if(mkdir("dd/dd/ffff") == 0){
    140f:	c7 04 24 cb 3c 00 00 	movl   $0x3ccb,(%esp)
  ...
  if(unlink("dd/xx/ff") == 0){
    1423:	c7 04 24 a4 3d 00 00 	movl   $0x3da4,(%esp)
  ...
  if(unlink("dd/ff/ff") == 0){
    1437:	c7 04 24 7f 3d 00 00 	movl   $0x3d7f,(%esp)
  ...
  if(chdir("dd/ff") == 0){
    144b:	c7 04 24 6a 3c 00 00 	movl   $0x3c6a,(%esp)
  ...
  if(chdir("dd/xx") == 0){
    145f:	c7 04 24 16 3e 00 00 	movl   $0x3e16,(%esp)
  ...
  if(unlink("dd/dd/ffff") != 0){
    1473:	c7 04 24 cb 3c 00 00 	movl   $0x3ccb,(%esp)
  ...
  if(unlink("dd/ff") != 0){
    1487:	c7 04 24 6a 3c 00 00 	movl   $0x3c6a,(%esp)
  ...
  if(unlink("dd") == 0){
    149b:	c7 04 24 31 3d 00 00 	movl   $0x3d31,(%esp)
  ...
  if(unlink("dd/dd") < 0){
    14af:	c7 04 24 46 3c 00 00 	movl   $0x3c46,(%esp)
  ...
  if(unlink("dd") < 0){
    14c3:	c7 04 24 31 3d 00 00 	movl   $0x3d31,(%esp)
  ...
  printf(1, "subdir ok\n");
    14d7:	c7 44 24 04 13 3f 00 	movl   $0x3f13,0x4(%esp)
    14de:	00 
    14df:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14e6:	e8 95 1f 00 00       	call   3480 <printf>
}
  ...
  if(mkdir("dd") != 0){
    printf(1, "subdir mkdir dd failed\n");
    14f1:	c7 44 24 04 18 3c 00 	movl   $0x3c18,0x4(%esp)
    14f8:	00 
    14f9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1500:	e8 7b 1f 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "create dd/ff failed\n");
    150a:	c7 44 24 04 30 3c 00 	movl   $0x3c30,0x4(%esp)
    1511:	00 
    1512:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1519:	e8 62 1f 00 00       	call   3480 <printf>
    exit();
  ...
  if(unlink("dd") >= 0){
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    1523:	c7 44 24 04 54 48 00 	movl   $0x4854,0x4(%esp)
    152a:	00 
    152b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1532:	e8 49 1f 00 00       	call   3480 <printf>
    exit();
  ...
  if(mkdir("/dd/dd") != 0){
    printf(1, "subdir mkdir dd/dd failed\n");
    153c:	c7 44 24 04 4c 3c 00 	movl   $0x3c4c,0x4(%esp)
    1543:	00 
    1544:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    154b:	e8 30 1f 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "create dd/dd/ff failed\n");
    1555:	c7 44 24 04 70 3c 00 	movl   $0x3c70,0x4(%esp)
    155c:	00 
    155d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1564:	e8 17 1f 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "open dd/dd/../ff failed\n");
    156e:	c7 44 24 04 97 3c 00 	movl   $0x3c97,0x4(%esp)
    1575:	00 
    1576:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    157d:	e8 fe 1e 00 00       	call   3480 <printf>
    exit();
  ...
  if(chdir("dd/../../../dd") != 0){
    printf(1, "chdir dd/../../dd failed\n");
    1587:	c7 44 24 04 0b 3d 00 	movl   $0x3d0b,0x4(%esp)
    158e:	00 
    158f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1596:	e8 e5 1e 00 00       	call   3480 <printf>
    exit();
  ...
  if(unlink("dd/dd/ffff") != 0){
    printf(1, "unlink dd/dd/ff failed\n");
    15a0:	c7 44 24 04 d6 3c 00 	movl   $0x3cd6,0x4(%esp)
    15a7:	00 
    15a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15af:	e8 cc 1e 00 00       	call   3480 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    15b9:	c7 44 24 04 a0 48 00 	movl   $0x48a0,0x4(%esp)
    15c0:	00 
    15c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15c8:	e8 b3 1e 00 00       	call   3480 <printf>
    exit();
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    15d2:	c7 44 24 04 7c 48 00 	movl   $0x487c,0x4(%esp)
    15d9:	00 
    15da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15e1:	e8 9a 1e 00 00       	call   3480 <printf>
    exit();
  ...
  if(chdir("dd") != 0){
    printf(1, "chdir dd failed\n");
    15eb:	c7 44 24 04 ee 3c 00 	movl   $0x3cee,0x4(%esp)
    15f2:	00 
    15f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15fa:	e8 81 1e 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "open dd/dd/ffff failed\n");
    1604:	c7 44 24 04 4c 3d 00 	movl   $0x3d4c,0x4(%esp)
    160b:	00 
    160c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1613:	e8 68 1e 00 00       	call   3480 <printf>
    exit();
  ...
  if(chdir("./..") != 0){
    printf(1, "chdir ./.. failed\n");
    161d:	c7 44 24 04 39 3d 00 	movl   $0x3d39,0x4(%esp)
    1624:	00 
    1625:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    162c:	e8 4f 1e 00 00       	call   3480 <printf>
    exit();
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/ff/ff succeeded!\n");
    1636:	c7 44 24 04 88 3d 00 	movl   $0x3d88,0x4(%esp)
    163d:	00 
    163e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1645:	e8 36 1e 00 00       	call   3480 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    164f:	c7 44 24 04 c4 48 00 	movl   $0x48c4,0x4(%esp)
    1656:	00 
    1657:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165e:	e8 1d 1e 00 00       	call   3480 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    printf(1, "read dd/dd/ffff wrong len\n");
    1668:	c7 44 24 04 64 3d 00 	movl   $0x3d64,0x4(%esp)
    166f:	00 
    1670:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1677:	e8 04 1e 00 00       	call   3480 <printf>
    exit();
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/xx/ff succeeded!\n");
    1681:	c7 44 24 04 ad 3d 00 	movl   $0x3dad,0x4(%esp)
    1688:	00 
    1689:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1690:	e8 eb 1d 00 00       	call   3480 <printf>
    exit();
  ...
  if(mkdir("dd/ff/ff") == 0){
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    169a:	c7 44 24 04 1c 3e 00 	movl   $0x3e1c,0x4(%esp)
    16a1:	00 
    16a2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16a9:	e8 d2 1d 00 00       	call   3480 <printf>
    exit();
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    16b3:	c7 44 24 04 34 49 00 	movl   $0x4934,0x4(%esp)
    16ba:	00 
    16bb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c2:	e8 b9 1d 00 00       	call   3480 <printf>
    exit();
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    16cc:	c7 44 24 04 10 49 00 	movl   $0x4910,0x4(%esp)
    16d3:	00 
    16d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16db:	e8 a0 1d 00 00       	call   3480 <printf>
    exit();
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    16e5:	c7 44 24 04 ec 48 00 	movl   $0x48ec,0x4(%esp)
    16ec:	00 
    16ed:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16f4:	e8 87 1d 00 00       	call   3480 <printf>
    exit();
  ...
  if(open("dd", O_WRONLY) >= 0){
    printf(1, "open dd wronly succeeded!\n");
    16fe:	c7 44 24 04 f8 3d 00 	movl   $0x3df8,0x4(%esp)
    1705:	00 
    1706:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    170d:	e8 6e 1d 00 00       	call   3480 <printf>
    exit();
  ...
  if(open("dd", O_RDWR) >= 0){
    printf(1, "open dd rdwr succeeded!\n");
    1717:	c7 44 24 04 df 3d 00 	movl   $0x3ddf,0x4(%esp)
    171e:	00 
    171f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1726:	e8 55 1d 00 00       	call   3480 <printf>
    exit();
  ...
  if(open("dd", O_CREATE) >= 0){
    printf(1, "create dd succeeded!\n");
    1730:	c7 44 24 04 c9 3d 00 	movl   $0x3dc9,0x4(%esp)
    1737:	00 
    1738:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    173f:	e8 3c 1d 00 00       	call   3480 <printf>
    exit();
  ...
  if(mkdir("dd/xx/ff") == 0){
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    1749:	c7 44 24 04 37 3e 00 	movl   $0x3e37,0x4(%esp)
    1750:	00 
    1751:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1758:	e8 23 1d 00 00       	call   3480 <printf>
    exit();
  ...
  if(unlink("dd") == 0){
    printf(1, "unlink non-empty dd succeeded!\n");
    1762:	c7 44 24 04 58 49 00 	movl   $0x4958,0x4(%esp)
    1769:	00 
    176a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1771:	e8 0a 1d 00 00       	call   3480 <printf>
    exit();
  ...
  if(unlink("dd/ff") != 0){
    printf(1, "unlink dd/ff failed\n");
    177b:	c7 44 24 04 d7 3e 00 	movl   $0x3ed7,0x4(%esp)
    1782:	00 
    1783:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    178a:	e8 f1 1c 00 00       	call   3480 <printf>
    exit();
  ...
  if(chdir("dd/xx") == 0){
    printf(1, "chdir dd/xx succeeded!\n");
    1794:	c7 44 24 04 bf 3e 00 	movl   $0x3ebf,0x4(%esp)
    179b:	00 
    179c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17a3:	e8 d8 1c 00 00       	call   3480 <printf>
    exit();
  ...
  if(chdir("dd/ff") == 0){
    printf(1, "chdir dd/ff succeeded!\n");
    17ad:	c7 44 24 04 a7 3e 00 	movl   $0x3ea7,0x4(%esp)
    17b4:	00 
    17b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17bc:	e8 bf 1c 00 00       	call   3480 <printf>
    exit();
  ...
  if(unlink("dd/ff/ff") == 0){
    printf(1, "unlink dd/ff/ff succeeded!\n");
    17c6:	c7 44 24 04 8b 3e 00 	movl   $0x3e8b,0x4(%esp)
    17cd:	00 
    17ce:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17d5:	e8 a6 1c 00 00       	call   3480 <printf>
    exit();
  ...
  if(unlink("dd/xx/ff") == 0){
    printf(1, "unlink dd/xx/ff succeeded!\n");
    17df:	c7 44 24 04 6f 3e 00 	movl   $0x3e6f,0x4(%esp)
    17e6:	00 
    17e7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17ee:	e8 8d 1c 00 00       	call   3480 <printf>
    exit();
  ...
  if(mkdir("dd/dd/ffff") == 0){
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    17f8:	c7 44 24 04 52 3e 00 	movl   $0x3e52,0x4(%esp)
    17ff:	00 
    1800:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1807:	e8 74 1c 00 00       	call   3480 <printf>
    exit();
  ...
  if(unlink("dd") < 0){
    printf(1, "unlink dd failed\n");
    1811:	c7 44 24 04 01 3f 00 	movl   $0x3f01,0x4(%esp)
    1818:	00 
    1819:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1820:	e8 5b 1c 00 00       	call   3480 <printf>
    exit();
  ...
  if(unlink("dd/dd") < 0){
    printf(1, "unlink dd/dd failed\n");
    182a:	c7 44 24 04 ec 3e 00 	movl   $0x3eec,0x4(%esp)
    1831:	00 
    1832:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1839:	e8 42 1c 00 00       	call   3480 <printf>
    exit();
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1858:	c7 44 24 04 1e 3f 00 	movl   $0x3f1e,0x4(%esp)
    185f:	00 
    1860:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1867:	e8 14 1c 00 00       	call   3480 <printf>
  unlink("bd");
    186c:	c7 04 24 2b 3f 00 00 	movl   $0x3f2b,(%esp)
    1873:	e8 e0 1a 00 00       	call   3358 <unlink>

  fd = open("bd", O_CREATE);
    1878:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    187f:	00 
    1880:	c7 04 24 2b 3f 00 00 	movl   $0x3f2b,(%esp)
  ...
  unlink("bd");
    1904:	c7 04 24 2b 3f 00 00 	movl   $0x3f2b,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1955:	c7 44 24 04 58 3f 00 	movl   $0x3f58,0x4(%esp)
    195c:	00 
    195d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1964:	e8 17 1b 00 00       	call   3480 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    196e:	c7 44 24 04 6d 3f 00 	movl   $0x3f6d,0x4(%esp)
    1975:	00 
    1976:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    197d:	e8 fe 1a 00 00       	call   3480 <printf>
}
  ...
  if(fd < 0){
    printf(1, "bigdir create failed\n");
    1989:	c7 44 24 04 2e 3f 00 	movl   $0x3f2e,0x4(%esp)
    1990:	00 
    1991:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1998:	e8 e3 1a 00 00       	call   3480 <printf>
    exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    19b7:	c7 44 24 04 78 3f 00 	movl   $0x3f78,0x4(%esp)
    19be:	00 
    19bf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    19c6:	e8 b5 1a 00 00       	call   3480 <printf>

  unlink("lf1");
    19cb:	c7 04 24 82 3f 00 00 	movl   $0x3f82,(%esp)
    19d2:	e8 81 19 00 00       	call   3358 <unlink>
  unlink("lf2");
    19d7:	c7 04 24 86 3f 00 00 	movl   $0x3f86,(%esp)
    19de:	e8 75 19 00 00       	call   3358 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    19e3:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    19ea:	00 
    19eb:	c7 04 24 82 3f 00 00 	movl   $0x3f82,(%esp)
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1a08:	00 
    1a09:	c7 44 24 04 9d 3f 00 	movl   $0x3f9d,0x4(%esp)
    1a10:	00 
  ...
  if(link("lf1", "lf2") < 0){
    1a2a:	c7 44 24 04 86 3f 00 	movl   $0x3f86,0x4(%esp)
    1a31:	00 
    1a32:	c7 04 24 82 3f 00 00 	movl   $0x3f82,(%esp)
  ...
  unlink("lf1");
    1a46:	c7 04 24 82 3f 00 00 	movl   $0x3f82,(%esp)
    1a4d:	e8 06 19 00 00       	call   3358 <unlink>

  if(open("lf1", 0) >= 0){
    1a52:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    1a59:	00 
    1a5a:	c7 04 24 82 3f 00 00 	movl   $0x3f82,(%esp)
  ...
  fd = open("lf2", 0);
    ...
    1a75:	00 
    1a76:	c7 04 24 86 3f 00 00 	movl   $0x3f86,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1a93:	00 
    1a94:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    1a9b:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    1ab5:	c7 44 24 04 86 3f 00 	movl   $0x3f86,0x4(%esp)
    1abc:	00 
    1abd:	c7 04 24 86 3f 00 00 	movl   $0x3f86,(%esp)
  ...
  unlink("lf2");
    1ad1:	c7 04 24 86 3f 00 00 	movl   $0x3f86,(%esp)
    1ad8:	e8 7b 18 00 00       	call   3358 <unlink>
  if(link("lf2", "lf1") >= 0){
    1add:	c7 44 24 04 82 3f 00 	movl   $0x3f82,0x4(%esp)
    1ae4:	00 
    1ae5:	c7 04 24 86 3f 00 00 	movl   $0x3f86,(%esp)
  ...
  if(link(".", "lf1") >= 0){
    1af9:	c7 44 24 04 82 3f 00 	movl   $0x3f82,0x4(%esp)
    1b00:	00 
    1b01:	c7 04 24 37 3d 00 00 	movl   $0x3d37,(%esp)
  ...
  printf(1, "linktest ok\n");
    1b15:	c7 44 24 04 26 40 00 	movl   $0x4026,0x4(%esp)
    1b1c:	00 
    1b1d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b24:	e8 57 19 00 00       	call   3480 <printf>
}
  ...
  if(fd < 0){
    printf(1, "create lf1 failed\n");
    1b2f:	c7 44 24 04 8a 3f 00 	movl   $0x3f8a,0x4(%esp)
    1b36:	00 
    1b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b3e:	e8 3d 19 00 00       	call   3480 <printf>
    exit();
    1b43:	e8 c0 17 00 00       	call   3308 <exit>
  }
  if(write(fd, "hello", 5) != 5){
    printf(1, "write lf1 failed\n");
    1b48:	c7 44 24 04 a3 3f 00 	movl   $0x3fa3,0x4(%esp)
    1b4f:	00 
    1b50:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b57:	e8 24 19 00 00       	call   3480 <printf>
    exit();
  ...
  if(link("lf1", "lf2") < 0){
    printf(1, "link lf1 lf2 failed\n");
    1b61:	c7 44 24 04 b5 3f 00 	movl   $0x3fb5,0x4(%esp)
    1b68:	00 
    1b69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b70:	e8 0b 19 00 00       	call   3480 <printf>
    exit();
  ...
  if(open("lf1", 0) >= 0){
    printf(1, "unlinked lf1 but it is still there!\n");
    1b7a:	c7 44 24 04 78 49 00 	movl   $0x4978,0x4(%esp)
    1b81:	00 
    1b82:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b89:	e8 f2 18 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "open lf2 failed\n");
    1b93:	c7 44 24 04 ca 3f 00 	movl   $0x3fca,0x4(%esp)
    1b9a:	00 
    1b9b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba2:	e8 d9 18 00 00       	call   3480 <printf>
    exit();
    1ba7:	e8 5c 17 00 00       	call   3308 <exit>
  }
  if(read(fd, buf, sizeof(buf)) != 5){
    printf(1, "read lf2 failed\n");
    1bac:	c7 44 24 04 db 3f 00 	movl   $0x3fdb,0x4(%esp)
    1bb3:	00 
    1bb4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bbb:	e8 c0 18 00 00       	call   3480 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1bc5:	c7 44 24 04 ec 3f 00 	movl   $0x3fec,0x4(%esp)
    1bcc:	00 
    1bcd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bd4:	e8 a7 18 00 00       	call   3480 <printf>
    exit();
  ...
  if(link("lf2", "lf1") >= 0){
    printf(1, "link non-existant succeeded! oops\n");
    1bde:	c7 44 24 04 a0 49 00 	movl   $0x49a0,0x4(%esp)
    1be5:	00 
    1be6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bed:	e8 8e 18 00 00       	call   3480 <printf>
    exit();
  ...
  if(link(".", "lf1") >= 0){
    printf(1, "link . lf1 succeeded! oops\n");
    1bf7:	c7 44 24 04 0a 40 00 	movl   $0x400a,0x4(%esp)
    1bfe:	00 
    1bff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c06:	e8 75 18 00 00       	call   3480 <printf>
    exit();
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1c18:	c7 44 24 04 33 40 00 	movl   $0x4033,0x4(%esp)
    1c1f:	00 
    1c20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c27:	e8 54 18 00 00       	call   3480 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1c2c:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1c33:	00 
    1c34:	c7 04 24 44 40 00 00 	movl   $0x4044,(%esp)
...
unlinkread(void)
{
  ...
  write(fd, "hello", 5);
    ...
    1c51:	00 
    1c52:	c7 44 24 04 9d 3f 00 	movl   $0x3f9d,0x4(%esp)
    1c59:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1c71:	00 
    1c72:	c7 04 24 44 40 00 00 	movl   $0x4044,(%esp)
  ...
  if(unlink("unlinkread") != 0){
    1c88:	c7 04 24 44 40 00 00 	movl   $0x4044,(%esp)
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1ca3:	00 
    1ca4:	c7 04 24 44 40 00 00 	movl   $0x4044,(%esp)
    1cab:	e8 98 16 00 00       	call   3348 <open>
  write(fd1, "yyy", 3);
    1cb0:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    1cb7:	00 
    1cb8:	c7 44 24 04 9b 40 00 	movl   $0x409b,0x4(%esp)
    1cbf:	00 
  if(unlink("unlinkread") != 0){
    printf(1, "unlink unlinkread failed\n");
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1cd9:	00 
    1cda:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    1ce1:	00 
  ...
  if(buf[0] != 'h'){
    1cf3:	80 3d 00 4c 00 00 68 	cmpb   $0x68,0x4c00
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1d07:	00 
    1d08:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    1d0f:	00 
  ...
  unlink("unlinkread");
    1d29:	c7 04 24 44 40 00 00 	movl   $0x4044,(%esp)
    1d30:	e8 23 16 00 00       	call   3358 <unlink>
  printf(1, "unlinkread ok\n");
    1d35:	c7 44 24 04 e6 40 00 	movl   $0x40e6,0x4(%esp)
    1d3c:	00 
    1d3d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d44:	e8 37 17 00 00       	call   3480 <printf>
}
  ...
  if(fd < 0){
    printf(1, "create unlinkread failed\n");
    1d50:	c7 44 24 04 4f 40 00 	movl   $0x404f,0x4(%esp)
    1d57:	00 
    1d58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d5f:	e8 1c 17 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "open unlinkread failed\n");
    1d69:	c7 44 24 04 69 40 00 	movl   $0x4069,0x4(%esp)
    1d70:	00 
    1d71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d78:	e8 03 17 00 00       	call   3480 <printf>
    exit();
    1d7d:	e8 86 15 00 00       	call   3308 <exit>
  }
  if(unlink("unlinkread") != 0){
    printf(1, "unlink unlinkread failed\n");
    1d82:	c7 44 24 04 81 40 00 	movl   $0x4081,0x4(%esp)
    1d89:	00 
    1d8a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d91:	e8 ea 16 00 00       	call   3480 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    printf(1, "unlinkread read failed");
    1d9b:	c7 44 24 04 9f 40 00 	movl   $0x409f,0x4(%esp)
    1da2:	00 
    1da3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1daa:	e8 d1 16 00 00       	call   3480 <printf>
    exit();
    1daf:	e8 54 15 00 00       	call   3308 <exit>
  }
  if(buf[0] != 'h'){
    printf(1, "unlinkread wrong data\n");
    1db4:	c7 44 24 04 b6 40 00 	movl   $0x40b6,0x4(%esp)
    1dbb:	00 
    1dbc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dc3:	e8 b8 16 00 00       	call   3480 <printf>
    exit();
    1dc8:	e8 3b 15 00 00       	call   3308 <exit>
  }
  if(write(fd, buf, 10) != 10){
    printf(1, "unlinkread write failed\n");
    1dcd:	c7 44 24 04 cd 40 00 	movl   $0x40cd,0x4(%esp)
    1dd4:	00 
    1dd5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ddc:	e8 9f 16 00 00       	call   3480 <printf>
    exit();
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1df9:	c7 44 24 04 f5 40 00 	movl   $0x40f5,0x4(%esp)
    1e00:	00 
    1e01:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e08:	e8 73 16 00 00       	call   3480 <printf>
  pid = fork();
  ...
  for(i = 0; i < N; i++){
    ...
    1e90:	c7 44 24 04 08 41 00 	movl   $0x4108,0x4(%esp)
    1e97:	00 
    1e98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e9f:	e8 dc 15 00 00       	call   3480 <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1f1e:	c7 44 24 04 e8 49 00 	movl   $0x49e8,0x4(%esp)
    1f25:	00 
    1f26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f2d:	e8 4e 15 00 00       	call   3480 <printf>
      exit();
    ...
    1f87:	c7 44 24 04 e8 49 00 	movl   $0x49e8,0x4(%esp)
    1f8e:	00 
    1f8f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f96:	e8 e5 14 00 00       	call   3480 <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    200c:	c7 44 24 04 17 41 00 	movl   $0x4117,0x4(%esp)
    2013:	00 
    2014:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    201b:	e8 60 14 00 00       	call   3480 <printf>
}
  ...
  for(i = 0; i < N; i++){
    ...
    if(fd < 0){
      printf(1, "create failed\n");
    2028:	c7 44 24 04 35 3f 00 	movl   $0x3f35,0x4(%esp)
    202f:	00 
    2030:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2037:	e8 44 14 00 00       	call   3480 <printf>
      exit();
    ...
    2048:	c7 44 24 04 c4 49 00 	movl   $0x49c4,0x4(%esp)
    204f:	00 
    2050:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2057:	e8 24 14 00 00       	call   3480 <printf>
      exit();
  ...
  for(i = 0; i < N; i++){
    ...
    2068:	c7 44 24 04 c4 49 00 	movl   $0x49c4,0x4(%esp)
    206f:	00 
    2070:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2077:	e8 04 14 00 00       	call   3480 <printf>
  ...
  if(pid < 0){
    printf(1, "fork failed\n");
    2081:	c7 44 24 04 81 38 00 	movl   $0x3881,0x4(%esp)
    2088:	00 
    2089:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2090:	e8 eb 13 00 00       	call   3480 <printf>
    exit();
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
    20a6:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    20ab:	c7 44 24 04 28 41 00 	movl   $0x4128,0x4(%esp)
    20b2:	00 
    20b3:	89 04 24             	mov    %eax,(%esp)
    20b6:	e8 c5 13 00 00       	call   3480 <printf>

  if(mkdir("dir0") < 0) {
    20bb:	c7 04 24 34 41 00 00 	movl   $0x4134,(%esp)
  ...
  if(chdir("dir0") < 0) {
    20cb:	c7 04 24 34 41 00 00 	movl   $0x4134,(%esp)
  ...
  if(chdir("..") < 0) {
    20db:	c7 04 24 36 3d 00 00 	movl   $0x3d36,(%esp)
  ...
  if(unlink("dir0") < 0) {
    20eb:	c7 04 24 34 41 00 00 	movl   $0x4134,(%esp)
  ...
  printf(stdout, "mkdir test\n");
    20fb:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2100:	c7 44 24 04 28 41 00 	movl   $0x4128,0x4(%esp)
    2107:	00 
    2108:	89 04 24             	mov    %eax,(%esp)
    210b:	e8 70 13 00 00       	call   3480 <printf>
}
    2110:	c9                   	leave  
    2111:	c3                   	ret    
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0) {
    printf(stdout, "mkdir failed\n");
    2112:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2117:	c7 44 24 04 39 41 00 	movl   $0x4139,0x4(%esp)
    211e:	00 
    211f:	89 04 24             	mov    %eax,(%esp)
    2122:	e8 59 13 00 00       	call   3480 <printf>
    exit();
  ...
  if(chdir("dir0") < 0) {
    printf(stdout, "chdir dir0 failed\n");
    212c:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2131:	c7 44 24 04 47 41 00 	movl   $0x4147,0x4(%esp)
    2138:	00 
    2139:	89 04 24             	mov    %eax,(%esp)
    213c:	e8 3f 13 00 00       	call   3480 <printf>
    exit();
  ...
  if(chdir("..") < 0) {
    printf(stdout, "chdir .. failed\n");
    2146:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    214b:	c7 44 24 04 5a 41 00 	movl   $0x415a,0x4(%esp)
    2152:	00 
    2153:	89 04 24             	mov    %eax,(%esp)
    2156:	e8 25 13 00 00       	call   3480 <printf>
    exit();
  ...
  if(unlink("dir0") < 0) {
    printf(stdout, "unlink dir0 failed\n");
    2160:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2165:	c7 44 24 04 6b 41 00 	movl   $0x416b,0x4(%esp)
    216c:	00 
    216d:	89 04 24             	mov    %eax,(%esp)
    2170:	e8 0b 13 00 00       	call   3480 <printf>
    exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
    218c:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2191:	c7 44 24 04 08 4a 00 	movl   $0x4a08,0x4(%esp)
    2198:	00 
    2199:	89 04 24             	mov    %eax,(%esp)
    219c:	e8 df 12 00 00       	call   3480 <printf>

  name[0] = 'a';
    21a1:	c6 05 00 54 00 00 61 	movb   $0x61,0x5400
  name[2] = '\0';
    21a8:	c6 05 02 54 00 00 00 	movb   $0x0,0x5402
  for(i = 0; i < 52; i++) {
    name[1] = '0' + i;
    21af:	c6 05 01 54 00 00 30 	movb   $0x30,0x5401
    fd = open(name, O_CREATE|O_RDWR);
    21b6:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    21bd:	00 
    21be:	c7 04 24 00 54 00 00 	movl   $0x5400,(%esp)
  ...
  for(i = 0; i < 52; i++) {
    ...
    name[1] = '0' + i;
    21d8:	a2 01 54 00 00       	mov    %al,0x5401
    fd = open(name, O_CREATE|O_RDWR);
    21dd:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    21e4:	00 
    21e5:	c7 04 24 00 54 00 00 	movl   $0x5400,(%esp)
  ...
  name[0] = 'a';
    21fe:	c6 05 00 54 00 00 61 	movb   $0x61,0x5400
  name[2] = '\0';
  for(i = 0; i < 52; i++) {
    name[1] = '0' + i;
    unlink(name);
  ...
  name[0] = 'a';
  name[2] = '\0';
    2207:	c6 05 02 54 00 00 00 	movb   $0x0,0x5402
  for(i = 0; i < 52; i++) {
    name[1] = '0' + i;
    220e:	c6 05 01 54 00 00 30 	movb   $0x30,0x5401
    unlink(name);
    2215:	c7 04 24 00 54 00 00 	movl   $0x5400,(%esp)
  ...
  for(i = 0; i < 52; i++) {
    ...
    name[1] = '0' + i;
    2227:	a2 01 54 00 00       	mov    %al,0x5401
    unlink(name);
    222c:	c7 04 24 00 54 00 00 	movl   $0x5400,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
    223d:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2242:	c7 44 24 04 30 4a 00 	movl   $0x4a30,0x4(%esp)
    2249:	00 
    224a:	89 04 24             	mov    %eax,(%esp)
    224d:	e8 2e 12 00 00       	call   3480 <printf>
}
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
    226a:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    226f:	c7 44 24 04 7f 41 00 	movl   $0x417f,0x4(%esp)
    2276:	00 
    2277:	89 04 24             	mov    %eax,(%esp)
    227a:	e8 01 12 00 00       	call   3480 <printf>

  fd = open("big", O_CREATE|O_RDWR);
    227f:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2286:	00 
    2287:	c7 04 24 f9 41 00 00 	movl   $0x41f9,(%esp)
    ...
    2293:	85 c0                	test   %eax,%eax
{
  ...
  for(i = 0; i < MAXFILE; i++) {
    ...
    ((int*) buf)[0] = i;
    22ab:	89 1d 00 4c 00 00    	mov    %ebx,0x4c00
    if(write(fd, buf, 512) != 512) {
    22b1:	c7 44 24 08 00 02 00 	movl   $0x200,0x8(%esp)
    22b8:	00 
    22b9:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    22c0:	00 
    ...
    22d0:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    22d5:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    22d9:	c7 44 24 04 a9 41 00 	movl   $0x41a9,0x4(%esp)
    22e0:	00 
    22e1:	89 04 24             	mov    %eax,(%esp)
    22e4:	e8 97 11 00 00       	call   3480 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
    ...
    22ff:	00 
    2300:	c7 04 24 f9 41 00 00 	movl   $0x41f9,(%esp)
  ...
  if(fd < 0){
    ...
    if(((int*)buf)[0] != n) {
    2322:	a1 00 4c 00 00       	mov    0x4c00,%eax
  ...
  for(;;) {
    ...
    2339:	00 
    233a:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    2341:	00 
  ...
  if(unlink("big") < 0) {
    2365:	c7 04 24 f9 41 00 00 	movl   $0x41f9,(%esp)
  ...
  printf(stdout, "big files ok\n");
    2379:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    237e:	c7 44 24 04 20 42 00 	movl   $0x4220,0x4(%esp)
    2385:	00 
    2386:	89 04 24             	mov    %eax,(%esp)
    2389:	e8 f2 10 00 00       	call   3480 <printf>
}
    ...
    2399:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    239e:	c7 44 24 04 fd 41 00 	movl   $0x41fd,0x4(%esp)
    23a5:	00 
    23a6:	89 04 24             	mov    %eax,(%esp)
    23a9:	e8 d2 10 00 00       	call   3480 <printf>
      exit();
    ...
    23b7:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    23bc:	89 74 24 08          	mov    %esi,0x8(%esp)
    23c0:	c7 44 24 04 58 4a 00 	movl   $0x4a58,0x4(%esp)
    23c7:	00 
    23c8:	89 04 24             	mov    %eax,(%esp)
    23cb:	e8 b0 10 00 00       	call   3480 <printf>
             n, ((int*)buf)[0]);
      exit();
  ...
  if(fd < 0){
    printf(stdout, "error: creat big failed!\n");
    23d5:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    23da:	c7 44 24 04 8f 41 00 	movl   $0x418f,0x4(%esp)
    23e1:	00 
    23e2:	89 04 24             	mov    %eax,(%esp)
    23e5:	e8 96 10 00 00       	call   3480 <printf>
    exit();
  ...
  for(;;) {
    ...
    if(i == 0) {
      if(n == MAXFILE - 1) {
        printf(stdout, "read only %d blocks from big", n);
    23ef:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    23f4:	c7 44 24 08 8b 00 00 	movl   $0x8b,0x8(%esp)
    23fb:	00 
    23fc:	c7 44 24 04 e0 41 00 	movl   $0x41e0,0x4(%esp)
    2403:	00 
    2404:	89 04 24             	mov    %eax,(%esp)
    2407:	e8 74 10 00 00       	call   3480 <printf>
        exit();
  ...
  if(fd < 0){
    printf(stdout, "error: open big failed!\n");
    2411:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2416:	c7 44 24 04 c7 41 00 	movl   $0x41c7,0x4(%esp)
    241d:	00 
    241e:	89 04 24             	mov    %eax,(%esp)
    2421:	e8 5a 10 00 00       	call   3480 <printf>
    exit();
  ...
  if(unlink("big") < 0) {
    printf(stdout, "unlink big failed\n");
    242b:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2430:	c7 44 24 04 0d 42 00 	movl   $0x420d,0x4(%esp)
    2437:	00 
    2438:	89 04 24             	mov    %eax,(%esp)
    243b:	e8 40 10 00 00       	call   3480 <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
    2458:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    245d:	c7 44 24 04 2e 42 00 	movl   $0x422e,0x4(%esp)
    2464:	00 
    2465:	89 04 24             	mov    %eax,(%esp)
    2468:	e8 13 10 00 00       	call   3480 <printf>
  fd = open("small", O_CREATE|O_RDWR);
    246d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2474:	00 
    2475:	c7 04 24 3f 42 00 00 	movl   $0x423f,(%esp)
    ...
    2481:	85 c0                	test   %eax,%eax
{
  ...
  if(fd >= 0){
    ...
    248b:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2490:	31 db                	xor    %ebx,%ebx
    2492:	c7 44 24 04 45 42 00 	movl   $0x4245,0x4(%esp)
    2499:	00 
    249a:	89 04 24             	mov    %eax,(%esp)
    249d:	e8 de 0f 00 00       	call   3480 <printf>
  ...
  for(i = 0; i < 100; i++) {
    ...
    24ab:	00 
    24ac:	c7 44 24 04 87 42 00 	movl   $0x4287,0x4(%esp)
    24b3:	00 
  ...
  for(i = 0; i < 100; i++) {
    ...
    24d0:	00 
    24d1:	c7 44 24 04 7c 42 00 	movl   $0x427c,0x4(%esp)
    24d8:	00 
    ...
    24e4:	74 be                	je     24a4 <writetest+0x54>
      printf(stdout, "error: write aa %d new file failed\n", i);
    24e6:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    24eb:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    24ef:	c7 44 24 04 78 4a 00 	movl   $0x4a78,0x4(%esp)
    24f6:	00 
    24f7:	89 04 24             	mov    %eax,(%esp)
    24fa:	e8 81 0f 00 00       	call   3480 <printf>
      exit();
    24ff:	e8 04 0e 00 00       	call   3308 <exit>
    }
    if(write(fd, "bbbbbbbbbb", 10) != 10) {
      printf(stdout, "error: write bb %d new file failed\n", i);
    2504:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2509:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    250d:	c7 44 24 04 9c 4a 00 	movl   $0x4a9c,0x4(%esp)
    2514:	00 
    2515:	89 04 24             	mov    %eax,(%esp)
    2518:	e8 63 0f 00 00       	call   3480 <printf>
      exit();
    251d:	e8 e6 0d 00 00       	call   3308 <exit>
    }
  }
  printf(stdout, "writes ok\n");
    2522:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2527:	c7 44 24 04 92 42 00 	movl   $0x4292,0x4(%esp)
    252e:	00 
    252f:	89 04 24             	mov    %eax,(%esp)
    2532:	e8 49 0f 00 00       	call   3480 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
    ...
    2546:	00 
    2547:	c7 04 24 3f 42 00 00 	movl   $0x423f,(%esp)
  ...
  if(fd >= 0){
    ...
    255d:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2562:	c7 44 24 04 9d 42 00 	movl   $0x429d,0x4(%esp)
    2569:	00 
    256a:	89 04 24             	mov    %eax,(%esp)
    256d:	e8 0e 0f 00 00       	call   3480 <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
    ...
    2579:	00 
    257a:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    2581:	00 
  ...
  if(i == 2000) {
    ...
    2591:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2596:	c7 44 24 04 d1 42 00 	movl   $0x42d1,0x4(%esp)
    259d:	00 
    259e:	89 04 24             	mov    %eax,(%esp)
    25a1:	e8 da 0e 00 00       	call   3480 <printf>
  } else {
  ...
  if(unlink("small") < 0) {
    25ae:	c7 04 24 3f 42 00 00 	movl   $0x423f,(%esp)
  ...
  printf(stdout, "small file test ok\n");
    25be:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    25c3:	c7 44 24 04 f9 42 00 	movl   $0x42f9,0x4(%esp)
    25ca:	00 
    25cb:	89 04 24             	mov    %eax,(%esp)
    25ce:	e8 ad 0e 00 00       	call   3480 <printf>
}
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
    25da:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    25df:	c7 44 24 04 60 42 00 	movl   $0x4260,0x4(%esp)
    25e6:	00 
    25e7:	89 04 24             	mov    %eax,(%esp)
    25ea:	e8 91 0e 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
    25f4:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    25f9:	c7 44 24 04 b6 42 00 	movl   $0x42b6,0x4(%esp)
    2600:	00 
    2601:	89 04 24             	mov    %eax,(%esp)
    2604:	e8 77 0e 00 00       	call   3480 <printf>
    exit();
  ...
  if(i == 2000) {
    ...
    printf(stdout, "read failed\n");
    260e:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2613:	c7 44 24 04 5c 40 00 	movl   $0x405c,0x4(%esp)
    261a:	00 
    261b:	89 04 24             	mov    %eax,(%esp)
    261e:	e8 5d 0e 00 00       	call   3480 <printf>
    exit();
  ...
  if(unlink("small") < 0) {
    printf(stdout, "unlink small failed\n");
    2628:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    262d:	c7 44 24 04 e4 42 00 	movl   $0x42e4,0x4(%esp)
    2634:	00 
    2635:	89 04 24             	mov    %eax,(%esp)
    2638:	e8 43 0e 00 00       	call   3480 <printf>
    exit();
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    265b:	c7 44 24 04 0d 43 00 	movl   $0x430d,0x4(%esp)
    2662:	00 
    2663:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    266a:	e8 11 0e 00 00       	call   3480 <printf>

  unlink("bigfile");
    266f:	c7 04 24 29 43 00 00 	movl   $0x4329,(%esp)
    2676:	e8 dd 0c 00 00       	call   3358 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    267b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2682:	00 
    2683:	c7 04 24 29 43 00 00 	movl   $0x4329,(%esp)
  ...
  for(i = 0; i < 20; i++){
    ...
    26ac:	c7 04 24 00 4c 00 00 	movl   $0x4c00,(%esp)
    26b3:	e8 e8 0a 00 00       	call   31a0 <memset>
    if(write(fd, buf, 600) != 600){
    26b8:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    26bf:	00 
    26c0:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    26c7:	00 
  ...
  fd = open("bigfile", 0);
    ...
    26f6:	00 
    26f7:	c7 04 24 29 43 00 00 	movl   $0x4329,(%esp)
  ...
  if(fd < 0){
    ...
    271b:	0f be 15 00 4c 00 00 	movsbl 0x4c00,%edx
    ...
    272f:	0f be 05 2b 4d 00 00 	movsbl 0x4d2b,%eax
  ...
  for(i = 0; ; i++){
    ...
    274a:	00 
    274b:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    2752:	00 
  ...
  unlink("bigfile");
    2776:	c7 04 24 29 43 00 00 	movl   $0x4329,(%esp)
    277d:	e8 d6 0b 00 00       	call   3358 <unlink>

  printf(1, "bigfile test ok\n");
    2782:	c7 44 24 04 b8 43 00 	movl   $0x43b8,0x4(%esp)
    2789:	00 
    278a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2791:	e8 ea 0c 00 00       	call   3480 <printf>
}
    ...
    if(buf[0] != i/2 || buf[299] != i/2){
      printf(1, "read bigfile wrong data\n");
    279e:	c7 44 24 04 85 43 00 	movl   $0x4385,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 ce 0c 00 00       	call   3480 <printf>
      exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    if(write(fd, buf, 600) != 600){
      printf(1, "write bigfile failed\n");
    27b7:	c7 44 24 04 31 43 00 	movl   $0x4331,0x4(%esp)
    27be:	00 
    27bf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c6:	e8 b5 0c 00 00       	call   3480 <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    if(cc < 0){
      printf(1, "read bigfile failed\n");
    27d0:	c7 44 24 04 5c 43 00 	movl   $0x435c,0x4(%esp)
    27d7:	00 
    27d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27df:	e8 9c 0c 00 00       	call   3480 <printf>
      exit();
    ...
    if(cc != 300){
      printf(1, "short read bigfile\n");
    27e9:	c7 44 24 04 71 43 00 	movl   $0x4371,0x4(%esp)
    27f0:	00 
    27f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27f8:	e8 83 0c 00 00       	call   3480 <printf>
      exit();
  ...
  if(fd < 0){
    printf(1, "cannot create bigfile");
    2802:	c7 44 24 04 1b 43 00 	movl   $0x431b,0x4(%esp)
    2809:	00 
    280a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2811:	e8 6a 0c 00 00       	call   3480 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "cannot open bigfile\n");
    281b:	c7 44 24 04 47 43 00 	movl   $0x4347,0x4(%esp)
    2822:	00 
    2823:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    282a:	e8 51 0c 00 00       	call   3480 <printf>
    exit();
  ...
  if(total != 20*600){
    printf(1, "read bigfile wrong total\n");
    2834:	c7 44 24 04 9e 43 00 	movl   $0x439e,0x4(%esp)
    283b:	00 
    283c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2843:	e8 38 0c 00 00       	call   3480 <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    285b:	c7 44 24 04 c9 43 00 	movl   $0x43c9,0x4(%esp)
    2862:	00 
    2863:	8d 7d f1             	lea    -0xf(%ebp),%edi
    2866:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    286d:	e8 0e 0c 00 00       	call   3480 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    290a:	c7 04 24 d9 43 00 00 	movl   $0x43d9,(%esp)
  ...
  for(i = 0; i < 40; i++){
    ...
    2922:	c7 04 24 d9 43 00 00 	movl   $0x43d9,(%esp)
  ...
  fd = open(".", 0);
    ...
    295d:	00 
    295e:	c7 04 24 37 3d 00 00 	movl   $0x3d37,(%esp)
  ...
  printf(1, "concreate ok\n");
    2a56:	c7 44 24 04 2e 44 00 	movl   $0x442e,0x4(%esp)
    2a5d:	00 
    2a5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a65:	e8 16 0a 00 00       	call   3480 <printf>
}
    ...
    2a76:	c7 44 24 04 dc 43 00 	movl   $0x43dc,0x4(%esp)
    2a7d:	00 
    2a7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a85:	e8 f6 09 00 00       	call   3480 <printf>
        exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid < 0){
      printf(1, "fork failed\n");
    2a8f:	c7 44 24 04 81 38 00 	movl   $0x3881,0x4(%esp)
    2a96:	00 
    2a97:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a9e:	e8 dd 09 00 00       	call   3480 <printf>
      exit();
    ...
    2aaf:	c7 44 24 04 11 44 00 	movl   $0x4411,0x4(%esp)
    2ab6:	00 
    2ab7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2abe:	e8 bd 09 00 00       	call   3480 <printf>
    ...
    2acf:	c7 44 24 04 f8 43 00 	movl   $0x43f8,0x4(%esp)
    2ad6:	00 
    2ad7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ade:	e8 9d 09 00 00       	call   3480 <printf>
  ...
  if(n != 40){
    printf(1, "concreate not enough files in directory listing\n");
    2ae8:	c7 44 24 04 c0 4a 00 	movl   $0x4ac0,0x4(%esp)
    2aef:	00 
    2af0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2af7:	e8 84 09 00 00       	call   3480 <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
    2b19:	c7 44 24 04 3c 44 00 	movl   $0x443c,0x4(%esp)
    2b20:	00 
    2b21:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b28:	e8 53 09 00 00       	call   3480 <printf>

  unlink("f1");
    2b2d:	c7 04 24 83 3f 00 00 	movl   $0x3f83,(%esp)
    2b34:	e8 1f 08 00 00       	call   3358 <unlink>
  unlink("f2");
    2b39:	c7 04 24 87 3f 00 00 	movl   $0x3f87,(%esp)
  ...
  fname = pid ? "f1" : "f2";
    ...
    2b5b:	b8 87 3f 00 00       	mov    $0x3f87,%eax
  ...
  memset(buf, pid?'p':'c', 512);
    ...
    2b93:	c7 04 24 00 4c 00 00 	movl   $0x4c00,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    2ba7:	00 
    2ba8:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    2baf:	00 
  ...
  for(i = 0; i < 2; i++){
    ...
    2be4:	b8 83 3f 00 00       	mov    $0x3f83,%eax
    2be9:	75 05                	jne    2bf0 <twofiles+0xe0>
    2beb:	b8 87 3f 00 00       	mov    $0x3f87,%eax
    ...
    2c0c:	00 
    2c0d:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    2c14:	00 
    ...
    2c2b:	0f be 91 00 4c 00 00 	movsbl 0x4c00(%ecx),%edx
  ...
  fname = pid ? "f1" : "f2";
    2c49:	b8 83 3f 00 00       	mov    $0x3f83,%eax
    ...
    2c57:	c7 44 24 04 68 44 00 	movl   $0x4468,0x4(%esp)
    2c5e:	00 
    2c5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c66:	e8 15 08 00 00       	call   3480 <printf>
      exit();
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
      for(j = 0; j < n; j++){
        if(buf[j] != (i?'p':'c')){
          printf(1, "wrong char\n");
    2c70:	c7 44 24 04 5c 44 00 	movl   $0x445c,0x4(%esp)
    2c77:	00 
    2c78:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c7f:	e8 fc 07 00 00       	call   3480 <printf>
      total += n;
    }
    close(fd);
    if(total != 12*500){
  ...
  unlink("f1");
    2ca8:	c7 04 24 83 3f 00 00 	movl   $0x3f83,(%esp)
    2caf:	e8 a4 06 00 00       	call   3358 <unlink>
  unlink("f2");
    2cb4:	c7 04 24 87 3f 00 00 	movl   $0x3f87,(%esp)
    2cbb:	e8 98 06 00 00       	call   3358 <unlink>

  printf(1, "twofiles ok\n");
    2cc0:	c7 44 24 04 79 44 00 	movl   $0x4479,0x4(%esp)
    2cc7:	00 
    2cc8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ccf:	e8 ac 07 00 00       	call   3480 <printf>
}
  ...
  if(pid < 0){
    printf(1, "fork failed\n");
    2cdc:	c7 44 24 04 81 38 00 	movl   $0x3881,0x4(%esp)
    2ce3:	00 
    2ce4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ceb:	e8 90 07 00 00       	call   3480 <printf>
  ...
  for(i = 0; i < 12; i++){
    ...
    2cfc:	c7 44 24 04 4b 44 00 	movl   $0x444b,0x4(%esp)
    2d03:	00 
    2d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d0b:	e8 70 07 00 00       	call   3480 <printf>
      exit();
  ...
  if(fd < 0){
    printf(1, "create failed\n");
    2d15:	c7 44 24 04 35 3f 00 	movl   $0x3f35,0x4(%esp)
    2d1c:	00 
    2d1d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d24:	e8 57 07 00 00       	call   3480 <printf>
    exit();
    ...
    2d59:	85 c0                	test   %eax,%eax
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    2db5:	c7 44 24 04 20 4b 00 	movl   $0x4b20,0x4(%esp)
    2dbc:	00 
    2dbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dc4:	e8 b7 06 00 00       	call   3480 <printf>
      break;
    }
  }
  if(pid == 0)
  ...
  fd = open("sharedfd", 0);
    ...
    2dec:	00 
    2ded:	c7 04 24 86 44 00 00 	movl   $0x4486,(%esp)
  ...
  unlink("sharedfd");
    2e51:	c7 04 24 86 44 00 00 	movl   $0x4486,(%esp)
  ...
  if(nc == 10000 && np == 10000)
    ...
    2e6d:	c7 44 24 04 9c 44 00 	movl   $0x449c,0x4(%esp)
    2e74:	00 
    2e75:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e7c:	e8 ff 05 00 00       	call   3480 <printf>
}
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for writing");
    2e89:	c7 44 24 04 f4 4a 00 	movl   $0x4af4,0x4(%esp)
    2e90:	00 
    2e91:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e98:	e8 e3 05 00 00       	call   3480 <printf>
  unlink("sharedfd");
  if(nc == 10000 && np == 10000)
    printf(1, "sharedfd ok\n");
  else
  ...
  if(nc == 10000 && np == 10000)
    ...
    printf(1, "sharedfd ok\n");
    2ead:	c7 44 24 04 8f 44 00 	movl   $0x448f,0x4(%esp)
    2eb4:	00 
    2eb5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ebc:	e8 bf 05 00 00       	call   3480 <printf>
  else
    printf(1, "sharedfd oops %d %d\n", nc, np);
}
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for reading\n");
    2ec9:	c7 44 24 04 40 4b 00 	movl   $0x4b40,0x4(%esp)
    2ed0:	00 
    2ed1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ed8:	e8 a3 05 00 00       	call   3480 <printf>
  unlink("sharedfd");
  if(nc == 10000 && np == 10000)
    printf(1, "sharedfd ok\n");
  else
...
mem(void)
{
  ...
  printf(1, "mem test\n");
    2efb:	c7 44 24 04 b1 44 00 	movl   $0x44b1,0x4(%esp)
    2f02:	00 
    2f03:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f0a:	e8 71 05 00 00       	call   3480 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    2f3b:	e8 40 07 00 00       	call   3680 <malloc>
    ...
    2f4d:	e8 ae 06 00 00       	call   3600 <free>
    ...
    2f5f:	e8 1c 07 00 00       	call   3680 <malloc>
    if(m1 == 0) {
    2f64:	85 c0                	test   %eax,%eax
    2f66:	75 21                	jne    2f89 <mem+0x99>
      printf(1, "couldn't allocate mem?!!\n");
    2f68:	c7 44 24 04 bb 44 00 	movl   $0x44bb,0x4(%esp)
    2f6f:	00 
    2f70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f77:	e8 04 05 00 00       	call   3480 <printf>
      kill(ppid);
    ...
    2f8c:	e8 6f 06 00 00       	call   3600 <free>
    printf(1, "mem ok\n");
    2f91:	c7 44 24 04 d5 44 00 	movl   $0x44d5,0x4(%esp)
    2f98:	00 
    2f99:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2fa0:	e8 db 04 00 00       	call   3480 <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
    2fb6:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2fbb:	c7 44 24 04 dd 44 00 	movl   $0x44dd,0x4(%esp)
    2fc2:	00 
    2fc3:	89 04 24             	mov    %eax,(%esp)
    2fc6:	e8 b5 04 00 00       	call   3480 <printf>
  if(exec("echo", echoargv) < 0) {
    2fcb:	c7 44 24 04 b0 4b 00 	movl   $0x4bb0,0x4(%esp)
    2fd2:	00 
    2fd3:	c7 04 24 63 37 00 00 	movl   $0x3763,(%esp)
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0) {
    printf(stdout, "exec echo failed\n");
    2fe5:	a1 c4 4b 00 00       	mov    0x4bc4,%eax
    2fea:	c7 44 24 04 e8 44 00 	movl   $0x44e8,0x4(%esp)
    2ff1:	00 
    2ff2:	89 04 24             	mov    %eax,(%esp)
    2ff5:	e8 86 04 00 00       	call   3480 <printf>
    exit();
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    305d:	00 
    305e:	c7 04 24 0e 45 00 00 	movl   $0x450e,(%esp)
...
000033b0 <getpriority>:
SYSCALL(getpriority)
    33b0:	b8 17 00 00 00       	mov    $0x17,%eax
    33b5:	cd 40                	int    $0x40
    33b7:	c3                   	ret    

000033b8 <setpriority>:
SYSCALL(setpriority)
    33b8:	b8 18 00 00 00       	mov    $0x18,%eax
    33bd:	cd 40                	int    $0x40
    33bf:	c3                   	ret    

000033c0 <getaffinity>:
SYSCALL(getaffinity)
    33c0:	b8 19 00 00 00       	mov    $0x19,%eax
    33c5:	cd 40                	int    $0x40
    33c7:	c3                   	ret    

000033c8 <setaffinity>:
SYSCALL(setaffinity)
    33c8:	b8 1a 00 00 00       	mov    $0x1a,%eax
    33cd:	cd 40                	int    $0x40
    33cf:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    33d3:	83 ec 18             	sub    $0x18,%esp
    33d6:	88 55 fc             	mov    %dl,-0x4(%ebp)
  write(fd, &c, 1);
    33d9:	8d 55 fc             	lea    -0x4(%ebp),%edx
    33dc:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    33e3:	00 
    33e4:	89 54 24 04          	mov    %edx,0x4(%esp)
    33e8:	89 04 24             	mov    %eax,(%esp)
    33eb:	e8 38 ff ff ff       	call   3328 <write>
}
    33f0:	c9                   	leave  
    33f1:	c3                   	ret    
    33f2:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    33f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3403:	57                   	push   %edi
    3404:	56                   	push   %esi
    3405:	89 ce                	mov    %ecx,%esi
    3407:	53                   	push   %ebx
    3408:	83 ec 1c             	sub    $0x1c,%esp
  char buf[16];
  int i, neg;
  uint x;
...
printint(int fd, int xx, int base, int sgn)
{
    340e:	89 45 dc             	mov    %eax,-0x24(%ebp)
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    3411:	85 c9                	test   %ecx,%ecx
    3413:	74 04                	je     3419 <printint+0x19>
    3415:	85 d2                	test   %edx,%edx
    3417:	78 54                	js     346d <printint+0x6d>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    3419:	89 d0                	mov    %edx,%eax
    341b:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    3422:	31 db                	xor    %ebx,%ebx
    3424:	8d 7d e4             	lea    -0x1c(%ebp),%edi
  }

  i = 0;
  do{
    buf[i++] = digits[x % base];
    3427:	31 d2                	xor    %edx,%edx
    3429:	f7 f6                	div    %esi
    342b:	89 c1                	mov    %eax,%ecx
    342d:	0f b6 82 9f 4b 00 00 	movzbl 0x4b9f(%edx),%eax
    3434:	88 04 3b             	mov    %al,(%ebx,%edi,1)
    3437:	83 c3 01             	add    $0x1,%ebx
  }while((x /= base) != 0);
    343a:	85 c9                	test   %ecx,%ecx
    343c:	89 c8                	mov    %ecx,%eax
    343e:	75 e7                	jne    3427 <printint+0x27>
  if(neg)
    3440:	8b 45 e0             	mov    -0x20(%ebp),%eax
    3443:	85 c0                	test   %eax,%eax
    3445:	74 08                	je     344f <printint+0x4f>
    buf[i++] = '-';
    3447:	c6 44 1d e4 2d       	movb   $0x2d,-0x1c(%ebp,%ebx,1)
    344c:	83 c3 01             	add    $0x1,%ebx
    344f:	8d 1c 1f             	lea    (%edi,%ebx,1),%ebx

  while(--i >= 0)
    putc(fd, buf[i]);
    3452:	0f be 53 ff          	movsbl -0x1(%ebx),%edx
    3456:	83 eb 01             	sub    $0x1,%ebx
    3459:	8b 45 dc             	mov    -0x24(%ebp),%eax
    345c:	e8 6f ff ff ff       	call   33d0 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3461:	39 fb                	cmp    %edi,%ebx
    3463:	75 ed                	jne    3452 <printint+0x52>
    putc(fd, buf[i]);
}
    3465:	83 c4 1c             	add    $0x1c,%esp
    3468:	5b                   	pop    %ebx
    3469:	5e                   	pop    %esi
    346a:	5f                   	pop    %edi
    346b:	5d                   	pop    %ebp
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
    346d:	89 d0                	mov    %edx,%eax
    346f:	f7 d8                	neg    %eax
    3471:	c7 45 e0 01 00 00 00 	movl   $0x1,-0x20(%ebp)
    3478:	eb a8                	jmp    3422 <printint+0x22>
    347a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3489:	8b 55 0c             	mov    0xc(%ebp),%edx
    348c:	0f b6 02             	movzbl (%edx),%eax
    348f:	84 c0                	test   %al,%al
    3491:	0f 84 87 00 00 00    	je     351e <printf+0x9e>
  char *s;
  int c, i, state;
  uint *ap;
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    3497:	8d 4d 10             	lea    0x10(%ebp),%ecx
    349a:	31 ff                	xor    %edi,%edi
    349c:	31 f6                	xor    %esi,%esi
    349e:	89 4d f0             	mov    %ecx,-0x10(%ebp)
    34a1:	eb 18                	jmp    34bb <printf+0x3b>
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    34a3:	83 fb 25             	cmp    $0x25,%ebx
    34a6:	0f 85 7a 00 00 00    	jne    3526 <printf+0xa6>
    34ac:	66 be 25 00          	mov    $0x25,%si
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    34b0:	83 c7 01             	add    $0x1,%edi
    34b3:	0f b6 04 3a          	movzbl (%edx,%edi,1),%eax
    34b7:	84 c0                	test   %al,%al
    34b9:	74 63                	je     351e <printf+0x9e>
    c = fmt[i] & 0xff;
    if(state == 0){
    34bb:	85 f6                	test   %esi,%esi
  uint *ap;
  ...
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    34bd:	0f b6 d8             	movzbl %al,%ebx
    if(state == 0){
    34c0:	74 e1                	je     34a3 <printf+0x23>
      if(c == '%'){
        state = '%';
      } else {
        putc(fd, c);
    ...
    34c2:	83 fe 25             	cmp    $0x25,%esi
    34c5:	75 e9                	jne    34b0 <printf+0x30>
      if(c == 'd'){
    34c7:	83 fb 64             	cmp    $0x64,%ebx
    34ca:	0f 84 f0 00 00 00    	je     35c0 <printf+0x140>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    34d0:	83 fb 78             	cmp    $0x78,%ebx
    34d3:	74 64                	je     3539 <printf+0xb9>
    34d5:	83 fb 70             	cmp    $0x70,%ebx
    34d8:	74 5f                	je     3539 <printf+0xb9>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    34da:	83 fb 73             	cmp    $0x73,%ebx
    34dd:	8d 76 00             	lea    0x0(%esi),%esi
    34e0:	74 7e                	je     3560 <printf+0xe0>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    34e2:	83 fb 63             	cmp    $0x63,%ebx
    34e5:	0f 84 b9 00 00 00    	je     35a4 <printf+0x124>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    34eb:	83 fb 25             	cmp    $0x25,%ebx
    34ee:	66 90                	xchg   %ax,%ax
    34f0:	0f 84 f2 00 00 00    	je     35e8 <printf+0x168>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    34f6:	8b 45 08             	mov    0x8(%ebp),%eax
    34f9:	ba 25 00 00 00       	mov    $0x25,%edx
  int c, i, state;
  uint *ap;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3501:	31 f6                	xor    %esi,%esi
        ...
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    3503:	e8 c8 fe ff ff       	call   33d0 <putc>
        putc(fd, c);
    3508:	8b 45 08             	mov    0x8(%ebp),%eax
    350b:	0f be d3             	movsbl %bl,%edx
    350e:	e8 bd fe ff ff       	call   33d0 <putc>
    3513:	8b 55 0c             	mov    0xc(%ebp),%edx
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3516:	0f b6 04 3a          	movzbl (%edx,%edi,1),%eax
    351a:	84 c0                	test   %al,%al
    351c:	75 9d                	jne    34bb <printf+0x3b>
        putc(fd, c);
      }
      state = 0;
    }
    ...
    if(state == 0){
      if(c == '%'){
        ...
        putc(fd, c);
    3526:	8b 45 08             	mov    0x8(%ebp),%eax
    3529:	0f be d3             	movsbl %bl,%edx
    352c:	e8 9f fe ff ff       	call   33d0 <putc>
    3531:	8b 55 0c             	mov    0xc(%ebp),%edx
    3534:	e9 77 ff ff ff       	jmp    34b0 <printf+0x30>
    } else if(state == '%'){
      if(c == 'd'){
        printint(fd, *ap, 10, 1);
        ap++;
        ...
        printint(fd, *ap, 16, 0);
    3539:	8b 45 f0             	mov    -0x10(%ebp),%eax
    353c:	b9 10 00 00 00       	mov    $0x10,%ecx
        ap++;
    3541:	31 f6                	xor    %esi,%esi
    } else if(state == '%'){
      if(c == 'd'){
        printint(fd, *ap, 10, 1);
        ap++;
        ...
        printint(fd, *ap, 16, 0);
    3543:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    354a:	8b 10                	mov    (%eax),%edx
    354c:	8b 45 08             	mov    0x8(%ebp),%eax
    354f:	e8 ac fe ff ff       	call   3400 <printint>
    3554:	8b 55 0c             	mov    0xc(%ebp),%edx
        ap++;
    3557:	83 45 f0 04          	addl   $0x4,-0x10(%ebp)
    355b:	e9 50 ff ff ff       	jmp    34b0 <printf+0x30>
      } else if(c == 's'){
        s = (char*)*ap;
    3560:	8b 4d f0             	mov    -0x10(%ebp),%ecx
    3563:	8b 01                	mov    (%ecx),%eax
        ap++;
    3565:	83 c1 04             	add    $0x4,%ecx
    3568:	89 4d f0             	mov    %ecx,-0x10(%ebp)
        if(s == 0)
    356b:	b9 98 4b 00 00       	mov    $0x4b98,%ecx
    3570:	85 c0                	test   %eax,%eax
    3572:	75 2c                	jne    35a0 <printf+0x120>
          s = "(null)";
        while(*s != 0){
    3574:	0f b6 01             	movzbl (%ecx),%eax
    3577:	84 c0                	test   %al,%al
    3579:	74 1e                	je     3599 <printf+0x119>
    357b:	89 cb                	mov    %ecx,%ebx
    357d:	8d 76 00             	lea    0x0(%esi),%esi
          putc(fd, *s);
    3580:	0f be d0             	movsbl %al,%edx
    3583:	8b 45 08             	mov    0x8(%ebp),%eax
    3586:	e8 45 fe ff ff       	call   33d0 <putc>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    358b:	0f b6 43 01          	movzbl 0x1(%ebx),%eax
    358f:	83 c3 01             	add    $0x1,%ebx
    3592:	84 c0                	test   %al,%al
    3594:	75 ea                	jne    3580 <printf+0x100>
    3596:	8b 55 0c             	mov    0xc(%ebp),%edx
        ...
        putc(fd, '%');
        putc(fd, c);
    3599:	31 f6                	xor    %esi,%esi
    359b:	e9 10 ff ff ff       	jmp    34b0 <printf+0x30>
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
        ...
        s = (char*)*ap;
    35a0:	89 c1                	mov    %eax,%ecx
    35a2:	eb d0                	jmp    3574 <printf+0xf4>
        while(*s != 0){
          putc(fd, *s);
          s++;
        }
        ...
        putc(fd, *ap);
    35a4:	8b 45 f0             	mov    -0x10(%ebp),%eax
        ap++;
    35a7:	31 f6                	xor    %esi,%esi
        while(*s != 0){
          putc(fd, *s);
          s++;
        }
        ...
        putc(fd, *ap);
    35a9:	0f be 10             	movsbl (%eax),%edx
    35ac:	8b 45 08             	mov    0x8(%ebp),%eax
    35af:	e8 1c fe ff ff       	call   33d0 <putc>
    35b4:	8b 55 0c             	mov    0xc(%ebp),%edx
        ap++;
    35b7:	83 45 f0 04          	addl   $0x4,-0x10(%ebp)
    35bb:	e9 f0 fe ff ff       	jmp    34b0 <printf+0x30>
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
      if(c == 'd'){
        printint(fd, *ap, 10, 1);
    35c0:	8b 45 f0             	mov    -0x10(%ebp),%eax
    35c3:	b9 0a 00 00 00       	mov    $0xa,%ecx
        ap++;
    35c8:	66 31 f6             	xor    %si,%si
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
      if(c == 'd'){
        printint(fd, *ap, 10, 1);
    35cb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35d2:	8b 10                	mov    (%eax),%edx
    35d4:	8b 45 08             	mov    0x8(%ebp),%eax
    35d7:	e8 24 fe ff ff       	call   3400 <printint>
    35dc:	8b 55 0c             	mov    0xc(%ebp),%edx
        ap++;
    35df:	83 45 f0 04          	addl   $0x4,-0x10(%ebp)
    35e3:	e9 c8 fe ff ff       	jmp    34b0 <printf+0x30>
        }
      } else if(c == 'c'){
        putc(fd, *ap);
        ap++;
    ...
    35eb:	ba 25 00 00 00       	mov    $0x25,%edx
    35f0:	31 f6                	xor    %esi,%esi
    35f2:	e8 d9 fd ff ff       	call   33d0 <putc>
    35f7:	8b 55 0c             	mov    0xc(%ebp),%edx
    35fa:	e9 b1 fe ff ff       	jmp    34b0 <printf+0x30>
    35ff:	90                   	nop    
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3601:	8b 0d e8 4b 00 00    	mov    0x4be8,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*) ap - 1;
    ...
    360e:	83 eb 08             	sub    $0x8,%ebx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3611:	39 d9                	cmp    %ebx,%ecx
    3613:	73 18                	jae    362d <free+0x2d>
    3615:	8b 11                	mov    (%ecx),%edx
    3617:	39 d3                	cmp    %edx,%ebx
    3619:	72 17                	jb     3632 <free+0x32>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    361b:	39 d1                	cmp    %edx,%ecx
    361d:	72 08                	jb     3627 <free+0x27>
    361f:	39 d9                	cmp    %ebx,%ecx
    3621:	72 0f                	jb     3632 <free+0x32>
    3623:	39 d3                	cmp    %edx,%ebx
    3625:	72 0b                	jb     3632 <free+0x32>
    3627:	89 d1                	mov    %edx,%ecx
free(void *ap)
{
  Header *bp, *p;
  ...
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3629:	39 d9                	cmp    %ebx,%ecx
    362b:	72 e8                	jb     3615 <free+0x15>
    362d:	8b 11                	mov    (%ecx),%edx
    362f:	90                   	nop    
    3630:	eb e9                	jmp    361b <free+0x1b>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    3632:	8b 73 04             	mov    0x4(%ebx),%esi
    3635:	8d 04 f3             	lea    (%ebx,%esi,8),%eax
    3638:	39 d0                	cmp    %edx,%eax
    363a:	74 18                	je     3654 <free+0x54>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    363c:	89 13                	mov    %edx,(%ebx)
  if(p + p->s.size == bp){
    363e:	8b 51 04             	mov    0x4(%ecx),%edx
    3641:	8d 04 d1             	lea    (%ecx,%edx,8),%eax
    3644:	39 d8                	cmp    %ebx,%eax
    3646:	74 20                	je     3668 <free+0x68>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3648:	89 19                	mov    %ebx,(%ecx)
  freep = p;
}
    364a:	5b                   	pop    %ebx
    364b:	5e                   	pop    %esi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    364d:	89 0d e8 4b 00 00    	mov    %ecx,0x4be8
}
    3653:	c3                   	ret    
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
  ...
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    3654:	03 72 04             	add    0x4(%edx),%esi
    bp->s.ptr = p->s.ptr->s.ptr;
    3657:	8b 02                	mov    (%edx),%eax
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    3659:	89 73 04             	mov    %esi,0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    365c:	8b 51 04             	mov    0x4(%ecx),%edx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    365f:	89 03                	mov    %eax,(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    3661:	8d 04 d1             	lea    (%ecx,%edx,8),%eax
    3664:	39 d8                	cmp    %ebx,%eax
    3666:	75 e0                	jne    3648 <free+0x48>
    p->s.size += bp->s.size;
    3668:	03 53 04             	add    0x4(%ebx),%edx
    366b:	89 51 04             	mov    %edx,0x4(%ecx)
    p->s.ptr = bp->s.ptr;
    366e:	8b 13                	mov    (%ebx),%edx
    3670:	89 11                	mov    %edx,(%ecx)
  } else
    p->s.ptr = bp;
  freep = p;
}
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    3675:	89 0d e8 4b 00 00    	mov    %ecx,0x4be8
}
    367b:	c3                   	ret    
    367c:	8d 74 26 00          	lea    0x0(%esi),%esi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    368c:	8b 15 e8 4b 00 00    	mov    0x4be8,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3692:	83 c0 07             	add    $0x7,%eax
    3695:	c1 e8 03             	shr    $0x3,%eax
  if((prevp = freep) == 0){
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    369a:	8d 58 01             	lea    0x1(%eax),%ebx
  if((prevp = freep) == 0){
    369d:	0f 84 8a 00 00 00    	je     372d <malloc+0xad>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    36a3:	8b 0a                	mov    (%edx),%ecx
    if(p->s.size >= nunits){
    36a5:	8b 41 04             	mov    0x4(%ecx),%eax
    36a8:	39 c3                	cmp    %eax,%ebx
    36aa:	76 1a                	jbe    36c6 <malloc+0x46>
        p->s.size -= nunits;
        p += p->s.size;
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*) (p + 1);
    36ac:	8d 3c dd 00 00 00 00 	lea    0x0(,%ebx,8),%edi
    }
    if(p == freep)
    36b3:	3b 0d e8 4b 00 00    	cmp    0x4be8,%ecx
    36b9:	89 ca                	mov    %ecx,%edx
    36bb:	74 29                	je     36e6 <malloc+0x66>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    36bd:	8b 0a                	mov    (%edx),%ecx
    if(p->s.size >= nunits){
    36bf:	8b 41 04             	mov    0x4(%ecx),%eax
    36c2:	39 c3                	cmp    %eax,%ebx
    36c4:	77 ed                	ja     36b3 <malloc+0x33>
      if(p->s.size == nunits)
    36c6:	39 c3                	cmp    %eax,%ebx
    36c8:	74 5d                	je     3727 <malloc+0xa7>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    36ca:	29 d8                	sub    %ebx,%eax
    36cc:	89 41 04             	mov    %eax,0x4(%ecx)
        p += p->s.size;
    36cf:	8d 0c c1             	lea    (%ecx,%eax,8),%ecx
        p->s.size = nunits;
    36d2:	89 59 04             	mov    %ebx,0x4(%ecx)
      }
      freep = prevp;
    36d5:	89 15 e8 4b 00 00    	mov    %edx,0x4be8
      return (void*) (p + 1);
    36db:	8d 41 08             	lea    0x8(%ecx),%eax
    }
    if(p == freep)
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    36e6:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
    36ec:	89 de                	mov    %ebx,%esi
    36ee:	89 f8                	mov    %edi,%eax
    36f0:	76 29                	jbe    371b <malloc+0x9b>
    nu = 4096;
  p = sbrk(nu * sizeof(Header));
    36f2:	89 04 24             	mov    %eax,(%esp)
    36f5:	e8 96 fc ff ff       	call   3390 <sbrk>
  if(p == (char*) -1)
    36fa:	83 f8 ff             	cmp    $0xffffffff,%eax
    36fd:	74 18                	je     3717 <malloc+0x97>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    36ff:	89 70 04             	mov    %esi,0x4(%eax)
  free((void*)(hp + 1));
    3702:	83 c0 08             	add    $0x8,%eax
    3705:	89 04 24             	mov    %eax,(%esp)
    3708:	e8 f3 fe ff ff       	call   3600 <free>
  return freep;
    370d:	8b 15 e8 4b 00 00    	mov    0x4be8,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
    ...
    3715:	75 a6                	jne    36bd <malloc+0x3d>
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    3717:	31 c0                	xor    %eax,%eax
    3719:	eb c3                	jmp    36de <malloc+0x5e>
morecore(uint nu)
{
  char *p;
  Header *hp;
  ...
  if(nu < 4096)
    371b:	be 00 10 00 00       	mov    $0x1000,%esi
    3720:	b8 00 80 00 00       	mov    $0x8000,%eax
    3725:	eb cb                	jmp    36f2 <malloc+0x72>
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
        prevp->s.ptr = p->s.ptr;
    3727:	8b 01                	mov    (%ecx),%eax
    3729:	89 02                	mov    %eax,(%edx)
    372b:	eb a8                	jmp    36d5 <malloc+0x55>
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
    372d:	ba e0 4b 00 00       	mov    $0x4be0,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    3732:	c7 05 e8 4b 00 00 e0 	movl   $0x4be0,0x4be8
    3739:	4b 00 00 
    373c:	c7 05 e0 4b 00 00 e0 	movl   $0x4be0,0x4be0
    3743:	4b 00 00 
    base.s.size = 0;
    3746:	c7 05 e4 4b 00 00 00 	movl   $0x0,0x4be4
    374d:	00 00 00 
    3750:	e9 4e ff ff ff       	jmp    36a3 <malloc+0x23>
