...
main(void)
{
  ...
  19:	00 
  1a:	c7 04 24 65 07 00 00 	movl   $0x765,(%esp)
  ...
  74:	74 d0                	je     46 <main+0x46>
      printf(1, "zombie!\n");
  76:	c7 44 24 04 ac 07 00 	movl   $0x7ac,0x4(%esp)
  7d:	00 
  ...
  for(;;){
    ...
    if(pid < 0){
      printf(1, "init: fork failed\n");
  8c:	c7 44 24 04 80 07 00 	movl   $0x780,0x4(%esp)
  93:	00 
  ...
  a0:	e8 73 02 00 00       	call   318 <exit>
    ...
    if(pid == 0){
      exec("sh", argv);
  a5:	c7 44 24 04 d0 07 00 	movl   $0x7d0,0x4(%esp)
  ac:	00 
  ad:	c7 04 24 93 07 00 00 	movl   $0x793,(%esp)
  b4:	e8 97 02 00 00       	call   350 <exec>
      printf(1, "init: exec sh failed\n");
  b9:	c7 44 24 04 96 07 00 	movl   $0x796,0x4(%esp)
  c0:	00 
...
main(void)
{
  ...
  e1:	00 
  e2:	c7 04 24 65 07 00 00 	movl   $0x765,(%esp)
  e9:	e8 72 02 00 00       	call   360 <mknod>
    open("console", O_RDWR);
  ee:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  f5:	00 
  f6:	c7 04 24 65 07 00 00 	movl   $0x765,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43d:	0f b6 82 bc 07 00 00 	movzbl 0x7bc(%edx),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 578:	89 4d f0             	mov    %ecx,-0x10(%ebp)
        if(s == 0)
 57b:	b9 b5 07 00 00       	mov    $0x7b5,%ecx
