...
brelse(struct buf *b)
{
  if((b->flags & B_BUSY) == 0)
    panic("brelse");
  100063:	c7 04 24 c0 61 10 00 	movl   $0x1061c0,(%esp)
...
bwrite(struct buf *b)
{
  if((b->flags & B_BUSY) == 0)
    panic("bwrite");
  10008d:	c7 04 24 c7 61 10 00 	movl   $0x1061c7,(%esp)
  ...
  100148:	c3                   	ret    
{
  ...
  10015b:	c7 04 24 ce 61 10 00 	movl   $0x1061ce,(%esp)
...
binit(void)
{
  ...
  100186:	c7 44 24 04 df 61 10 	movl   $0x1061df,0x4(%esp)
  10018d:	00 
...
consoleinit(void)
{
  ...
  1001f6:	c7 44 24 04 e6 61 10 	movl   $0x1061e6,0x4(%esp)
  1001fd:	00 
  1001fe:	c7 04 24 c0 77 10 00 	movl   $0x1077c0,(%esp)
  100205:	e8 46 36 00 00       	call   103850 <initlock>
  initlock(&input.lock, "input");
  10020a:	c7 44 24 04 ee 61 10 	movl   $0x1061ee,0x4(%esp)
  100211:	00 
...
cli(void)
{
  ...
  100286:	e8 75 4b 00 00       	call   104e00 <uartputc>
}
...
outb(ushort port, uchar data)
{
  ...
  100329:	e8 d2 4a 00 00       	call   104e00 <uartputc>
  10032e:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
  100335:	e8 c6 4a 00 00       	call   104e00 <uartputc>
  10033a:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
  100341:	e8 ba 4a 00 00       	call   104e00 <uartputc>
...
printint(int xx, int base, int sgn)
{
  ...
  100466:	0f b6 82 0e 62 10 00 	movzbl 0x10620e(%edx),%eax
  ...
  1004ce:	85 c0                	test   %eax,%eax
{
  ...
  1005c0:	ba f4 61 10 00       	mov    $0x1061f4,%edx
  ...
  100892:	bb 02 00 00 00       	mov    $0x2,%ebx
{
  ...
  1008a4:	c7 04 24 fb 61 10 00 	movl   $0x1061fb,(%esp)
  ...
  cprintf("\n");
  1008bf:	c7 04 24 36 66 10 00 	movl   $0x106636,(%esp)
  ...
  1008dd:	c7 04 24 0a 62 10 00 	movl   $0x10620a,(%esp)
  ...
  1008f4:	c7 04 24 0a 62 10 00 	movl   $0x10620a,(%esp)
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  if(!(pgdir = setupkvm()))
  10098f:	e8 1c 52 00 00       	call   105bb0 <setupkvm>
  ...
  100a16:	e8 35 54 00 00       	call   105e50 <allocuvm>
  ...
  100a44:	e8 d7 54 00 00       	call   105f20 <loaduvm>
 ...
 bad:
  ...
  100a61:	e8 aa 52 00 00       	call   105d10 <freevm>
  ...
  100a9e:	e8 ad 53 00 00       	call   105e50 <allocuvm>
  ...
  100abe:	e8 9d 4f 00 00       	call   105a60 <uva2ka>
  ...
  *(uint*)(mem+sp-spbottom) = 0xffffffff;   // fake return pc
  ...
  100c3e:	e8 8d 53 00 00       	call   105fd0 <switchuvm>

  freevm(oldpgdir);
  100c43:	89 1c 24             	mov    %ebx,(%esp)
  100c46:	e8 c5 50 00 00       	call   105d10 <freevm>
...
filewrite(struct file *f, char *addr, int n)
{
  ...
  panic("filewrite");
  100d00:	c7 04 24 1f 62 10 00 	movl   $0x10621f,(%esp)
...
fileread(struct file *f, char *addr, int n)
{
  ...
  panic("fileread");
  100da0:	c7 04 24 29 62 10 00 	movl   $0x106229,(%esp)
...
filedup(struct file *f)
{
  ...
  if(f->ref < 1)
    panic("filedup");
  100e37:	c7 04 24 32 62 10 00 	movl   $0x106232,(%esp)
  ...
  100f7a:	e9 f1 08 00 00       	jmp    101870 <iput>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
  100f7f:	c7 04 24 3a 62 10 00 	movl   $0x10623a,(%esp)
...
fileinit(void)
{
  ...
  100f96:	c7 44 24 04 44 62 10 	movl   $0x106244,0x4(%esp)
  100f9d:	00 
...
iget(uint dev, uint inum)
{
  ...
  if(empty == 0)
    panic("iget: no inodes");
  1010b4:	c7 04 24 4b 62 10 00 	movl   $0x10624b,(%esp)
...
balloc(uint dev)
{
  ...
  panic("balloc: out of blocks");
  101265:	c7 04 24 5b 62 10 00 	movl   $0x10625b,(%esp)
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
  10131c:	c7 04 24 71 62 10 00 	movl   $0x106271,(%esp)
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
  101693:	c7 04 24 84 62 10 00 	movl   $0x106284,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !(ip->flags & I_BUSY) || ip->ref < 1)
    panic("iunlock");
  1016e4:	c7 04 24 96 62 10 00 	movl   $0x106296,(%esp)
...
ialloc(uint dev, short type)
{
  ...
  panic("ialloc: no inodes");
  1017a4:	c7 04 24 9e 62 10 00 	movl   $0x10629e,(%esp)
...
bzero(int dev, int bno)
{
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
  101863:	c7 04 24 b0 62 10 00 	movl   $0x1062b0,(%esp)
  ...
  10199e:	e9 51 ff ff ff       	jmp    1018f4 <iput+0x84>
{
  ...
  if(ip->ref == 1 && (ip->flags & I_VALID) && ip->nlink == 0){
    ...
    if(ip->flags & I_BUSY)
      panic("iput busy");
  1019a3:	c7 04 24 c3 62 10 00 	movl   $0x1062c3,(%esp)
...
dirlink(struct inode *dp, char *name, uint inum)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
  101a67:	c7 04 24 cd 62 10 00 	movl   $0x1062cd,(%esp)
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
  101a89:	c7 04 24 92 68 10 00 	movl   $0x106892,(%esp)
...
ilock(struct inode *ip)
{
  ...
  101b9d:	75 81                	jne    101b20 <ilock+0x60>
      panic("ilock: no type");
  101b9f:	c7 04 24 e0 62 10 00 	movl   $0x1062e0,(%esp)
  ...
  101bac:	8d 74 26 00          	lea    0x0(%esi),%esi
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
  101bb0:	c7 04 24 da 62 10 00 	movl   $0x1062da,(%esp)
...
iinit(void)
{
  ...
  101d76:	c7 44 24 04 ef 62 10 	movl   $0x1062ef,0x4(%esp)
  101d7d:	00 
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
  101e53:	c7 04 24 f6 62 10 00 	movl   $0x1062f6,(%esp)
...
iderw(struct buf *b)
{
  ...
  if(!(b->flags & B_BUSY))
    panic("iderw: buf not busy");
  101f04:	c7 04 24 ff 62 10 00 	movl   $0x1062ff,(%esp)
  101f0b:	e8 70 e9 ff ff       	call   100880 <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  101f10:	c7 04 24 13 63 10 00 	movl   $0x106313,(%esp)
  101f17:	e8 64 e9 ff ff       	call   100880 <panic>
  if(b->dev != 0 && !havedisk1)
    panic("idrw: ide disk 1 not present");
  101f1c:	c7 04 24 28 63 10 00 	movl   $0x106328,(%esp)
...
insl(int port, void *addr, int cnt)
{
  ...
  101fb7:	e8 d4 19 00 00       	call   103990 <release>
    cprintf("Spurious IDE interrupt.\n");
  101fbc:	c7 04 24 45 63 10 00 	movl   $0x106345,(%esp)
...
ideinit(void)
{
  ...
  101fd6:	c7 44 24 04 5e 63 10 	movl   $0x10635e,0x4(%esp)
  101fdd:	00 
...
ioapicinit(void)
{
  ...
  10212f:	c7 04 24 64 63 10 00 	movl   $0x106364,(%esp)
...
kfree(char *v)
{
  ...
  1021d0:	76 0e                	jbe    1021e0 <kfree+0x30>
    panic("kfree");
  1021d2:	c7 04 24 96 63 10 00 	movl   $0x106396,(%esp)
...
kinit(void)
{
  ...
  initlock(&kmem.lock, "kmem");
  102242:	c7 44 24 04 9c 63 10 	movl   $0x10639c,0x4(%esp)
  102249:	00 
...
inb(ushort port)
{
  ...
  1022e5:	0f b6 81 c0 63 10 00 	movzbl 0x1063c0(%ecx),%eax
  ...
  102318:	0f b6 91 c0 64 10 00 	movzbl 0x1064c0(%ecx),%edx
  10231f:	0f b6 81 c0 63 10 00 	movzbl 0x1063c0(%ecx),%eax
  ...
  shift ^= togglecode[data];
  c = charcode[shift & (CTL | SHIFT)][data];
  102335:	8b 14 95 c0 65 10 00 	mov    0x1065c0(,%edx,4),%edx
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
readeflags(void)
{
  ...
  1023f6:	c7 04 24 d0 65 10 00 	movl   $0x1065d0,(%esp)
...
lapicinit(int c)
{
  ...
  102422:	c7 04 24 fc 65 10 00 	movl   $0x1065fc,(%esp)
...
mpmain(void)
{
  ...
  1025e5:	74 16                	je     1025fd <mpmain+0x2d>
    ksegment();
  1025e7:	e8 94 3a 00 00       	call   106080 <ksegment>
...
mainc(void)
{
  ...
  102650:	c7 04 24 21 66 10 00 	movl   $0x106621,(%esp)
  102657:	89 44 24 04          	mov    %eax,0x4(%esp)
  10265b:	e8 60 de ff ff       	call   1004c0 <cprintf>
  kvmalloc();      // initialize the kernel page table
  102660:	e8 fb 35 00 00       	call   105c60 <kvmalloc>
  pinit();         // process table
  102665:	e8 c6 11 00 00       	call   103830 <pinit>
  tvinit();        // trap vectors
  10266a:	e8 b1 24 00 00       	call   104b20 <tvinit>
  10266f:	90                   	nop    
  binit();         // buffer cache
  ...
  if(!ismp)
    timerinit();   // uniprocessor timer
  10273d:	e8 4e 23 00 00       	call   104a90 <timerinit>
...
jkstack(void)
{
  ...
  10275d:	75 0c                	jne    10276b <jkstack+0x1b>
    panic("jkstack\n");
  10275f:	c7 04 24 38 66 10 00 	movl   $0x106638,(%esp)
  ...
  panic("jkstack");
  102777:	c7 04 24 41 66 10 00 	movl   $0x106641,(%esp)
...
main(void)
{
  ...
  1027b3:	e8 c8 38 00 00       	call   106080 <ksegment>
  ...
  1027ca:	e8 b1 26 00 00       	call   104e80 <uartinit>
  1027cf:	90                   	nop    
...
mpsearch1(uchar *addr, int len)
{
  ...
  102848:	c7 04 24 49 66 10 00 	movl   $0x106649,(%esp)
  ...
  10286e:	00 
  10286f:	c7 44 24 04 5c 66 10 	movl   $0x10665c,0x4(%esp)
  102876:	00 
...
mpconfig(struct mp **pmp)
{
  ...
  102903:	00 
  102904:	c7 44 24 04 61 66 10 	movl   $0x106661,0x4(%esp)
  10290b:	00 
...
mpconfig(struct mp **pmp)
{
  ...
  1029c2:	c7 04 24 88 66 10 00 	movl   $0x106688,(%esp)
  1029c9:	89 44 24 04          	mov    %eax,0x4(%esp)
  1029cd:	e8 ee da ff ff       	call   1004c0 <cprintf>
      panic("mpinit");
  1029d2:	c7 04 24 81 66 10 00 	movl   $0x106681,(%esp)
  ...
  1029e3:	ff 24 85 a8 66 10 00 	jmp    *0x1066a8(,%eax,4)
      ncpu++;
...
outb(ushort port, uchar data)
{
  ...
  102a7c:	c7 04 24 66 66 10 00 	movl   $0x106666,(%esp)
  102a83:	89 44 24 08          	mov    %eax,0x8(%esp)
  102a87:	e8 34 da ff ff       	call   1004c0 <cprintf>
        panic("mpinit");
  102a8c:	c7 04 24 81 66 10 00 	movl   $0x106681,(%esp)
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  102e81:	c7 44 24 04 bc 66 10 	movl   $0x1066bc,0x4(%esp)
  102e88:	00 
...
sched(void)
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
  103075:	c7 04 24 c1 66 10 00 	movl   $0x1066c1,(%esp)
  10307c:	e8 ff d7 ff ff       	call   100880 <panic>
  if(cpu->ncli != 1)
    panic("sched locks");
  103081:	c7 04 24 d3 66 10 00 	movl   $0x1066d3,(%esp)
  103088:	e8 f3 d7 ff ff       	call   100880 <panic>
  if(proc->state == RUNNING)
    panic("sched running");
  10308d:	c7 04 24 df 66 10 00 	movl   $0x1066df,(%esp)
  103094:	e8 e7 d7 ff ff       	call   100880 <panic>
  if(readeflags()&FL_IF)
    panic("sched interruptible");
  103099:	c7 04 24 ed 66 10 00 	movl   $0x1066ed,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  if(proc == 0)
    panic("sleep");
  10315b:	c7 04 24 01 67 10 00 	movl   $0x106701,(%esp)
  103162:	e8 19 d7 ff ff       	call   100880 <panic>

  if(lk == 0)
    panic("sleep without lk");
  103167:	c7 04 24 07 67 10 00 	movl   $0x106707,(%esp)
...
sti(void)
{
  ...
  1031fc:	e8 cf 2d 00 00       	call   105fd0 <switchuvm>
      p->state = RUNNING;
  ...
  103224:	e8 33 0a 00 00       	call   103c5c <swtch>
      switchkvm();
  103229:	e8 82 27 00 00       	call   1059b0 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
wait(void)
{
  ...
  1032e1:	e8 2a 2a 00 00       	call   105d10 <freevm>
        p->state = UNUSED;
...
exit(void)
{
  ...
  103358:	75 0c                	jne    103366 <exit+0x26>
    panic("init exiting");
  10335a:	c7 04 24 18 67 10 00 	movl   $0x106718,(%esp)
  ...
  panic("zombie exit");
  103414:	c7 04 24 25 67 10 00 	movl   $0x106725,(%esp)
...
found:
  ...
  *(uint*)sp = (uint)trapret;
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
  103492:	c7 82 b0 0f 00 00 e0 	movl   $0x104ae0,0xfb0(%edx)
  103499:	4a 10 00 
...
fork(void)
{
  ...
  10351f:	e8 6c 28 00 00       	call   105d90 <copyuvm>
...
growproc(int n)
{
  ...
  103622:	e8 a9 29 00 00       	call   105fd0 <switchuvm>
...
growproc(int n)
{
  ...
  10363e:	e8 0d 28 00 00       	call   105e50 <allocuvm>
  ...
  103665:	e8 16 26 00 00       	call   105c80 <deallocuvm>
...
userinit(void)
{
  ...
  if(!(p->pgdir = setupkvm()))
  103693:	e8 18 25 00 00       	call   105bb0 <setupkvm>
  ...
  1036b5:	00 
  1036b6:	e8 65 24 00 00       	call   105b20 <inituvm>
  p->sz = PGSIZE;
  ...
  10372c:	00 
  10372d:	c7 44 24 04 4a 67 10 	movl   $0x10674a,0x4(%esp)
  103734:	00 
  103735:	89 04 24             	mov    %eax,(%esp)
  103738:	e8 c3 04 00 00       	call   103c00 <safestrcpy>
  p->cwd = namei("/");
  10373d:	c7 04 24 53 67 10 00 	movl   $0x106753,(%esp)
  ...
  if(!(p->pgdir = setupkvm()))
    panic("userinit: out of memory?");
  103759:	c7 04 24 31 67 10 00 	movl   $0x106731,(%esp)
...
procdump(void)
{
  ...
  103783:	8b 0c 85 94 67 10 00 	mov    0x106794(,%eax,4),%ecx
  ...
  10379c:	c7 04 24 59 67 10 00 	movl   $0x106759,(%esp)
  ...
  1037b0:	74 2a                	je     1037dc <procdump+0x6c>
    ...
    cprintf("\n");
  1037b2:	c7 04 24 36 66 10 00 	movl   $0x106636,(%esp)
  ...
  1037d5:	b9 55 67 10 00       	mov    $0x106755,%ecx
  ...
  103805:	c7 04 24 0a 62 10 00 	movl   $0x10620a,(%esp)
...
pinit(void)
{
  ...
  103836:	c7 44 24 04 62 67 10 	movl   $0x106762,0x4(%esp)
  10383d:	00 
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
  103973:	c7 04 24 ac 67 10 00 	movl   $0x1067ac,(%esp)
  10397a:	e8 01 cf ff ff       	call   100880 <panic>
  if(--cpu->ncli < 0)
    panic("popcli");
  10397f:	c7 04 24 c3 67 10 00 	movl   $0x1067c3,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
  1039c3:	c7 04 24 ca 67 10 00 	movl   $0x1067ca,(%esp)
...
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
  103a26:	c7 04 24 d2 67 10 00 	movl   $0x1067d2,(%esp)
...
syscall(void)
{
  ...
  103de3:	83 f9 1a             	cmp    $0x1a,%ecx
  103de6:	77 18                	ja     103e00 <syscall+0x30>
  103de8:	8b 14 8d 00 68 10 00 	mov    0x106800(,%ecx,4),%edx
  ...
  103e0e:	c7 04 24 da 67 10 00 	movl   $0x1067da,(%esp)
...
create(char *path, short type, short major, short minor)
{
  ...
  10422b:	c7 44 24 04 7c 68 10 	movl   $0x10687c,0x4(%esp)
  104232:	00 
  ...
  104246:	c7 44 24 04 7b 68 10 	movl   $0x10687b,0x4(%esp)
  10424d:	00 
  ...
  10425c:	79 99                	jns    1041f7 <create+0xd7>
      panic("create dots");
  10425e:	c7 04 24 7e 68 10 00 	movl   $0x10687e,(%esp)
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
  10426a:	c7 04 24 6c 68 10 00 	movl   $0x10686c,(%esp)
  ...
  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
  104276:	c7 04 24 8a 68 10 00 	movl   $0x10688a,(%esp)
...
sys_unlink(void)
{
  ...
  1045d8:	c7 44 24 04 7c 68 10 	movl   $0x10687c,0x4(%esp)
  1045df:	00 
  ...
  1045ec:	c7 44 24 04 7b 68 10 	movl   $0x10687b,0x4(%esp)
  1045f3:	00 
...
isdirempty(struct inode *dp)
{
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
  10470a:	c7 04 24 ac 68 10 00 	movl   $0x1068ac,(%esp)
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
  104716:	c7 04 24 be 68 10 00 	movl   $0x1068be,(%esp)
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
  104722:	c7 04 24 9a 68 10 00 	movl   $0x10689a,(%esp)
...
sys_getpriority(void)
{
  ...
  1048c5:	5d                   	pop    %ebp
  1048c6:	c3                   	ret    
  1048c7:	89 f6                	mov    %esi,%esi
  1048c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi

001048d0 <sys_setpriority>:
...
sys_setpriority(void)
{
  ...
  1048d1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
	return 0;
}
...
sys_setpriority(void)
{
  ...
  1048d8:	5d                   	pop    %ebp
  1048d9:	c3                   	ret    
  1048da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

001048e0 <sys_getaffinity>:
...
sys_getaffinity(void)
{
  ...
  1048e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi

001048f0 <sys_setaffinity>:
...
sys_setaffinity(void)
{
  ...
  1048f5:	5d                   	pop    %ebp
  1048f6:	c3                   	ret    
  1048f7:	89 f6                	mov    %esi,%esi
  1048f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
sys_uptime(void)
{
  ...
  104903:	53                   	push   %ebx
  104904:	83 ec 04             	sub    $0x4,%esp
  uint xticks;
  
  acquire(&tickslock);
  104907:	c7 04 24 e0 cf 10 00 	movl   $0x10cfe0,(%esp)
  10490e:	e8 bd f0 ff ff       	call   1039d0 <acquire>
  xticks = ticks;
  104913:	8b 1d 20 d8 10 00    	mov    0x10d820,%ebx
  release(&tickslock);
  104919:	c7 04 24 e0 cf 10 00 	movl   $0x10cfe0,(%esp)
  104920:	e8 6b f0 ff ff       	call   103990 <release>
  return xticks;
}
  104925:	83 c4 04             	add    $0x4,%esp
  104928:	89 d8                	mov    %ebx,%eax
  10492a:	5b                   	pop    %ebx
  10492b:	5d                   	pop    %ebp
  10492c:	c3                   	ret    
...
sys_sleep(void)
{
  ...
  104933:	53                   	push   %ebx
  104934:	83 ec 24             	sub    $0x24,%esp
  int n;
  uint ticks0;
  
  if(argint(0, &n) < 0)
  104937:	8d 45 f8             	lea    -0x8(%ebp),%eax
  10493a:	89 44 24 04          	mov    %eax,0x4(%esp)
  10493e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  104945:	e8 a6 f3 ff ff       	call   103cf0 <argint>
  10494a:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  10494f:	85 c0                	test   %eax,%eax
  104951:	78 5b                	js     1049ae <sys_sleep+0x7e>
    return -1;
  acquire(&tickslock);
  104953:	c7 04 24 e0 cf 10 00 	movl   $0x10cfe0,(%esp)
  10495a:	e8 71 f0 ff ff       	call   1039d0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
  10495f:	8b 55 f8             	mov    -0x8(%ebp),%edx
  uint ticks0;
  ...
  acquire(&tickslock);
  ticks0 = ticks;
  104962:	8b 1d 20 d8 10 00    	mov    0x10d820,%ebx
  while(ticks - ticks0 < n){
  104968:	85 d2                	test   %edx,%edx
  10496a:	75 24                	jne    104990 <sys_sleep+0x60>
  10496c:	eb 48                	jmp    1049b6 <sys_sleep+0x86>
  ...
  104970:	c7 44 24 04 e0 cf 10 	movl   $0x10cfe0,0x4(%esp)
  104977:	00 
  104978:	c7 04 24 20 d8 10 00 	movl   $0x10d820,(%esp)
  10497f:	e8 2c e7 ff ff       	call   1030b0 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
  104984:	a1 20 d8 10 00       	mov    0x10d820,%eax
  104989:	29 d8                	sub    %ebx,%eax
  10498b:	3b 45 f8             	cmp    -0x8(%ebp),%eax
  10498e:	73 26                	jae    1049b6 <sys_sleep+0x86>
    if(proc->killed){
  104990:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  104996:	8b 40 24             	mov    0x24(%eax),%eax
  104999:	85 c0                	test   %eax,%eax
  10499b:	74 d3                	je     104970 <sys_sleep+0x40>
      release(&tickslock);
  10499d:	c7 04 24 e0 cf 10 00 	movl   $0x10cfe0,(%esp)
  1049a4:	e8 e7 ef ff ff       	call   103990 <release>
  1049a9:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    }
    sleep(&ticks, &tickslock);
  }
  release(&tickslock);
  ...
  release(&tickslock);
  1049b6:	c7 04 24 e0 cf 10 00 	movl   $0x10cfe0,(%esp)
  1049bd:	e8 ce ef ff ff       	call   103990 <release>
  return 0;
}
  ...
  release(&tickslock);
  1049c5:	31 d2                	xor    %edx,%edx
  return 0;
}
  1049c7:	5b                   	pop    %ebx
  1049c8:	89 d0                	mov    %edx,%eax
  1049ca:	5d                   	pop    %ebp
  1049cb:	c3                   	ret    
  1049cc:	8d 74 26 00          	lea    0x0(%esi),%esi
...
sys_sbrk(void)
{
  ...
  1049da:	89 44 24 04          	mov    %eax,0x4(%esp)
  1049de:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  1049e5:	e8 06 f3 ff ff       	call   103cf0 <argint>
  1049ea:	85 c0                	test   %eax,%eax
  1049ec:	79 0d                	jns    1049fb <sys_sbrk+0x2b>
    return -1;
  addr = proc->sz;
  if(growproc(n) < 0)
    return -1;
  return addr;
  1049ee:	ba ff ff ff ff       	mov    $0xffffffff,%edx
}
  1049f3:	83 c4 24             	add    $0x24,%esp
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = proc->sz;
  1049fb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  104a01:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
  104a03:	8b 45 f8             	mov    -0x8(%ebp),%eax
  104a06:	89 04 24             	mov    %eax,(%esp)
  104a09:	e8 f2 eb ff ff       	call   103600 <growproc>
  int addr;
  int n;
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = proc->sz;
  104a0e:	89 da                	mov    %ebx,%edx
  if(growproc(n) < 0)
  104a10:	85 c0                	test   %eax,%eax
  104a12:	79 df                	jns    1049f3 <sys_sbrk+0x23>
  104a14:	eb d8                	jmp    1049ee <sys_sbrk+0x1e>
  104a16:	8d 76 00             	lea    0x0(%esi),%esi
  104a19:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
sys_kill(void)
{
  ...
  if(argint(0, &pid) < 0)
  104a26:	8d 45 fc             	lea    -0x4(%ebp),%eax
  104a29:	89 44 24 04          	mov    %eax,0x4(%esp)
  104a2d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  104a34:	e8 b7 f2 ff ff       	call   103cf0 <argint>
  104a39:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  104a3e:	85 c0                	test   %eax,%eax
  104a40:	78 0d                	js     104a4f <sys_kill+0x2f>
    return -1;
  return kill(pid);
  104a42:	8b 45 fc             	mov    -0x4(%ebp),%eax
  104a45:	89 04 24             	mov    %eax,(%esp)
  104a48:	e8 f3 e4 ff ff       	call   102f40 <kill>
  104a4d:	89 c2                	mov    %eax,%edx
}
  104a4f:	c9                   	leave  
  104a50:	89 d0                	mov    %edx,%eax
  104a52:	c3                   	ret    
  104a53:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  104a59:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
{
  return wait();
  104a64:	e9 f7 e7 ff ff       	jmp    103260 <wait>
  104a69:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
sys_exit(void)
{
  ...
  104a73:	83 ec 08             	sub    $0x8,%esp
  exit();
  104a76:	e8 c5 e8 ff ff       	call   103340 <exit>
  return 0;  // not reached
}
  104a7b:	31 c0                	xor    %eax,%eax
  104a7d:	c9                   	leave  
  104a7e:	c3                   	ret    
  104a7f:	90                   	nop    
...
{
  return fork();
  104a84:	e9 67 ea ff ff       	jmp    1034f0 <fork>
  104a89:	90                   	nop    
  104a8a:	90                   	nop    
  104a8b:	90                   	nop    
  104a8c:	90                   	nop    
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
  104a91:	b8 34 00 00 00       	mov    $0x34,%eax
  104a96:	89 e5                	mov    %esp,%ebp
  104a98:	ba 43 00 00 00       	mov    $0x43,%edx
  104a9d:	83 ec 08             	sub    $0x8,%esp
  104aa0:	ee                   	out    %al,(%dx)
  ...
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
  picenable(IRQ_TIMER);
  104aa1:	b8 9c ff ff ff       	mov    $0xffffff9c,%eax
  104aa6:	b2 40                	mov    $0x40,%dl
  104aa8:	ee                   	out    %al,(%dx)
  104aa9:	b8 2e 00 00 00       	mov    $0x2e,%eax
  104aae:	ee                   	out    %al,(%dx)
  104aaf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  104ab6:	e8 05 e0 ff ff       	call   102ac0 <picenable>
}
  104abb:	c9                   	leave  
  104abc:	c3                   	ret    
  104abd:	90                   	nop    
...
alltraps:
  ...
  104ac1:	06                   	push   %es
  pushl %fs
  104ac2:	0f a0                	push   %fs
  pushl %gs
  104ac4:	0f a8                	push   %gs
  pushal
  104ac6:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
  104ac7:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
  104acb:	8e d8                	mov    %eax,%ds
  movw %ax, %es
  104acd:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
  104acf:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
  104ad3:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
  104ad5:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
  104ad7:	54                   	push   %esp
  call trap
  104ad8:	e8 d3 00 00 00       	call   104bb0 <trap>
  addl $4, %esp
  104add:	83 c4 04             	add    $0x4,%esp
...
lidt(struct gatedesc *p, int size)
{
  ...
  pd[0] = size-1;
  pd[1] = (uint)p;
  104af1:	b8 20 d0 10 00       	mov    $0x10d020,%eax
  104af6:	89 e5                	mov    %esp,%ebp
  104af8:	83 ec 10             	sub    $0x10,%esp
static inline void
lidt(struct gatedesc *p, int size)
{
  volatile ushort pd[3];
  ...
  pd[0] = size-1;
  104afb:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
  104b01:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
  104b05:	c1 e8 10             	shr    $0x10,%eax
  104b08:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
  104b0c:	8d 45 fa             	lea    -0x6(%ebp),%eax
  104b0f:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
  104b12:	c9                   	leave  
  104b13:	c3                   	ret    
  104b14:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  104b1a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
{
  104b20:	55                   	push   %ebp
  104b21:	31 d2                	xor    %edx,%edx
  104b23:	89 e5                	mov    %esp,%ebp
  104b25:	83 ec 08             	sub    $0x8,%esp
  int i;

  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  104b28:	8b 04 95 08 73 10 00 	mov    0x107308(,%edx,4),%eax
  104b2f:	66 c7 04 d5 22 d0 10 	movw   $0x8,0x10d022(,%edx,8)
  104b36:	00 08 00 
  104b39:	c6 04 d5 24 d0 10 00 	movb   $0x0,0x10d024(,%edx,8)
  104b40:	00 
  104b41:	c6 04 d5 25 d0 10 00 	movb   $0x8e,0x10d025(,%edx,8)
  104b48:	8e 
  104b49:	66 89 04 d5 20 d0 10 	mov    %ax,0x10d020(,%edx,8)
  104b50:	00 
  104b51:	c1 e8 10             	shr    $0x10,%eax
  104b54:	66 89 04 d5 26 d0 10 	mov    %ax,0x10d026(,%edx,8)
  104b5b:	00 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
  104b5c:	83 c2 01             	add    $0x1,%edx
  104b5f:	81 fa 00 01 00 00    	cmp    $0x100,%edx
  104b65:	75 c1                	jne    104b28 <tvinit+0x8>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
  104b67:	a1 08 74 10 00       	mov    0x107408,%eax
  
  initlock(&tickslock, "time");
  104b6c:	c7 44 24 04 cd 68 10 	movl   $0x1068cd,0x4(%esp)
  104b73:	00 
  104b74:	c7 04 24 e0 cf 10 00 	movl   $0x10cfe0,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
  104b7b:	66 c7 05 22 d2 10 00 	movw   $0x8,0x10d222
  104b82:	08 00 
  104b84:	66 a3 20 d2 10 00    	mov    %ax,0x10d220
  104b8a:	c1 e8 10             	shr    $0x10,%eax
  104b8d:	c6 05 24 d2 10 00 00 	movb   $0x0,0x10d224
  104b94:	c6 05 25 d2 10 00 ef 	movb   $0xef,0x10d225
  104b9b:	66 a3 26 d2 10 00    	mov    %ax,0x10d226
  
  initlock(&tickslock, "time");
  104ba1:	e8 aa ec ff ff       	call   103850 <initlock>
}
  104ba6:	c9                   	leave  
  104ba7:	c3                   	ret    
  104ba8:	90                   	nop    
  104ba9:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
trap(struct trapframe *tf)
{
  ...
  104bb3:	56                   	push   %esi
  104bb4:	53                   	push   %ebx
  104bb5:	83 ec 20             	sub    $0x20,%esp
  104bb8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
  104bbb:	8b 4b 30             	mov    0x30(%ebx),%ecx
  104bbe:	83 f9 40             	cmp    $0x40,%ecx
  104bc1:	74 5d                	je     104c20 <trap+0x70>
    if(proc->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
  104bc3:	8d 41 e0             	lea    -0x20(%ecx),%eax
  104bc6:	83 f8 1f             	cmp    $0x1f,%eax
  104bc9:	76 4c                	jbe    104c17 <trap+0x67>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
    break;
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
  104bcb:	65 8b 35 04 00 00 00 	mov    %gs:0x4,%esi
  104bd2:	85 f6                	test   %esi,%esi
  104bd4:	74 0a                	je     104be0 <trap+0x30>
  104bd6:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
  104bda:	0f 85 a0 01 00 00    	jne    104d80 <trap+0x1d0>
...
rcr2(void)
{
  ...
  104be0:	0f 20 d0             	mov    %cr2,%eax
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
  104be3:	89 44 24 10          	mov    %eax,0x10(%esp)
  104be7:	8b 43 38             	mov    0x38(%ebx),%eax
  104bea:	89 44 24 0c          	mov    %eax,0xc(%esp)
  104bee:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
  104bf4:	0f b6 00             	movzbl (%eax),%eax
  104bf7:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  104bfb:	c7 04 24 fc 68 10 00 	movl   $0x1068fc,(%esp)
  104c02:	89 44 24 08          	mov    %eax,0x8(%esp)
  104c06:	e8 b5 b8 ff ff       	call   1004c0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
  104c0b:	c7 04 24 d2 68 10 00 	movl   $0x1068d2,(%esp)
  104c12:	e8 69 bc ff ff       	call   100880 <panic>
    if(proc->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
  104c17:	ff 24 85 74 69 10 00 	jmp    *0x106974(,%eax,4)
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(proc->killed)
  104c20:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
  104c27:	8b 72 24             	mov    0x24(%edx),%esi
  104c2a:	85 f6                	test   %esi,%esi
  104c2c:	0f 85 0c 01 00 00    	jne    104d3e <trap+0x18e>
      exit();
    proc->tf = tf;
  104c32:	89 5a 18             	mov    %ebx,0x18(%edx)
    syscall();
  104c35:	e8 96 f1 ff ff       	call   103dd0 <syscall>
    if(proc->killed)
  104c3a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  104c40:	8b 58 24             	mov    0x24(%eax),%ebx
  104c43:	85 db                	test   %ebx,%ebx
  104c45:	75 5e                	jne    104ca5 <trap+0xf5>
    yield();
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
  104c4e:	e8 dd d2 ff ff       	call   101f30 <ideintr>
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
  104c53:	e8 38 d7 ff ff       	call   102390 <lapiceoi>
  }
  ...
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
  104c58:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
  104c5f:	85 d2                	test   %edx,%edx
  104c61:	74 e4                	je     104c47 <trap+0x97>
  104c63:	8b 4a 24             	mov    0x24(%edx),%ecx
  104c66:	85 c9                	test   %ecx,%ecx
  104c68:	74 10                	je     104c7a <trap+0xca>
  104c6a:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
  104c6e:	83 e0 03             	and    $0x3,%eax
  104c71:	83 f8 03             	cmp    $0x3,%eax
  104c74:	0f 84 ed 00 00 00    	je     104d67 <trap+0x1b7>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
  104c7a:	83 7a 0c 04          	cmpl   $0x4,0xc(%edx)
  104c7e:	75 10                	jne    104c90 <trap+0xe0>
  104c80:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
  104c84:	0f 84 c5 00 00 00    	je     104d4f <trap+0x19f>
  104c8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    yield();

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
  104c90:	89 d0                	mov    %edx,%eax
  104c92:	8b 40 24             	mov    0x24(%eax),%eax
  104c95:	85 c0                	test   %eax,%eax
  104c97:	74 ae                	je     104c47 <trap+0x97>
  104c99:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
  104c9d:	83 e0 03             	and    $0x3,%eax
  104ca0:	83 f8 03             	cmp    $0x3,%eax
  104ca3:	75 a2                	jne    104c47 <trap+0x97>
    exit();
}
  104ca5:	83 c4 20             	add    $0x20,%esp
  104ca8:	5b                   	pop    %ebx
  104ca9:	5e                   	pop    %esi
  104caa:	5d                   	pop    %ebp
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
  ...
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
    exit();
  104cab:	e9 90 e6 ff ff       	jmp    103340 <exit>
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
  104cb0:	8b 43 38             	mov    0x38(%ebx),%eax
  104cb3:	89 44 24 0c          	mov    %eax,0xc(%esp)
  104cb7:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
  104cbb:	89 44 24 08          	mov    %eax,0x8(%esp)
  104cbf:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
  104cc5:	0f b6 00             	movzbl (%eax),%eax
  104cc8:	c7 04 24 d8 68 10 00 	movl   $0x1068d8,(%esp)
  104ccf:	89 44 24 04          	mov    %eax,0x4(%esp)
  104cd3:	e8 e8 b7 ff ff       	call   1004c0 <cprintf>
  104cd8:	e9 76 ff ff ff       	jmp    104c53 <trap+0xa3>
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_COM1:
    uartintr();
  104cdd:	e8 fe 00 00 00       	call   104de0 <uartintr>
    lapiceoi();
  104ce2:	e8 a9 d6 ff ff       	call   102390 <lapiceoi>
  104ce7:	e9 6c ff ff ff       	jmp    104c58 <trap+0xa8>
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
  104cf0:	e8 9b d5 ff ff       	call   102290 <kbdintr>
    lapiceoi();
  104cf5:	e8 96 d6 ff ff       	call   102390 <lapiceoi>
  104cfa:	e9 59 ff ff ff       	jmp    104c58 <trap+0xa8>
    return;
  }
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
  104cff:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
  104d05:	80 38 00             	cmpb   $0x0,(%eax)
  104d08:	0f 85 45 ff ff ff    	jne    104c53 <trap+0xa3>
      acquire(&tickslock);
  104d0e:	c7 04 24 e0 cf 10 00 	movl   $0x10cfe0,(%esp)
  104d15:	e8 b6 ec ff ff       	call   1039d0 <acquire>
      ticks++;
  104d1a:	83 05 20 d8 10 00 01 	addl   $0x1,0x10d820
      wakeup(&ticks);
  104d21:	c7 04 24 20 d8 10 00 	movl   $0x10d820,(%esp)
  104d28:	e8 93 e2 ff ff       	call   102fc0 <wakeup>
      release(&tickslock);
  104d2d:	c7 04 24 e0 cf 10 00 	movl   $0x10cfe0,(%esp)
  104d34:	e8 57 ec ff ff       	call   103990 <release>
  104d39:	e9 15 ff ff ff       	jmp    104c53 <trap+0xa3>
void
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(proc->killed)
      exit();
  104d3e:	e8 fd e5 ff ff       	call   103340 <exit>
  104d43:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
  104d4a:	e9 e3 fe ff ff       	jmp    104c32 <trap+0x82>
    exit();
  ...
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
  104d4f:	e8 2c e4 ff ff       	call   103180 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
  104d54:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  104d5a:	85 c0                	test   %eax,%eax
  104d5c:	0f 85 30 ff ff ff    	jne    104c92 <trap+0xe2>
  104d62:	e9 e0 fe ff ff       	jmp    104c47 <trap+0x97>
  ...
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
    exit();
  104d67:	e8 d4 e5 ff ff       	call   103340 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
  104d6c:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
  104d73:	85 d2                	test   %edx,%edx
  104d75:	0f 85 ff fe ff ff    	jne    104c7a <trap+0xca>
  104d7b:	e9 c7 fe ff ff       	jmp    104c47 <trap+0x97>
  104d80:	0f 20 d0             	mov    %cr2,%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
  ...
  104d83:	8b 56 10             	mov    0x10(%esi),%edx
  104d86:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  104d8a:	8b 43 38             	mov    0x38(%ebx),%eax
  104d8d:	89 44 24 18          	mov    %eax,0x18(%esp)
  104d91:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
  104d97:	0f b6 00             	movzbl (%eax),%eax
  104d9a:	89 44 24 14          	mov    %eax,0x14(%esp)
  104d9e:	8b 43 34             	mov    0x34(%ebx),%eax
  104da1:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  104da5:	89 54 24 04          	mov    %edx,0x4(%esp)
  104da9:	c7 04 24 30 69 10 00 	movl   $0x106930,(%esp)
  104db0:	89 44 24 10          	mov    %eax,0x10(%esp)
  104db4:	8d 46 6c             	lea    0x6c(%esi),%eax
  104db7:	89 44 24 08          	mov    %eax,0x8(%esp)
  104dbb:	e8 00 b7 ff ff       	call   1004c0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
  104dc0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  104dc6:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  104dcd:	e9 86 fe ff ff       	jmp    104c58 <trap+0xa8>
  104dd2:	90                   	nop    
  104dd3:	90                   	nop    
  104dd4:	90                   	nop    
  104dd5:	90                   	nop    
...
uartintr(void)
{
  ...
  104de6:	c7 04 24 50 4e 10 00 	movl   $0x104e50,(%esp)
  104ded:	e8 0e b9 ff ff       	call   100700 <consoleintr>
}
  104df2:	c9                   	leave  
  104df3:	c3                   	ret    
  104df4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  104dfa:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
uartputc(int c)
{
  104e06:	83 ec 04             	sub    $0x4,%esp
  int i;

  if(!uart)
  104e09:	a1 4c 78 10 00       	mov    0x10784c,%eax
  104e0e:	85 c0                	test   %eax,%eax
  104e10:	75 19                	jne    104e2b <uartputc+0x2b>
  104e12:	eb 2b                	jmp    104e3f <uartputc+0x3f>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
  104e14:	83 c3 01             	add    $0x1,%ebx
    microdelay(10);
  104e17:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  104e1e:	e8 8d d5 ff ff       	call   1023b0 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
  104e23:	81 fb 80 00 00 00    	cmp    $0x80,%ebx
  104e29:	74 0a                	je     104e35 <uartputc+0x35>
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
  104e2b:	ba fd 03 00 00       	mov    $0x3fd,%edx
  104e30:	ec                   	in     (%dx),%al
  104e31:	a8 20                	test   $0x20,%al
  104e33:	74 df                	je     104e14 <uartputc+0x14>
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
  104e35:	ba f8 03 00 00       	mov    $0x3f8,%edx
  104e3a:	0f b6 45 08          	movzbl 0x8(%ebp),%eax
  104e3e:	ee                   	out    %al,(%dx)
    microdelay(10);
  outb(COM1+0, c);
}
  104e3f:	83 c4 04             	add    $0x4,%esp
  104e42:	5b                   	pop    %ebx
  104e43:	5d                   	pop    %ebp
  104e44:	c3                   	ret    
  104e45:	8d 74 26 00          	lea    0x0(%esi),%esi
  104e49:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
{
  if(!uart)
  104e50:	8b 15 4c 78 10 00    	mov    0x10784c,%edx
  outb(COM1+0, c);
}
...
uartgetc(void)
{
  ...
  if(!uart)
  104e59:	85 d2                	test   %edx,%edx
  104e5b:	75 07                	jne    104e64 <uartgetc+0x14>
    return -1;
  if(!(inb(COM1+5) & 0x01))
    return -1;
  return inb(COM1+0);
  ...
  104e5d:	5d                   	pop    %ebp
{
  ...
  if(!(inb(COM1+5) & 0x01))
    return -1;
  return inb(COM1+0);
  104e5e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
  104e63:	c3                   	ret    
static inline uchar
inb(ushort port)
{
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
  104e64:	ba fd 03 00 00       	mov    $0x3fd,%edx
  104e69:	ec                   	in     (%dx),%al
static int
uartgetc(void)
{
  if(!uart)
    return -1;
  if(!(inb(COM1+5) & 0x01))
  104e6a:	a8 01                	test   $0x1,%al
  104e6c:	74 ef                	je     104e5d <uartgetc+0xd>
  104e6e:	b2 f8                	mov    $0xf8,%dl
  104e70:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
}
  ...
  104e75:	c3                   	ret    
  104e76:	8d 76 00             	lea    0x0(%esi),%esi
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
  104e84:	bf fa 03 00 00       	mov    $0x3fa,%edi
  104e89:	56                   	push   %esi
  104e8a:	89 fa                	mov    %edi,%edx
  104e8c:	53                   	push   %ebx
  104e8d:	31 db                	xor    %ebx,%ebx
  104e8f:	83 ec 0c             	sub    $0xc,%esp
  104e92:	89 d8                	mov    %ebx,%eax
  104e94:	ee                   	out    %al,(%dx)
static inline uchar
inb(ushort port)
{
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
  104e95:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
  104e9a:	b2 fb                	mov    $0xfb,%dl
  104e9c:	ee                   	out    %al,(%dx)
  104e9d:	be f8 03 00 00       	mov    $0x3f8,%esi
  104ea2:	b8 0c 00 00 00       	mov    $0xc,%eax
  104ea7:	89 f2                	mov    %esi,%edx
  104ea9:	ee                   	out    %al,(%dx)
  104eaa:	b9 f9 03 00 00       	mov    $0x3f9,%ecx
  104eaf:	89 d8                	mov    %ebx,%eax
  104eb1:	89 ca                	mov    %ecx,%edx
  104eb3:	ee                   	out    %al,(%dx)
  104eb4:	b8 03 00 00 00       	mov    $0x3,%eax
  104eb9:	b2 fb                	mov    $0xfb,%dl
  104ebb:	ee                   	out    %al,(%dx)
  104ebc:	b2 fc                	mov    $0xfc,%dl
  104ebe:	89 d8                	mov    %ebx,%eax
  104ec0:	ee                   	out    %al,(%dx)
  104ec1:	b8 01 00 00 00       	mov    $0x1,%eax
  104ec6:	89 ca                	mov    %ecx,%edx
  104ec8:	ee                   	out    %al,(%dx)
  104ec9:	b2 fd                	mov    $0xfd,%dl
  104ecb:	ec                   	in     (%dx),%al
  ...
  if(inb(COM1+5) == 0xFF)
  104ecc:	04 01                	add    $0x1,%al
  104ece:	74 56                	je     104f26 <uartinit+0xa6>
    return;
  uart = 1;
  104ed0:	c7 05 4c 78 10 00 01 	movl   $0x1,0x10784c
  104ed7:	00 00 00 
  104eda:	89 fa                	mov    %edi,%edx
  104edc:	ec                   	in     (%dx),%al
  ...
  104edd:	89 f2                	mov    %esi,%edx
  104edf:	ec                   	in     (%dx),%al
  104ee0:	bb f4 69 10 00       	mov    $0x1069f4,%ebx
  ...
  inb(COM1+0);
  picenable(IRQ_COM1);
  104ee5:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  104eec:	e8 cf db ff ff       	call   102ac0 <picenable>
  ioapicenable(IRQ_COM1, 0);
  104ef1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  104ef8:	00 
  104ef9:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  104f00:	e8 8b d1 ff ff       	call   102090 <ioapicenable>
  104f05:	b8 78 00 00 00       	mov    $0x78,%eax
  104f0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
    uartputc(*p);
  104f10:	0f be c0             	movsbl %al,%eax
  104f13:	89 04 24             	mov    %eax,(%esp)
  104f16:	e8 e5 fe ff ff       	call   104e00 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
  104f1b:	0f b6 43 01          	movzbl 0x1(%ebx),%eax
  104f1f:	83 c3 01             	add    $0x1,%ebx
  104f22:	84 c0                	test   %al,%al
  104f24:	75 ea                	jne    104f10 <uartinit+0x90>
    uartputc(*p);
}
...
vector0:
  pushl $0
  104f30:	6a 00                	push   $0x0
  pushl $0
  104f32:	6a 00                	push   $0x0
  jmp alltraps
  104f34:	e9 87 fb ff ff       	jmp    104ac0 <alltraps>

00104f39 <vector1>:
.globl vector1
vector1:
  pushl $0
  104f39:	6a 00                	push   $0x0
  pushl $1
  104f3b:	6a 01                	push   $0x1
  jmp alltraps
  104f3d:	e9 7e fb ff ff       	jmp    104ac0 <alltraps>
...
vector2:
  ...
  pushl $2
  104f44:	6a 02                	push   $0x2
  jmp alltraps
  104f46:	e9 75 fb ff ff       	jmp    104ac0 <alltraps>
...
vector3:
  ...
  pushl $3
  104f4d:	6a 03                	push   $0x3
  jmp alltraps
  104f4f:	e9 6c fb ff ff       	jmp    104ac0 <alltraps>

00104f54 <vector4>:
.globl vector4
vector4:
  pushl $0
  104f54:	6a 00                	push   $0x0
  pushl $4
  104f56:	6a 04                	push   $0x4
  jmp alltraps
  104f58:	e9 63 fb ff ff       	jmp    104ac0 <alltraps>

00104f5d <vector5>:
.globl vector5
vector5:
  pushl $0
  104f5d:	6a 00                	push   $0x0
  pushl $5
  104f5f:	6a 05                	push   $0x5
  jmp alltraps
  104f61:	e9 5a fb ff ff       	jmp    104ac0 <alltraps>

00104f66 <vector6>:
.globl vector6
vector6:
  pushl $0
  104f66:	6a 00                	push   $0x0
  pushl $6
  104f68:	6a 06                	push   $0x6
  jmp alltraps
  104f6a:	e9 51 fb ff ff       	jmp    104ac0 <alltraps>
...
vector7:
  ...
  pushl $7
  104f71:	6a 07                	push   $0x7
  jmp alltraps
  104f73:	e9 48 fb ff ff       	jmp    104ac0 <alltraps>

00104f78 <vector8>:
.globl vector8
vector8:
  pushl $8
  104f78:	6a 08                	push   $0x8
  jmp alltraps
  104f7a:	e9 41 fb ff ff       	jmp    104ac0 <alltraps>

00104f7f <vector9>:
.globl vector9
vector9:
  pushl $0
  104f7f:	6a 00                	push   $0x0
  pushl $9
  104f81:	6a 09                	push   $0x9
  jmp alltraps
  104f83:	e9 38 fb ff ff       	jmp    104ac0 <alltraps>

00104f88 <vector10>:
.globl vector10
vector10:
  pushl $10
  104f88:	6a 0a                	push   $0xa
  jmp alltraps
  104f8a:	e9 31 fb ff ff       	jmp    104ac0 <alltraps>

00104f8f <vector11>:
.globl vector11
vector11:
  pushl $11
  104f8f:	6a 0b                	push   $0xb
  jmp alltraps
  104f91:	e9 2a fb ff ff       	jmp    104ac0 <alltraps>

00104f96 <vector12>:
.globl vector12
vector12:
  pushl $12
  104f96:	6a 0c                	push   $0xc
  jmp alltraps
  104f98:	e9 23 fb ff ff       	jmp    104ac0 <alltraps>

00104f9d <vector13>:
.globl vector13
vector13:
  pushl $13
  104f9d:	6a 0d                	push   $0xd
  jmp alltraps
  104f9f:	e9 1c fb ff ff       	jmp    104ac0 <alltraps>

00104fa4 <vector14>:
.globl vector14
vector14:
  pushl $14
  104fa4:	6a 0e                	push   $0xe
  jmp alltraps
  104fa6:	e9 15 fb ff ff       	jmp    104ac0 <alltraps>
...
vector15:
  ...
  pushl $15
  104fad:	6a 0f                	push   $0xf
  jmp alltraps
  104faf:	e9 0c fb ff ff       	jmp    104ac0 <alltraps>
...
vector16:
  ...
  pushl $16
  104fb6:	6a 10                	push   $0x10
  jmp alltraps
  104fb8:	e9 03 fb ff ff       	jmp    104ac0 <alltraps>

00104fbd <vector17>:
.globl vector17
vector17:
  pushl $17
  104fbd:	6a 11                	push   $0x11
  jmp alltraps
  104fbf:	e9 fc fa ff ff       	jmp    104ac0 <alltraps>

00104fc4 <vector18>:
.globl vector18
vector18:
  pushl $0
  104fc4:	6a 00                	push   $0x0
  pushl $18
  104fc6:	6a 12                	push   $0x12
  jmp alltraps
  104fc8:	e9 f3 fa ff ff       	jmp    104ac0 <alltraps>

00104fcd <vector19>:
.globl vector19
vector19:
  pushl $0
  104fcd:	6a 00                	push   $0x0
  pushl $19
  104fcf:	6a 13                	push   $0x13
  jmp alltraps
  104fd1:	e9 ea fa ff ff       	jmp    104ac0 <alltraps>
...
vector20:
  ...
  pushl $20
  104fd8:	6a 14                	push   $0x14
  jmp alltraps
  104fda:	e9 e1 fa ff ff       	jmp    104ac0 <alltraps>

00104fdf <vector21>:
.globl vector21
vector21:
  pushl $0
  104fdf:	6a 00                	push   $0x0
  pushl $21
  104fe1:	6a 15                	push   $0x15
  jmp alltraps
  104fe3:	e9 d8 fa ff ff       	jmp    104ac0 <alltraps>

00104fe8 <vector22>:
.globl vector22
vector22:
  pushl $0
  104fe8:	6a 00                	push   $0x0
  pushl $22
  104fea:	6a 16                	push   $0x16
  jmp alltraps
  104fec:	e9 cf fa ff ff       	jmp    104ac0 <alltraps>

00104ff1 <vector23>:
.globl vector23
vector23:
  pushl $0
  104ff1:	6a 00                	push   $0x0
  pushl $23
  104ff3:	6a 17                	push   $0x17
  jmp alltraps
  104ff5:	e9 c6 fa ff ff       	jmp    104ac0 <alltraps>

00104ffa <vector24>:
.globl vector24
vector24:
  pushl $0
  104ffa:	6a 00                	push   $0x0
  pushl $24
  104ffc:	6a 18                	push   $0x18
  jmp alltraps
  104ffe:	e9 bd fa ff ff       	jmp    104ac0 <alltraps>

00105003 <vector25>:
.globl vector25
vector25:
  pushl $0
  105003:	6a 00                	push   $0x0
  pushl $25
  105005:	6a 19                	push   $0x19
  jmp alltraps
  105007:	e9 b4 fa ff ff       	jmp    104ac0 <alltraps>

0010500c <vector26>:
.globl vector26
vector26:
  pushl $0
  10500c:	6a 00                	push   $0x0
  pushl $26
  10500e:	6a 1a                	push   $0x1a
  jmp alltraps
  105010:	e9 ab fa ff ff       	jmp    104ac0 <alltraps>

00105015 <vector27>:
.globl vector27
vector27:
  pushl $0
  105015:	6a 00                	push   $0x0
  pushl $27
  105017:	6a 1b                	push   $0x1b
  jmp alltraps
  105019:	e9 a2 fa ff ff       	jmp    104ac0 <alltraps>

0010501e <vector28>:
.globl vector28
vector28:
  pushl $0
  10501e:	6a 00                	push   $0x0
  pushl $28
  105020:	6a 1c                	push   $0x1c
  jmp alltraps
  105022:	e9 99 fa ff ff       	jmp    104ac0 <alltraps>

00105027 <vector29>:
.globl vector29
vector29:
  pushl $0
  105027:	6a 00                	push   $0x0
  pushl $29
  105029:	6a 1d                	push   $0x1d
  jmp alltraps
  10502b:	e9 90 fa ff ff       	jmp    104ac0 <alltraps>
...
vector30:
  ...
  pushl $30
  105032:	6a 1e                	push   $0x1e
  jmp alltraps
  105034:	e9 87 fa ff ff       	jmp    104ac0 <alltraps>

00105039 <vector31>:
.globl vector31
vector31:
  pushl $0
  105039:	6a 00                	push   $0x0
  pushl $31
  10503b:	6a 1f                	push   $0x1f
  jmp alltraps
  10503d:	e9 7e fa ff ff       	jmp    104ac0 <alltraps>

00105042 <vector32>:
.globl vector32
vector32:
  pushl $0
  105042:	6a 00                	push   $0x0
  pushl $32
  105044:	6a 20                	push   $0x20
  jmp alltraps
  105046:	e9 75 fa ff ff       	jmp    104ac0 <alltraps>

0010504b <vector33>:
.globl vector33
vector33:
  pushl $0
  10504b:	6a 00                	push   $0x0
  pushl $33
  10504d:	6a 21                	push   $0x21
  jmp alltraps
  10504f:	e9 6c fa ff ff       	jmp    104ac0 <alltraps>

00105054 <vector34>:
.globl vector34
vector34:
  pushl $0
  105054:	6a 00                	push   $0x0
  pushl $34
  105056:	6a 22                	push   $0x22
  jmp alltraps
  105058:	e9 63 fa ff ff       	jmp    104ac0 <alltraps>

0010505d <vector35>:
.globl vector35
vector35:
  pushl $0
  10505d:	6a 00                	push   $0x0
  pushl $35
  10505f:	6a 23                	push   $0x23
  jmp alltraps
  105061:	e9 5a fa ff ff       	jmp    104ac0 <alltraps>
...
vector36:
  ...
  pushl $36
  105068:	6a 24                	push   $0x24
  jmp alltraps
  10506a:	e9 51 fa ff ff       	jmp    104ac0 <alltraps>

0010506f <vector37>:
.globl vector37
vector37:
  pushl $0
  10506f:	6a 00                	push   $0x0
  pushl $37
  105071:	6a 25                	push   $0x25
  jmp alltraps
  105073:	e9 48 fa ff ff       	jmp    104ac0 <alltraps>

00105078 <vector38>:
.globl vector38
vector38:
  pushl $0
  105078:	6a 00                	push   $0x0
  pushl $38
  10507a:	6a 26                	push   $0x26
  jmp alltraps
  10507c:	e9 3f fa ff ff       	jmp    104ac0 <alltraps>

00105081 <vector39>:
.globl vector39
vector39:
  pushl $0
  105081:	6a 00                	push   $0x0
  pushl $39
  105083:	6a 27                	push   $0x27
  jmp alltraps
  105085:	e9 36 fa ff ff       	jmp    104ac0 <alltraps>
...
vector40:
  ...
  pushl $40
  10508c:	6a 28                	push   $0x28
  jmp alltraps
  10508e:	e9 2d fa ff ff       	jmp    104ac0 <alltraps>
...
vector41:
  ...
  pushl $41
  105095:	6a 29                	push   $0x29
  jmp alltraps
  105097:	e9 24 fa ff ff       	jmp    104ac0 <alltraps>

0010509c <vector42>:
.globl vector42
vector42:
  pushl $0
  10509c:	6a 00                	push   $0x0
  pushl $42
  10509e:	6a 2a                	push   $0x2a
  jmp alltraps
  1050a0:	e9 1b fa ff ff       	jmp    104ac0 <alltraps>
...
vector43:
  ...
  pushl $43
  1050a7:	6a 2b                	push   $0x2b
  jmp alltraps
  1050a9:	e9 12 fa ff ff       	jmp    104ac0 <alltraps>

001050ae <vector44>:
.globl vector44
vector44:
  pushl $0
  1050ae:	6a 00                	push   $0x0
  pushl $44
  1050b0:	6a 2c                	push   $0x2c
  jmp alltraps
  1050b2:	e9 09 fa ff ff       	jmp    104ac0 <alltraps>
...
vector45:
  ...
  pushl $45
  1050b9:	6a 2d                	push   $0x2d
  jmp alltraps
  1050bb:	e9 00 fa ff ff       	jmp    104ac0 <alltraps>
...
vector46:
  ...
  pushl $46
  1050c2:	6a 2e                	push   $0x2e
  jmp alltraps
  1050c4:	e9 f7 f9 ff ff       	jmp    104ac0 <alltraps>

001050c9 <vector47>:
.globl vector47
vector47:
  pushl $0
  1050c9:	6a 00                	push   $0x0
  pushl $47
  1050cb:	6a 2f                	push   $0x2f
  jmp alltraps
  1050cd:	e9 ee f9 ff ff       	jmp    104ac0 <alltraps>

001050d2 <vector48>:
.globl vector48
vector48:
  pushl $0
  1050d2:	6a 00                	push   $0x0
  pushl $48
  1050d4:	6a 30                	push   $0x30
  jmp alltraps
  1050d6:	e9 e5 f9 ff ff       	jmp    104ac0 <alltraps>

001050db <vector49>:
.globl vector49
vector49:
  pushl $0
  1050db:	6a 00                	push   $0x0
  pushl $49
  1050dd:	6a 31                	push   $0x31
  jmp alltraps
  1050df:	e9 dc f9 ff ff       	jmp    104ac0 <alltraps>

001050e4 <vector50>:
.globl vector50
vector50:
  pushl $0
  1050e4:	6a 00                	push   $0x0
  pushl $50
  1050e6:	6a 32                	push   $0x32
  jmp alltraps
  1050e8:	e9 d3 f9 ff ff       	jmp    104ac0 <alltraps>

001050ed <vector51>:
.globl vector51
vector51:
  pushl $0
  1050ed:	6a 00                	push   $0x0
  pushl $51
  1050ef:	6a 33                	push   $0x33
  jmp alltraps
  1050f1:	e9 ca f9 ff ff       	jmp    104ac0 <alltraps>

001050f6 <vector52>:
.globl vector52
vector52:
  pushl $0
  1050f6:	6a 00                	push   $0x0
  pushl $52
  1050f8:	6a 34                	push   $0x34
  jmp alltraps
  1050fa:	e9 c1 f9 ff ff       	jmp    104ac0 <alltraps>

001050ff <vector53>:
.globl vector53
vector53:
  pushl $0
  1050ff:	6a 00                	push   $0x0
  pushl $53
  105101:	6a 35                	push   $0x35
  jmp alltraps
  105103:	e9 b8 f9 ff ff       	jmp    104ac0 <alltraps>

00105108 <vector54>:
.globl vector54
vector54:
  pushl $0
  105108:	6a 00                	push   $0x0
  pushl $54
  10510a:	6a 36                	push   $0x36
  jmp alltraps
  10510c:	e9 af f9 ff ff       	jmp    104ac0 <alltraps>

00105111 <vector55>:
.globl vector55
vector55:
  pushl $0
  105111:	6a 00                	push   $0x0
  pushl $55
  105113:	6a 37                	push   $0x37
  jmp alltraps
  105115:	e9 a6 f9 ff ff       	jmp    104ac0 <alltraps>

0010511a <vector56>:
.globl vector56
vector56:
  pushl $0
  10511a:	6a 00                	push   $0x0
  pushl $56
  10511c:	6a 38                	push   $0x38
  jmp alltraps
  10511e:	e9 9d f9 ff ff       	jmp    104ac0 <alltraps>

00105123 <vector57>:
.globl vector57
vector57:
  pushl $0
  105123:	6a 00                	push   $0x0
  pushl $57
  105125:	6a 39                	push   $0x39
  jmp alltraps
  105127:	e9 94 f9 ff ff       	jmp    104ac0 <alltraps>
...
vector58:
  ...
  pushl $58
  10512e:	6a 3a                	push   $0x3a
  jmp alltraps
  105130:	e9 8b f9 ff ff       	jmp    104ac0 <alltraps>

00105135 <vector59>:
.globl vector59
vector59:
  pushl $0
  105135:	6a 00                	push   $0x0
  pushl $59
  105137:	6a 3b                	push   $0x3b
  jmp alltraps
  105139:	e9 82 f9 ff ff       	jmp    104ac0 <alltraps>
...
vector60:
  ...
  pushl $60
  105140:	6a 3c                	push   $0x3c
  jmp alltraps
  105142:	e9 79 f9 ff ff       	jmp    104ac0 <alltraps>
...
vector61:
  ...
  pushl $61
  105149:	6a 3d                	push   $0x3d
  jmp alltraps
  10514b:	e9 70 f9 ff ff       	jmp    104ac0 <alltraps>

00105150 <vector62>:
.globl vector62
vector62:
  pushl $0
  105150:	6a 00                	push   $0x0
  pushl $62
  105152:	6a 3e                	push   $0x3e
  jmp alltraps
  105154:	e9 67 f9 ff ff       	jmp    104ac0 <alltraps>

00105159 <vector63>:
.globl vector63
vector63:
  pushl $0
  105159:	6a 00                	push   $0x0
  pushl $63
  10515b:	6a 3f                	push   $0x3f
  jmp alltraps
  10515d:	e9 5e f9 ff ff       	jmp    104ac0 <alltraps>

00105162 <vector64>:
.globl vector64
vector64:
  pushl $0
  105162:	6a 00                	push   $0x0
  pushl $64
  105164:	6a 40                	push   $0x40
  jmp alltraps
  105166:	e9 55 f9 ff ff       	jmp    104ac0 <alltraps>

0010516b <vector65>:
.globl vector65
vector65:
  pushl $0
  10516b:	6a 00                	push   $0x0
  pushl $65
  10516d:	6a 41                	push   $0x41
  jmp alltraps
  10516f:	e9 4c f9 ff ff       	jmp    104ac0 <alltraps>
...
vector66:
  ...
  pushl $66
  105176:	6a 42                	push   $0x42
  jmp alltraps
  105178:	e9 43 f9 ff ff       	jmp    104ac0 <alltraps>

0010517d <vector67>:
.globl vector67
vector67:
  pushl $0
  10517d:	6a 00                	push   $0x0
  pushl $67
  10517f:	6a 43                	push   $0x43
  jmp alltraps
  105181:	e9 3a f9 ff ff       	jmp    104ac0 <alltraps>

00105186 <vector68>:
.globl vector68
vector68:
  pushl $0
  105186:	6a 00                	push   $0x0
  pushl $68
  105188:	6a 44                	push   $0x44
  jmp alltraps
  10518a:	e9 31 f9 ff ff       	jmp    104ac0 <alltraps>
...
vector69:
  ...
  pushl $69
  105191:	6a 45                	push   $0x45
  jmp alltraps
  105193:	e9 28 f9 ff ff       	jmp    104ac0 <alltraps>
...
vector70:
  ...
  pushl $70
  10519a:	6a 46                	push   $0x46
  jmp alltraps
  10519c:	e9 1f f9 ff ff       	jmp    104ac0 <alltraps>

001051a1 <vector71>:
.globl vector71
vector71:
  pushl $0
  1051a1:	6a 00                	push   $0x0
  pushl $71
  1051a3:	6a 47                	push   $0x47
  jmp alltraps
  1051a5:	e9 16 f9 ff ff       	jmp    104ac0 <alltraps>

001051aa <vector72>:
.globl vector72
vector72:
  pushl $0
  1051aa:	6a 00                	push   $0x0
  pushl $72
  1051ac:	6a 48                	push   $0x48
  jmp alltraps
  1051ae:	e9 0d f9 ff ff       	jmp    104ac0 <alltraps>
...
vector73:
  ...
  pushl $73
  1051b5:	6a 49                	push   $0x49
  jmp alltraps
  1051b7:	e9 04 f9 ff ff       	jmp    104ac0 <alltraps>

001051bc <vector74>:
.globl vector74
vector74:
  pushl $0
  1051bc:	6a 00                	push   $0x0
  pushl $74
  1051be:	6a 4a                	push   $0x4a
  jmp alltraps
  1051c0:	e9 fb f8 ff ff       	jmp    104ac0 <alltraps>

001051c5 <vector75>:
.globl vector75
vector75:
  pushl $0
  1051c5:	6a 00                	push   $0x0
  pushl $75
  1051c7:	6a 4b                	push   $0x4b
  jmp alltraps
  1051c9:	e9 f2 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector76:
  ...
  pushl $76
  1051d0:	6a 4c                	push   $0x4c
  jmp alltraps
  1051d2:	e9 e9 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector77:
  ...
  pushl $77
  1051d9:	6a 4d                	push   $0x4d
  jmp alltraps
  1051db:	e9 e0 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector78:
  ...
  pushl $78
  1051e2:	6a 4e                	push   $0x4e
  jmp alltraps
  1051e4:	e9 d7 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector79:
  ...
  pushl $79
  1051eb:	6a 4f                	push   $0x4f
  jmp alltraps
  1051ed:	e9 ce f8 ff ff       	jmp    104ac0 <alltraps>
...
vector80:
  ...
  pushl $80
  1051f4:	6a 50                	push   $0x50
  jmp alltraps
  1051f6:	e9 c5 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector81:
  ...
  pushl $81
  1051fd:	6a 51                	push   $0x51
  jmp alltraps
  1051ff:	e9 bc f8 ff ff       	jmp    104ac0 <alltraps>
...
vector82:
  ...
  pushl $82
  105206:	6a 52                	push   $0x52
  jmp alltraps
  105208:	e9 b3 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector83:
  ...
  pushl $83
  10520f:	6a 53                	push   $0x53
  jmp alltraps
  105211:	e9 aa f8 ff ff       	jmp    104ac0 <alltraps>
...
vector84:
  ...
  pushl $84
  105218:	6a 54                	push   $0x54
  jmp alltraps
  10521a:	e9 a1 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector85:
  ...
  pushl $85
  105221:	6a 55                	push   $0x55
  jmp alltraps
  105223:	e9 98 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector86:
  ...
  pushl $86
  10522a:	6a 56                	push   $0x56
  jmp alltraps
  10522c:	e9 8f f8 ff ff       	jmp    104ac0 <alltraps>

00105231 <vector87>:
.globl vector87
vector87:
  pushl $0
  105231:	6a 00                	push   $0x0
  pushl $87
  105233:	6a 57                	push   $0x57
  jmp alltraps
  105235:	e9 86 f8 ff ff       	jmp    104ac0 <alltraps>

0010523a <vector88>:
.globl vector88
vector88:
  pushl $0
  10523a:	6a 00                	push   $0x0
  pushl $88
  10523c:	6a 58                	push   $0x58
  jmp alltraps
  10523e:	e9 7d f8 ff ff       	jmp    104ac0 <alltraps>

00105243 <vector89>:
.globl vector89
vector89:
  pushl $0
  105243:	6a 00                	push   $0x0
  pushl $89
  105245:	6a 59                	push   $0x59
  jmp alltraps
  105247:	e9 74 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector90:
  ...
  pushl $90
  10524e:	6a 5a                	push   $0x5a
  jmp alltraps
  105250:	e9 6b f8 ff ff       	jmp    104ac0 <alltraps>
...
vector91:
  ...
  pushl $91
  105257:	6a 5b                	push   $0x5b
  jmp alltraps
  105259:	e9 62 f8 ff ff       	jmp    104ac0 <alltraps>

0010525e <vector92>:
.globl vector92
vector92:
  pushl $0
  10525e:	6a 00                	push   $0x0
  pushl $92
  105260:	6a 5c                	push   $0x5c
  jmp alltraps
  105262:	e9 59 f8 ff ff       	jmp    104ac0 <alltraps>

00105267 <vector93>:
.globl vector93
vector93:
  pushl $0
  105267:	6a 00                	push   $0x0
  pushl $93
  105269:	6a 5d                	push   $0x5d
  jmp alltraps
  10526b:	e9 50 f8 ff ff       	jmp    104ac0 <alltraps>

00105270 <vector94>:
.globl vector94
vector94:
  pushl $0
  105270:	6a 00                	push   $0x0
  pushl $94
  105272:	6a 5e                	push   $0x5e
  jmp alltraps
  105274:	e9 47 f8 ff ff       	jmp    104ac0 <alltraps>

00105279 <vector95>:
.globl vector95
vector95:
  pushl $0
  105279:	6a 00                	push   $0x0
  pushl $95
  10527b:	6a 5f                	push   $0x5f
  jmp alltraps
  10527d:	e9 3e f8 ff ff       	jmp    104ac0 <alltraps>
...
vector96:
  ...
  pushl $96
  105284:	6a 60                	push   $0x60
  jmp alltraps
  105286:	e9 35 f8 ff ff       	jmp    104ac0 <alltraps>

0010528b <vector97>:
.globl vector97
vector97:
  pushl $0
  10528b:	6a 00                	push   $0x0
  pushl $97
  10528d:	6a 61                	push   $0x61
  jmp alltraps
  10528f:	e9 2c f8 ff ff       	jmp    104ac0 <alltraps>
...
vector98:
  ...
  pushl $98
  105296:	6a 62                	push   $0x62
  jmp alltraps
  105298:	e9 23 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector99:
  ...
  pushl $99
  10529f:	6a 63                	push   $0x63
  jmp alltraps
  1052a1:	e9 1a f8 ff ff       	jmp    104ac0 <alltraps>
...
vector100:
  ...
  pushl $100
  1052a8:	6a 64                	push   $0x64
  jmp alltraps
  1052aa:	e9 11 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector101:
  ...
  pushl $101
  1052b1:	6a 65                	push   $0x65
  jmp alltraps
  1052b3:	e9 08 f8 ff ff       	jmp    104ac0 <alltraps>
...
vector102:
  ...
  pushl $102
  1052ba:	6a 66                	push   $0x66
  jmp alltraps
  1052bc:	e9 ff f7 ff ff       	jmp    104ac0 <alltraps>
...
vector103:
  ...
  pushl $103
  1052c3:	6a 67                	push   $0x67
  jmp alltraps
  1052c5:	e9 f6 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector104:
  ...
  pushl $104
  1052cc:	6a 68                	push   $0x68
  jmp alltraps
  1052ce:	e9 ed f7 ff ff       	jmp    104ac0 <alltraps>
...
vector105:
  ...
  pushl $105
  1052d5:	6a 69                	push   $0x69
  jmp alltraps
  1052d7:	e9 e4 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector106:
  ...
  pushl $106
  1052de:	6a 6a                	push   $0x6a
  jmp alltraps
  1052e0:	e9 db f7 ff ff       	jmp    104ac0 <alltraps>
...
vector107:
  ...
  pushl $107
  1052e7:	6a 6b                	push   $0x6b
  jmp alltraps
  1052e9:	e9 d2 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector108:
  ...
  pushl $108
  1052f0:	6a 6c                	push   $0x6c
  jmp alltraps
  1052f2:	e9 c9 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector109:
  ...
  pushl $109
  1052f9:	6a 6d                	push   $0x6d
  jmp alltraps
  1052fb:	e9 c0 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector110:
  ...
  pushl $110
  105302:	6a 6e                	push   $0x6e
  jmp alltraps
  105304:	e9 b7 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector111:
  ...
  pushl $111
  10530b:	6a 6f                	push   $0x6f
  jmp alltraps
  10530d:	e9 ae f7 ff ff       	jmp    104ac0 <alltraps>
...
vector112:
  ...
  pushl $112
  105314:	6a 70                	push   $0x70
  jmp alltraps
  105316:	e9 a5 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector113:
  ...
  pushl $113
  10531d:	6a 71                	push   $0x71
  jmp alltraps
  10531f:	e9 9c f7 ff ff       	jmp    104ac0 <alltraps>
...
vector114:
  ...
  pushl $114
  105326:	6a 72                	push   $0x72
  jmp alltraps
  105328:	e9 93 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector115:
  ...
  pushl $115
  10532f:	6a 73                	push   $0x73
  jmp alltraps
  105331:	e9 8a f7 ff ff       	jmp    104ac0 <alltraps>
...
vector116:
  ...
  pushl $116
  105338:	6a 74                	push   $0x74
  jmp alltraps
  10533a:	e9 81 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector117:
  ...
  pushl $117
  105341:	6a 75                	push   $0x75
  jmp alltraps
  105343:	e9 78 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector118:
  ...
  pushl $118
  10534a:	6a 76                	push   $0x76
  jmp alltraps
  10534c:	e9 6f f7 ff ff       	jmp    104ac0 <alltraps>
...
vector119:
  ...
  pushl $119
  105353:	6a 77                	push   $0x77
  jmp alltraps
  105355:	e9 66 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector120:
  ...
  pushl $120
  10535c:	6a 78                	push   $0x78
  jmp alltraps
  10535e:	e9 5d f7 ff ff       	jmp    104ac0 <alltraps>
...
vector121:
  ...
  pushl $121
  105365:	6a 79                	push   $0x79
  jmp alltraps
  105367:	e9 54 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector122:
  ...
  pushl $122
  10536e:	6a 7a                	push   $0x7a
  jmp alltraps
  105370:	e9 4b f7 ff ff       	jmp    104ac0 <alltraps>
...
vector123:
  ...
  pushl $123
  105377:	6a 7b                	push   $0x7b
  jmp alltraps
  105379:	e9 42 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector124:
  ...
  pushl $124
  105380:	6a 7c                	push   $0x7c
  jmp alltraps
  105382:	e9 39 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector125:
  ...
  pushl $125
  105389:	6a 7d                	push   $0x7d
  jmp alltraps
  10538b:	e9 30 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector126:
  ...
  pushl $126
  105392:	6a 7e                	push   $0x7e
  jmp alltraps
  105394:	e9 27 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector127:
  ...
  pushl $127
  10539b:	6a 7f                	push   $0x7f
  jmp alltraps
  10539d:	e9 1e f7 ff ff       	jmp    104ac0 <alltraps>
...
vector128:
  ...
  pushl $128
  1053a4:	68 80 00 00 00       	push   $0x80
  jmp alltraps
  1053a9:	e9 12 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector129:
  ...
  pushl $129
  1053b0:	68 81 00 00 00       	push   $0x81
  jmp alltraps
  1053b5:	e9 06 f7 ff ff       	jmp    104ac0 <alltraps>
...
vector130:
  ...
  pushl $130
  1053bc:	68 82 00 00 00       	push   $0x82
  jmp alltraps
  1053c1:	e9 fa f6 ff ff       	jmp    104ac0 <alltraps>
...
vector131:
  ...
  pushl $131
  1053c8:	68 83 00 00 00       	push   $0x83
  jmp alltraps
  1053cd:	e9 ee f6 ff ff       	jmp    104ac0 <alltraps>
...
vector132:
  ...
  pushl $132
  1053d4:	68 84 00 00 00       	push   $0x84
  jmp alltraps
  1053d9:	e9 e2 f6 ff ff       	jmp    104ac0 <alltraps>
...
vector133:
  ...
  pushl $133
  1053e0:	68 85 00 00 00       	push   $0x85
  jmp alltraps
  1053e5:	e9 d6 f6 ff ff       	jmp    104ac0 <alltraps>
...
vector134:
  ...
  pushl $134
  1053ec:	68 86 00 00 00       	push   $0x86
  jmp alltraps
  1053f1:	e9 ca f6 ff ff       	jmp    104ac0 <alltraps>
...
vector135:
  ...
  pushl $135
  1053f8:	68 87 00 00 00       	push   $0x87
  jmp alltraps
  1053fd:	e9 be f6 ff ff       	jmp    104ac0 <alltraps>
...
vector136:
  ...
  pushl $136
  105404:	68 88 00 00 00       	push   $0x88
  jmp alltraps
  105409:	e9 b2 f6 ff ff       	jmp    104ac0 <alltraps>
...
vector137:
  ...
  pushl $137
  105410:	68 89 00 00 00       	push   $0x89
  jmp alltraps
  105415:	e9 a6 f6 ff ff       	jmp    104ac0 <alltraps>
...
vector138:
  ...
  pushl $138
  10541c:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
  105421:	e9 9a f6 ff ff       	jmp    104ac0 <alltraps>
...
vector139:
  ...
  pushl $139
  105428:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
  10542d:	e9 8e f6 ff ff       	jmp    104ac0 <alltraps>
...
vector140:
  ...
  pushl $140
  105434:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
  105439:	e9 82 f6 ff ff       	jmp    104ac0 <alltraps>
...
vector141:
  ...
  pushl $141
  105440:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
  105445:	e9 76 f6 ff ff       	jmp    104ac0 <alltraps>
...
vector142:
  ...
  pushl $142
  10544c:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
  105451:	e9 6a f6 ff ff       	jmp    104ac0 <alltraps>
...
vector143:
  ...
  pushl $143
  105458:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
  10545d:	e9 5e f6 ff ff       	jmp    104ac0 <alltraps>
...
vector144:
  ...
  pushl $144
  105464:	68 90 00 00 00       	push   $0x90
  jmp alltraps
  105469:	e9 52 f6 ff ff       	jmp    104ac0 <alltraps>
...
vector145:
  ...
  pushl $145
  105470:	68 91 00 00 00       	push   $0x91
  jmp alltraps
  105475:	e9 46 f6 ff ff       	jmp    104ac0 <alltraps>
...
vector146:
  ...
  pushl $146
  10547c:	68 92 00 00 00       	push   $0x92
  jmp alltraps
  105481:	e9 3a f6 ff ff       	jmp    104ac0 <alltraps>
...
vector147:
  ...
  pushl $147
  105488:	68 93 00 00 00       	push   $0x93
  jmp alltraps
  10548d:	e9 2e f6 ff ff       	jmp    104ac0 <alltraps>
...
vector148:
  ...
  pushl $148
  105494:	68 94 00 00 00       	push   $0x94
  jmp alltraps
  105499:	e9 22 f6 ff ff       	jmp    104ac0 <alltraps>
...
vector149:
  ...
  pushl $149
  1054a0:	68 95 00 00 00       	push   $0x95
  jmp alltraps
  1054a5:	e9 16 f6 ff ff       	jmp    104ac0 <alltraps>
...
vector150:
  ...
  pushl $150
  1054ac:	68 96 00 00 00       	push   $0x96
  jmp alltraps
  1054b1:	e9 0a f6 ff ff       	jmp    104ac0 <alltraps>
...
vector151:
  ...
  pushl $151
  1054b8:	68 97 00 00 00       	push   $0x97
  jmp alltraps
  1054bd:	e9 fe f5 ff ff       	jmp    104ac0 <alltraps>
...
vector152:
  ...
  pushl $152
  1054c4:	68 98 00 00 00       	push   $0x98
  jmp alltraps
  1054c9:	e9 f2 f5 ff ff       	jmp    104ac0 <alltraps>
...
vector153:
  ...
  pushl $153
  1054d0:	68 99 00 00 00       	push   $0x99
  jmp alltraps
  1054d5:	e9 e6 f5 ff ff       	jmp    104ac0 <alltraps>
...
vector154:
  ...
  pushl $154
  1054dc:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
  1054e1:	e9 da f5 ff ff       	jmp    104ac0 <alltraps>
...
vector155:
  ...
  pushl $155
  1054e8:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
  1054ed:	e9 ce f5 ff ff       	jmp    104ac0 <alltraps>
...
vector156:
  ...
  pushl $156
  1054f4:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
  1054f9:	e9 c2 f5 ff ff       	jmp    104ac0 <alltraps>
...
vector157:
  ...
  pushl $157
  105500:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
  105505:	e9 b6 f5 ff ff       	jmp    104ac0 <alltraps>
...
vector158:
  ...
  pushl $158
  10550c:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
  105511:	e9 aa f5 ff ff       	jmp    104ac0 <alltraps>
...
vector159:
  ...
  pushl $159
  105518:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
  10551d:	e9 9e f5 ff ff       	jmp    104ac0 <alltraps>
...
vector160:
  ...
  pushl $160
  105524:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
  105529:	e9 92 f5 ff ff       	jmp    104ac0 <alltraps>
...
vector161:
  ...
  pushl $161
  105530:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
  105535:	e9 86 f5 ff ff       	jmp    104ac0 <alltraps>
...
vector162:
  ...
  pushl $162
  10553c:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
  105541:	e9 7a f5 ff ff       	jmp    104ac0 <alltraps>
...
vector163:
  ...
  pushl $163
  105548:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
  10554d:	e9 6e f5 ff ff       	jmp    104ac0 <alltraps>
...
vector164:
  ...
  pushl $164
  105554:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
  105559:	e9 62 f5 ff ff       	jmp    104ac0 <alltraps>
...
vector165:
  ...
  pushl $165
  105560:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
  105565:	e9 56 f5 ff ff       	jmp    104ac0 <alltraps>
...
vector166:
  ...
  pushl $166
  10556c:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
  105571:	e9 4a f5 ff ff       	jmp    104ac0 <alltraps>
...
vector167:
  ...
  pushl $167
  105578:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
  10557d:	e9 3e f5 ff ff       	jmp    104ac0 <alltraps>
...
vector168:
  ...
  pushl $168
  105584:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
  105589:	e9 32 f5 ff ff       	jmp    104ac0 <alltraps>
...
vector169:
  ...
  pushl $169
  105590:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
  105595:	e9 26 f5 ff ff       	jmp    104ac0 <alltraps>
...
vector170:
  ...
  pushl $170
  10559c:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
  1055a1:	e9 1a f5 ff ff       	jmp    104ac0 <alltraps>
...
vector171:
  ...
  pushl $171
  1055a8:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
  1055ad:	e9 0e f5 ff ff       	jmp    104ac0 <alltraps>
...
vector172:
  ...
  pushl $172
  1055b4:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
  1055b9:	e9 02 f5 ff ff       	jmp    104ac0 <alltraps>
...
vector173:
  ...
  pushl $173
  1055c0:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
  1055c5:	e9 f6 f4 ff ff       	jmp    104ac0 <alltraps>
...
vector174:
  ...
  pushl $174
  1055cc:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
  1055d1:	e9 ea f4 ff ff       	jmp    104ac0 <alltraps>
...
vector175:
  ...
  pushl $175
  1055d8:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
  1055dd:	e9 de f4 ff ff       	jmp    104ac0 <alltraps>
...
vector176:
  ...
  pushl $176
  1055e4:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
  1055e9:	e9 d2 f4 ff ff       	jmp    104ac0 <alltraps>
...
vector177:
  ...
  pushl $177
  1055f0:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
  1055f5:	e9 c6 f4 ff ff       	jmp    104ac0 <alltraps>
...
vector178:
  ...
  pushl $178
  1055fc:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
  105601:	e9 ba f4 ff ff       	jmp    104ac0 <alltraps>
...
vector179:
  ...
  pushl $179
  105608:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
  10560d:	e9 ae f4 ff ff       	jmp    104ac0 <alltraps>
...
vector180:
  ...
  pushl $180
  105614:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
  105619:	e9 a2 f4 ff ff       	jmp    104ac0 <alltraps>
...
vector181:
  ...
  pushl $181
  105620:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
  105625:	e9 96 f4 ff ff       	jmp    104ac0 <alltraps>
...
vector182:
  ...
  pushl $182
  10562c:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
  105631:	e9 8a f4 ff ff       	jmp    104ac0 <alltraps>
...
vector183:
  ...
  pushl $183
  105638:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
  10563d:	e9 7e f4 ff ff       	jmp    104ac0 <alltraps>
...
vector184:
  ...
  pushl $184
  105644:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
  105649:	e9 72 f4 ff ff       	jmp    104ac0 <alltraps>
...
vector185:
  ...
  pushl $185
  105650:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
  105655:	e9 66 f4 ff ff       	jmp    104ac0 <alltraps>
...
vector186:
  ...
  pushl $186
  10565c:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
  105661:	e9 5a f4 ff ff       	jmp    104ac0 <alltraps>
...
vector187:
  ...
  pushl $187
  105668:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
  10566d:	e9 4e f4 ff ff       	jmp    104ac0 <alltraps>
...
vector188:
  ...
  pushl $188
  105674:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
  105679:	e9 42 f4 ff ff       	jmp    104ac0 <alltraps>
...
vector189:
  ...
  pushl $189
  105680:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
  105685:	e9 36 f4 ff ff       	jmp    104ac0 <alltraps>
...
vector190:
  ...
  pushl $190
  10568c:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
  105691:	e9 2a f4 ff ff       	jmp    104ac0 <alltraps>
...
vector191:
  ...
  pushl $191
  105698:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
  10569d:	e9 1e f4 ff ff       	jmp    104ac0 <alltraps>
...
vector192:
  ...
  pushl $192
  1056a4:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
  1056a9:	e9 12 f4 ff ff       	jmp    104ac0 <alltraps>
...
vector193:
  ...
  pushl $193
  1056b0:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
  1056b5:	e9 06 f4 ff ff       	jmp    104ac0 <alltraps>
...
vector194:
  ...
  pushl $194
  1056bc:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
  1056c1:	e9 fa f3 ff ff       	jmp    104ac0 <alltraps>
...
vector195:
  ...
  pushl $195
  1056c8:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
  1056cd:	e9 ee f3 ff ff       	jmp    104ac0 <alltraps>
...
vector196:
  ...
  pushl $196
  1056d4:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
  1056d9:	e9 e2 f3 ff ff       	jmp    104ac0 <alltraps>
...
vector197:
  ...
  pushl $197
  1056e0:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
  1056e5:	e9 d6 f3 ff ff       	jmp    104ac0 <alltraps>
...
vector198:
  ...
  pushl $198
  1056ec:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
  1056f1:	e9 ca f3 ff ff       	jmp    104ac0 <alltraps>
...
vector199:
  ...
  pushl $199
  1056f8:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
  1056fd:	e9 be f3 ff ff       	jmp    104ac0 <alltraps>
...
vector200:
  ...
  pushl $200
  105704:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
  105709:	e9 b2 f3 ff ff       	jmp    104ac0 <alltraps>
...
vector201:
  ...
  pushl $201
  105710:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
  105715:	e9 a6 f3 ff ff       	jmp    104ac0 <alltraps>
...
vector202:
  ...
  pushl $202
  10571c:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
  105721:	e9 9a f3 ff ff       	jmp    104ac0 <alltraps>
...
vector203:
  ...
  pushl $203
  105728:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
  10572d:	e9 8e f3 ff ff       	jmp    104ac0 <alltraps>
...
vector204:
  ...
  pushl $204
  105734:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
  105739:	e9 82 f3 ff ff       	jmp    104ac0 <alltraps>
...
vector205:
  ...
  pushl $205
  105740:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
  105745:	e9 76 f3 ff ff       	jmp    104ac0 <alltraps>
...
vector206:
  ...
  pushl $206
  10574c:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
  105751:	e9 6a f3 ff ff       	jmp    104ac0 <alltraps>
...
vector207:
  ...
  pushl $207
  105758:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
  10575d:	e9 5e f3 ff ff       	jmp    104ac0 <alltraps>
...
vector208:
  ...
  pushl $208
  105764:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
  105769:	e9 52 f3 ff ff       	jmp    104ac0 <alltraps>
...
vector209:
  ...
  pushl $209
  105770:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
  105775:	e9 46 f3 ff ff       	jmp    104ac0 <alltraps>
...
vector210:
  ...
  pushl $210
  10577c:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
  105781:	e9 3a f3 ff ff       	jmp    104ac0 <alltraps>
...
vector211:
  ...
  pushl $211
  105788:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
  10578d:	e9 2e f3 ff ff       	jmp    104ac0 <alltraps>
...
vector212:
  ...
  pushl $212
  105794:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
  105799:	e9 22 f3 ff ff       	jmp    104ac0 <alltraps>
...
vector213:
  ...
  pushl $213
  1057a0:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
  1057a5:	e9 16 f3 ff ff       	jmp    104ac0 <alltraps>
...
vector214:
  ...
  pushl $214
  1057ac:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
  1057b1:	e9 0a f3 ff ff       	jmp    104ac0 <alltraps>
...
vector215:
  ...
  pushl $215
  1057b8:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
  1057bd:	e9 fe f2 ff ff       	jmp    104ac0 <alltraps>
...
vector216:
  ...
  pushl $216
  1057c4:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
  1057c9:	e9 f2 f2 ff ff       	jmp    104ac0 <alltraps>
...
vector217:
  ...
  pushl $217
  1057d0:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
  1057d5:	e9 e6 f2 ff ff       	jmp    104ac0 <alltraps>
...
vector218:
  ...
  pushl $218
  1057dc:	68 da 00 00 00       	push   $0xda
  jmp alltraps
  1057e1:	e9 da f2 ff ff       	jmp    104ac0 <alltraps>
...
vector219:
  ...
  pushl $219
  1057e8:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
  1057ed:	e9 ce f2 ff ff       	jmp    104ac0 <alltraps>
...
vector220:
  ...
  pushl $220
  1057f4:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
  1057f9:	e9 c2 f2 ff ff       	jmp    104ac0 <alltraps>
...
vector221:
  ...
  pushl $221
  105800:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
  105805:	e9 b6 f2 ff ff       	jmp    104ac0 <alltraps>
...
vector222:
  ...
  pushl $222
  10580c:	68 de 00 00 00       	push   $0xde
  jmp alltraps
  105811:	e9 aa f2 ff ff       	jmp    104ac0 <alltraps>
...
vector223:
  ...
  pushl $223
  105818:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
  10581d:	e9 9e f2 ff ff       	jmp    104ac0 <alltraps>
...
vector224:
  ...
  pushl $224
  105824:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
  105829:	e9 92 f2 ff ff       	jmp    104ac0 <alltraps>
...
vector225:
  ...
  pushl $225
  105830:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
  105835:	e9 86 f2 ff ff       	jmp    104ac0 <alltraps>
...
vector226:
  ...
  pushl $226
  10583c:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
  105841:	e9 7a f2 ff ff       	jmp    104ac0 <alltraps>
...
vector227:
  ...
  pushl $227
  105848:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
  10584d:	e9 6e f2 ff ff       	jmp    104ac0 <alltraps>
...
vector228:
  ...
  pushl $228
  105854:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
  105859:	e9 62 f2 ff ff       	jmp    104ac0 <alltraps>
...
vector229:
  ...
  pushl $229
  105860:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
  105865:	e9 56 f2 ff ff       	jmp    104ac0 <alltraps>
...
vector230:
  ...
  pushl $230
  10586c:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
  105871:	e9 4a f2 ff ff       	jmp    104ac0 <alltraps>
...
vector231:
  ...
  pushl $231
  105878:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
  10587d:	e9 3e f2 ff ff       	jmp    104ac0 <alltraps>
...
vector232:
  ...
  pushl $232
  105884:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
  105889:	e9 32 f2 ff ff       	jmp    104ac0 <alltraps>
...
vector233:
  ...
  pushl $233
  105890:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
  105895:	e9 26 f2 ff ff       	jmp    104ac0 <alltraps>
...
vector234:
  ...
  pushl $234
  10589c:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
  1058a1:	e9 1a f2 ff ff       	jmp    104ac0 <alltraps>
...
vector235:
  ...
  pushl $235
  1058a8:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
  1058ad:	e9 0e f2 ff ff       	jmp    104ac0 <alltraps>
...
vector236:
  ...
  pushl $236
  1058b4:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
  1058b9:	e9 02 f2 ff ff       	jmp    104ac0 <alltraps>
...
vector237:
  ...
  pushl $237
  1058c0:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
  1058c5:	e9 f6 f1 ff ff       	jmp    104ac0 <alltraps>
...
vector238:
  ...
  pushl $238
  1058cc:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
  1058d1:	e9 ea f1 ff ff       	jmp    104ac0 <alltraps>
...
vector239:
  ...
  pushl $239
  1058d8:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
  1058dd:	e9 de f1 ff ff       	jmp    104ac0 <alltraps>
...
vector240:
  ...
  pushl $240
  1058e4:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
  1058e9:	e9 d2 f1 ff ff       	jmp    104ac0 <alltraps>
...
vector241:
  ...
  pushl $241
  1058f0:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
  1058f5:	e9 c6 f1 ff ff       	jmp    104ac0 <alltraps>
...
vector242:
  ...
  pushl $242
  1058fc:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
  105901:	e9 ba f1 ff ff       	jmp    104ac0 <alltraps>
...
vector243:
  ...
  pushl $243
  105908:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
  10590d:	e9 ae f1 ff ff       	jmp    104ac0 <alltraps>
...
vector244:
  ...
  pushl $244
  105914:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
  105919:	e9 a2 f1 ff ff       	jmp    104ac0 <alltraps>
...
vector245:
  ...
  pushl $245
  105920:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
  105925:	e9 96 f1 ff ff       	jmp    104ac0 <alltraps>
...
vector246:
  ...
  pushl $246
  10592c:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
  105931:	e9 8a f1 ff ff       	jmp    104ac0 <alltraps>
...
vector247:
  ...
  pushl $247
  105938:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
  10593d:	e9 7e f1 ff ff       	jmp    104ac0 <alltraps>
...
vector248:
  ...
  pushl $248
  105944:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
  105949:	e9 72 f1 ff ff       	jmp    104ac0 <alltraps>
...
vector249:
  ...
  pushl $249
  105950:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
  105955:	e9 66 f1 ff ff       	jmp    104ac0 <alltraps>
...
vector250:
  ...
  pushl $250
  10595c:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
  105961:	e9 5a f1 ff ff       	jmp    104ac0 <alltraps>
...
vector251:
  ...
  pushl $251
  105968:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
  10596d:	e9 4e f1 ff ff       	jmp    104ac0 <alltraps>
...
vector252:
  ...
  pushl $252
  105974:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
  105979:	e9 42 f1 ff ff       	jmp    104ac0 <alltraps>
...
vector253:
  ...
  pushl $253
  105980:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
  105985:	e9 36 f1 ff ff       	jmp    104ac0 <alltraps>
...
vector254:
  ...
  pushl $254
  10598c:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
  105991:	e9 2a f1 ff ff       	jmp    104ac0 <alltraps>
...
vector255:
  ...
  pushl $255
  105998:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
  10599d:	e9 1e f1 ff ff       	jmp    104ac0 <alltraps>
  1059a2:	90                   	nop    
  1059a3:	90                   	nop    
  1059a4:	90                   	nop    
  1059a5:	90                   	nop    
...
lcr3(uint val) 
{
  ...
  1059b1:	a1 50 78 10 00       	mov    0x107850,%eax
  1059b6:	89 e5                	mov    %esp,%ebp
  1059b8:	0f 22 d8             	mov    %eax,%cr3
...
vmenable(void)
{
  ...
  1059c3:	e8 e8 ff ff ff       	call   1059b0 <switchkvm>
...
lcr0(uint val)
{
  ...
  1059cb:	0d 00 00 00 80       	or     $0x80000000,%eax
  1059d0:	0f 22 c0             	mov    %eax,%cr0
  cr0 = rcr0();
  cr0 |= CR0_PG;
  lcr0(cr0);
}
  1059d3:	5d                   	pop    %ebp
  1059d4:	c3                   	ret    
  1059d5:	8d 74 26 00          	lea    0x0(%esi),%esi
...
walkpgdir(pde_t *pgdir, const void *va, int create)
{
  ...
  1059e6:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  1059e9:	89 d3                	mov    %edx,%ebx
  uint r;
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
  1059eb:	c1 ea 16             	shr    $0x16,%edx
// Return the address of the PTE in page table pgdir
// that corresponds to linear address va.  If create!=0,
// create any required page table pages.
static pte_t *
walkpgdir(pde_t *pgdir, const void *va, int create)
{
  1059ee:	89 7d fc             	mov    %edi,-0x4(%ebp)
  uint r;
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
  1059f1:	8d 3c 90             	lea    (%eax,%edx,4),%edi
// Return the address of the PTE in page table pgdir
// that corresponds to linear address va.  If create!=0,
// create any required page table pages.
static pte_t *
walkpgdir(pde_t *pgdir, const void *va, int create)
{
  1059f4:	89 75 f8             	mov    %esi,-0x8(%ebp)
  uint r;
  pde_t *pde;
  pte_t *pgtab;
  ...
  pde = &pgdir[PDX(va)];
  if(*pde & PTE_P){
  1059f7:	8b 07                	mov    (%edi),%eax
  1059f9:	a8 01                	test   $0x1,%al
  1059fb:	74 21                	je     105a1e <walkpgdir+0x3e>
    pgtab = (pte_t*) PTE_ADDR(*pde);
  1059fd:	89 c6                	mov    %eax,%esi
  1059ff:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  ...
  return &pgtab[PTX(va)];
  105a05:	c1 eb 0a             	shr    $0xa,%ebx
  105a08:	81 e3 fc 0f 00 00    	and    $0xffc,%ebx
  105a0e:	8d 04 33             	lea    (%ebx,%esi,1),%eax
}
  105a11:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  105a14:	8b 75 f8             	mov    -0x8(%ebp),%esi
  105a17:	8b 7d fc             	mov    -0x4(%ebp),%edi
  105a1a:	89 ec                	mov    %ebp,%esp
  105a1c:	5d                   	pop    %ebp
  105a1d:	c3                   	ret    
  pte_t *pgtab;
  ...
  105a1e:	85 c9                	test   %ecx,%ecx
  105a20:	75 04                	jne    105a26 <walkpgdir+0x46>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table 
    // entries, if necessary.
    *pde = PADDR(r) | PTE_P | PTE_W | PTE_U;
  ...
  return &pgtab[PTX(va)];
  105a22:	31 c0                	xor    %eax,%eax
  105a24:	eb eb                	jmp    105a11 <walkpgdir+0x31>
  pte_t *pgtab;
  ...
  105a26:	e8 45 c7 ff ff       	call   102170 <kalloc>
  105a2b:	85 c0                	test   %eax,%eax
  105a2d:	8d 76 00             	lea    0x0(%esi),%esi
  105a30:	74 f0                	je     105a22 <walkpgdir+0x42>
    return 0;
  else {
    pgtab = (pte_t*) r;
  105a32:	89 c6                	mov    %eax,%esi
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
  105a34:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  105a3b:	00 
  105a3c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  105a43:	00 
  105a44:	89 04 24             	mov    %eax,(%esp)
  105a47:	e8 f4 df ff ff       	call   103a40 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table 
    // entries, if necessary.
    *pde = PADDR(r) | PTE_P | PTE_W | PTE_U;
  105a4c:	89 f0                	mov    %esi,%eax
  105a4e:	83 c8 07             	or     $0x7,%eax
  105a51:	89 07                	mov    %eax,(%edi)
  105a53:	eb b0                	jmp    105a05 <walkpgdir+0x25>
  105a55:	8d 74 26 00          	lea    0x0(%esi),%esi
  105a59:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
{    
  ...
  105a65:	83 ec 08             	sub    $0x8,%esp
  pte_t *pte = walkpgdir(pgdir, uva, 0);
  105a68:	8b 55 0c             	mov    0xc(%ebp),%edx
  105a6b:	8b 45 08             	mov    0x8(%ebp),%eax
  105a6e:	e8 6d ff ff ff       	call   1059e0 <walkpgdir>
  if(pte == 0) return 0;
  105a73:	31 d2                	xor    %edx,%edx
  105a75:	85 c0                	test   %eax,%eax
  105a77:	74 08                	je     105a81 <uva2ka+0x21>
  uint pa = PTE_ADDR(*pte);
  return (char *)pa;
  105a79:	8b 10                	mov    (%eax),%edx
  105a7b:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
}
  105a81:	c9                   	leave  
  105a82:	89 d0                	mov    %edx,%eax
  105a84:	c3                   	ret    
  105a85:	8d 74 26 00          	lea    0x0(%esi),%esi
  105a89:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
mappages(pde_t *pgdir, void *la, uint size, uint pa, int perm)
{
  105a98:	83 ec 0c             	sub    $0xc,%esp
  105a9b:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a = PGROUNDDOWN(la);
  105a9e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
// Create PTEs for linear addresses starting at la that refer to
// physical addresses starting at pa. la and size might not
// be page-aligned.
static int
mappages(pde_t *pgdir, void *la, uint size, uint pa, int perm)
{
  105aa4:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
  105aa7:	8b 45 0c             	mov    0xc(%ebp),%eax
// be page-aligned.
static int
mappages(pde_t *pgdir, void *la, uint size, uint pa, int perm)
{
  ...
  105aaa:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
  105aae:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pte_t *pte = walkpgdir(pgdir, a, 1);
    if(pte == 0)
      return 0;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
  105ab4:	83 c8 01             	or     $0x1,%eax
  105ab7:	89 45 ec             	mov    %eax,-0x14(%ebp)
  105aba:	eb 20                	jmp    105adc <mappages+0x4c>
  105abc:	8d 74 26 00          	lea    0x0(%esi),%esi
  ...
  while(1){
    ...
    if(pte == 0)
      return 0;
    if(*pte & PTE_P)
  105ac0:	f6 00 01             	testb  $0x1,(%eax)
  105ac3:	75 43                	jne    105b08 <mappages+0x78>
      panic("remap");
    *pte = pa | perm | PTE_P;
  105ac5:	8b 45 ec             	mov    -0x14(%ebp),%eax
  105ac8:	09 f0                	or     %esi,%eax
    if(a == last)
  105aca:	39 fb                	cmp    %edi,%ebx
    pte_t *pte = walkpgdir(pgdir, a, 1);
    if(pte == 0)
      return 0;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
  105acc:	89 02                	mov    %eax,(%edx)
    if(a == last)
  105ace:	74 2b                	je     105afb <mappages+0x6b>
      break;
    a += PGSIZE;
  105ad0:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
  105ad6:	81 c6 00 10 00 00    	add    $0x1000,%esi
{
  char *a = PGROUNDDOWN(la);
  char *last = PGROUNDDOWN(la + size - 1);
  ...
  while(1){
    pte_t *pte = walkpgdir(pgdir, a, 1);
  105adc:	8b 45 f0             	mov    -0x10(%ebp),%eax
  105adf:	89 da                	mov    %ebx,%edx
  105ae1:	b9 01 00 00 00       	mov    $0x1,%ecx
  105ae6:	e8 f5 fe ff ff       	call   1059e0 <walkpgdir>
    if(pte == 0)
  105aeb:	85 c0                	test   %eax,%eax
{
  char *a = PGROUNDDOWN(la);
  char *last = PGROUNDDOWN(la + size - 1);
  ...
  while(1){
    pte_t *pte = walkpgdir(pgdir, a, 1);
  105aed:	89 c2                	mov    %eax,%edx
    if(pte == 0)
  105aef:	75 cf                	jne    105ac0 <mappages+0x30>
      break;
    a += PGSIZE;
    pa += PGSIZE;
  }
  ...
  105afb:	83 c4 0c             	add    $0xc,%esp
    ...
    *pte = pa | perm | PTE_P;
    if(a == last)
  105afe:	b8 01 00 00 00       	mov    $0x1,%eax
      break;
    a += PGSIZE;
    pa += PGSIZE;
  }
  ...
  while(1){
    ...
    if(*pte & PTE_P)
      panic("remap");
  105b08:	c7 04 24 fc 69 10 00 	movl   $0x1069fc,(%esp)
  105b0f:	e8 6c ad ff ff       	call   100880 <panic>
...
inituvm(pde_t *pgdir, char *init, uint sz)
{
  ...
  105b23:	83 ec 28             	sub    $0x28,%esp
  105b26:	8b 45 0c             	mov    0xc(%ebp),%eax
  105b29:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  105b2c:	89 75 f8             	mov    %esi,-0x8(%ebp)
  105b2f:	8b 75 10             	mov    0x10(%ebp),%esi
  105b32:	89 7d fc             	mov    %edi,-0x4(%ebp)
  105b35:	8b 7d 08             	mov    0x8(%ebp),%edi
  105b38:	89 45 f0             	mov    %eax,-0x10(%ebp)
  char *mem = kalloc();
  105b3b:	e8 30 c6 ff ff       	call   102170 <kalloc>
  if (sz >= PGSIZE)
  105b40:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
// Load the initcode into address 0 of pgdir.
// sz must be less than a page.
void
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem = kalloc();
  105b46:	89 c3                	mov    %eax,%ebx
  if (sz >= PGSIZE)
  105b48:	77 4e                	ja     105b98 <inituvm+0x78>
    panic("inituvm: more than a page");
  memset(mem, 0, PGSIZE);
  105b4a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  105b51:	00 
  105b52:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  105b59:	00 
  105b5a:	89 04 24             	mov    %eax,(%esp)
  105b5d:	e8 de de ff ff       	call   103a40 <memset>
  mappages(pgdir, 0, PGSIZE, PADDR(mem), PTE_W|PTE_U);
  105b62:	89 f8                	mov    %edi,%eax
  105b64:	b9 00 10 00 00       	mov    $0x1000,%ecx
  105b69:	89 1c 24             	mov    %ebx,(%esp)
  105b6c:	31 d2                	xor    %edx,%edx
  105b6e:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
  105b75:	00 
  105b76:	e8 15 ff ff ff       	call   105a90 <mappages>
  memmove(mem, init, sz);
  105b7b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  105b7e:	89 75 10             	mov    %esi,0x10(%ebp)
}
  105b81:	8b 7d fc             	mov    -0x4(%ebp),%edi
  char *mem = kalloc();
  if (sz >= PGSIZE)
    panic("inituvm: more than a page");
  memset(mem, 0, PGSIZE);
  mappages(pgdir, 0, PGSIZE, PADDR(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
  105b84:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
  105b87:	8b 75 f8             	mov    -0x8(%ebp),%esi
  105b8a:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  char *mem = kalloc();
  if (sz >= PGSIZE)
    panic("inituvm: more than a page");
  memset(mem, 0, PGSIZE);
  mappages(pgdir, 0, PGSIZE, PADDR(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
  105b8d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
  105b90:	89 ec                	mov    %ebp,%esp
  105b92:	5d                   	pop    %ebp
  char *mem = kalloc();
  if (sz >= PGSIZE)
    panic("inituvm: more than a page");
  ...
  mappages(pgdir, 0, PGSIZE, PADDR(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
  105b93:	e9 48 df ff ff       	jmp    103ae0 <memmove>
void
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem = kalloc();
  if (sz >= PGSIZE)
    panic("inituvm: more than a page");
  105b98:	c7 04 24 02 6a 10 00 	movl   $0x106a02,(%esp)
  105b9f:	e8 dc ac ff ff       	call   100880 <panic>
  105ba4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  105baa:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
setupkvm(void)
{
  ...
  105bb3:	53                   	push   %ebx
  105bb4:	83 ec 14             	sub    $0x14,%esp
  pde_t *pgdir;

  // Allocate page directory
  if(!(pgdir = (pde_t *) kalloc()))
  105bb7:	e8 b4 c5 ff ff       	call   102170 <kalloc>
  105bbc:	85 c0                	test   %eax,%eax
  105bbe:	75 10                	jne    105bd0 <setupkvm+0x20>
    return 0;
  memset(pgdir, 0, PGSIZE);
  if(// Map IO space from 640K to 1Mbyte
  105bc0:	31 db                	xor    %ebx,%ebx
  ...
  105bc2:	89 d8                	mov    %ebx,%eax
  105bc4:	83 c4 14             	add    $0x14,%esp
  105bc7:	5b                   	pop    %ebx
  105bc8:	5d                   	pop    %ebp
  105bc9:	c3                   	ret    
...
setupkvm(void)
{
  ...
  // Allocate page directory
  if(!(pgdir = (pde_t *) kalloc()))
  105bd0:	89 c3                	mov    %eax,%ebx
    return 0;
  memset(pgdir, 0, PGSIZE);
  105bd2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  105bd9:	00 
  105bda:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  105be1:	00 
  105be2:	89 04 24             	mov    %eax,(%esp)
  105be5:	e8 56 de ff ff       	call   103a40 <memset>
  if(// Map IO space from 640K to 1Mbyte
  105bea:	b9 00 00 06 00       	mov    $0x60000,%ecx
  105bef:	ba 00 00 0a 00       	mov    $0xa0000,%edx
  105bf4:	89 d8                	mov    %ebx,%eax
  105bf6:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  105bfd:	00 
  105bfe:	c7 04 24 00 00 0a 00 	movl   $0xa0000,(%esp)
  105c05:	e8 86 fe ff ff       	call   105a90 <mappages>
  105c0a:	85 c0                	test   %eax,%eax
  105c0c:	74 b2                	je     105bc0 <setupkvm+0x10>
  105c0e:	b9 00 00 f0 00       	mov    $0xf00000,%ecx
  105c13:	ba 00 00 10 00       	mov    $0x100000,%edx
  105c18:	89 d8                	mov    %ebx,%eax
  105c1a:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  105c21:	00 
  105c22:	c7 04 24 00 00 10 00 	movl   $0x100000,(%esp)
  105c29:	e8 62 fe ff ff       	call   105a90 <mappages>
  105c2e:	85 c0                	test   %eax,%eax
  105c30:	74 8e                	je     105bc0 <setupkvm+0x10>
  105c32:	b9 00 00 00 02       	mov    $0x2000000,%ecx
  105c37:	ba 00 00 00 fe       	mov    $0xfe000000,%edx
  105c3c:	89 d8                	mov    %ebx,%eax
  105c3e:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  105c45:	00 
  105c46:	c7 04 24 00 00 00 fe 	movl   $0xfe000000,(%esp)
  105c4d:	e8 3e fe ff ff       	call   105a90 <mappages>
  105c52:	85 c0                	test   %eax,%eax
  105c54:	0f 85 68 ff ff ff    	jne    105bc2 <setupkvm+0x12>
  105c5a:	e9 61 ff ff ff       	jmp    105bc0 <setupkvm+0x10>
  105c5f:	90                   	nop    
...
kvmalloc(void)
{
  ...
  105c63:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
  105c66:	e8 45 ff ff ff       	call   105bb0 <setupkvm>
  105c6b:	a3 50 78 10 00       	mov    %eax,0x107850
}
  105c70:	c9                   	leave  
  105c71:	c3                   	ret    
  105c72:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
  105c79:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  ...
  105c84:	56                   	push   %esi
  105c85:	53                   	push   %ebx
  105c86:	83 ec 0c             	sub    $0xc,%esp
  char *a = (char *)PGROUNDUP(newsz);
  105c89:	8b 75 10             	mov    0x10(%ebp),%esi
  char *last = PGROUNDDOWN(oldsz - 1);
  105c8c:	8b 7d 0c             	mov    0xc(%ebp),%edi
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  char *a = (char *)PGROUNDUP(newsz);
  105c8f:	81 c6 ff 0f 00 00    	add    $0xfff,%esi
  char *last = PGROUNDDOWN(oldsz - 1);
  105c95:	83 ef 01             	sub    $0x1,%edi
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  char *a = (char *)PGROUNDUP(newsz);
  105c98:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  char *last = PGROUNDDOWN(oldsz - 1);
  105c9e:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(; a <= last; a += PGSIZE){
  105ca4:	39 fe                	cmp    %edi,%esi
  105ca6:	77 37                	ja     105cdf <deallocuvm+0x5f>
    pte_t *pte = walkpgdir(pgdir, a, 0);
  105ca8:	8b 45 08             	mov    0x8(%ebp),%eax
  105cab:	31 c9                	xor    %ecx,%ecx
  105cad:	89 f2                	mov    %esi,%edx
  105caf:	e8 2c fd ff ff       	call   1059e0 <walkpgdir>
    if(pte && (*pte & PTE_P) != 0){
  105cb4:	85 c0                	test   %eax,%eax
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  char *a = (char *)PGROUNDUP(newsz);
  char *last = PGROUNDDOWN(oldsz - 1);
  for(; a <= last; a += PGSIZE){
    pte_t *pte = walkpgdir(pgdir, a, 0);
  105cb6:	89 c3                	mov    %eax,%ebx
    if(pte && (*pte & PTE_P) != 0){
  105cb8:	74 1b                	je     105cd5 <deallocuvm+0x55>
  105cba:	8b 00                	mov    (%eax),%eax
  105cbc:	a8 01                	test   $0x1,%al
  105cbe:	74 15                	je     105cd5 <deallocuvm+0x55>
      uint pa = PTE_ADDR(*pte);
      if(pa == 0)
  105cc0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  105cc5:	74 33                	je     105cfa <deallocuvm+0x7a>
        panic("kfree");
      kfree((void *) pa);
  105cc7:	89 04 24             	mov    %eax,(%esp)
  105cca:	e8 e1 c4 ff ff       	call   1021b0 <kfree>
      *pte = 0;
  105ccf:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  char *a = (char *)PGROUNDUP(newsz);
  char *last = PGROUNDDOWN(oldsz - 1);
  for(; a <= last; a += PGSIZE){
  105cd5:	81 c6 00 10 00 00    	add    $0x1000,%esi
  105cdb:	39 f7                	cmp    %esi,%edi
  105cdd:	73 c9                	jae    105ca8 <deallocuvm+0x28>
  105cdf:	8b 45 10             	mov    0x10(%ebp),%eax
  105ce2:	3b 45 0c             	cmp    0xc(%ebp),%eax
  105ce5:	77 08                	ja     105cef <deallocuvm+0x6f>
      kfree((void *) pa);
      *pte = 0;
    }
  }
...
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  ...
  for(; a <= last; a += PGSIZE){
    ...
    if(pte && (*pte & PTE_P) != 0){
      ...
      if(pa == 0)
        panic("kfree");
  105cfa:	c7 04 24 96 63 10 00 	movl   $0x106396,(%esp)
  105d01:	e8 7a ab ff ff       	call   100880 <panic>
...
freevm(pde_t *pgdir)
{
  ...
  105d13:	56                   	push   %esi
  105d14:	53                   	push   %ebx
  105d15:	83 ec 10             	sub    $0x10,%esp
  105d18:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(!pgdir)
  105d1b:	85 f6                	test   %esi,%esi
  105d1d:	74 59                	je     105d78 <freevm+0x68>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, USERTOP, 0);
  105d1f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  105d26:	00 
  105d27:	31 db                	xor    %ebx,%ebx
  105d29:	c7 44 24 04 00 00 0a 	movl   $0xa0000,0x4(%esp)
  105d30:	00 
  105d31:	89 34 24             	mov    %esi,(%esp)
  105d34:	e8 47 ff ff ff       	call   105c80 <deallocuvm>
  105d39:	eb 10                	jmp    105d4b <freevm+0x3b>
  105d3b:	90                   	nop    
  105d3c:	8d 74 26 00          	lea    0x0(%esi),%esi
  for(i = 0; i < NPDENTRIES; i++){
  105d40:	83 c3 01             	add    $0x1,%ebx
  105d43:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
  105d49:	74 1f                	je     105d6a <freevm+0x5a>
    if(pgdir[i] & PTE_P)
  105d4b:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
  105d4e:	a8 01                	test   $0x1,%al
  105d50:	74 ee                	je     105d40 <freevm+0x30>
      kfree((void *) PTE_ADDR(pgdir[i]));
  105d52:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  uint i;
  ...
  deallocuvm(pgdir, USERTOP, 0);
  for(i = 0; i < NPDENTRIES; i++){
  105d57:	83 c3 01             	add    $0x1,%ebx
    if(pgdir[i] & PTE_P)
      kfree((void *) PTE_ADDR(pgdir[i]));
  105d5a:	89 04 24             	mov    %eax,(%esp)
  105d5d:	e8 4e c4 ff ff       	call   1021b0 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, USERTOP, 0);
  for(i = 0; i < NPDENTRIES; i++){
  105d62:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
  105d68:	75 e1                	jne    105d4b <freevm+0x3b>
    if(pgdir[i] & PTE_P)
      kfree((void *) PTE_ADDR(pgdir[i]));
  }
  kfree((void *) pgdir);
  105d6a:	89 75 08             	mov    %esi,0x8(%ebp)
}
  105d6d:	83 c4 10             	add    $0x10,%esp
  105d70:	5b                   	pop    %ebx
  105d71:	5e                   	pop    %esi
  105d72:	5d                   	pop    %ebp
  deallocuvm(pgdir, USERTOP, 0);
  ...
  kfree((void *) pgdir);
  105d73:	e9 38 c4 ff ff       	jmp    1021b0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(!pgdir)
    panic("freevm: no pgdir");
  105d78:	c7 04 24 1c 6a 10 00 	movl   $0x106a1c,(%esp)
  105d7f:	e8 fc aa ff ff       	call   100880 <panic>
  105d84:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  105d8a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
copyuvm(pde_t *pgdir, uint sz)
{
  ...
  105d94:	56                   	push   %esi
  105d95:	53                   	push   %ebx
  105d96:	83 ec 1c             	sub    $0x1c,%esp
  pde_t *d = setupkvm();
  105d99:	e8 12 fe ff ff       	call   105bb0 <setupkvm>
  pte_t *pte;
  uint pa, i;
  char *mem;

  if(!d) return 0;
  105d9e:	85 c0                	test   %eax,%eax
// Given a parent process's page table, create a copy
// of it for a child.
pde_t*
copyuvm(pde_t *pgdir, uint sz)
{
  ...
  if(!d) return 0;
  105da3:	0f 84 84 00 00 00    	je     105e2d <copyuvm+0x9d>
  for(i = 0; i < sz; i += PGSIZE){
  105da9:	8b 45 0c             	mov    0xc(%ebp),%eax
  105dac:	85 c0                	test   %eax,%eax
  105dae:	74 7d                	je     105e2d <copyuvm+0x9d>
  105db0:	31 ff                	xor    %edi,%edi
  105db2:	eb 43                	jmp    105df7 <copyuvm+0x67>
    if(!(*pte & PTE_P))
  ...
  105db4:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  105dba:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  105dc1:	00 
  105dc2:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  105dc6:	89 04 24             	mov    %eax,(%esp)
  105dc9:	e8 12 dd ff ff       	call   103ae0 <memmove>
    if(!mappages(d, (void *)i, PGSIZE, PADDR(mem), PTE_W|PTE_U))
  105dce:	8b 45 f0             	mov    -0x10(%ebp),%eax
  105dd1:	b9 00 10 00 00       	mov    $0x1000,%ecx
  105dd6:	89 fa                	mov    %edi,%edx
  105dd8:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
  105ddf:	00 
  105de0:	89 34 24             	mov    %esi,(%esp)
  105de3:	e8 a8 fc ff ff       	call   105a90 <mappages>
  105de8:	85 c0                	test   %eax,%eax
  105dea:	74 2f                	je     105e1b <copyuvm+0x8b>
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if(!d) return 0;
  for(i = 0; i < sz; i += PGSIZE){
  105dec:	81 c7 00 10 00 00    	add    $0x1000,%edi
  105df2:	39 7d 0c             	cmp    %edi,0xc(%ebp)
  105df5:	76 36                	jbe    105e2d <copyuvm+0x9d>
    if(!(pte = walkpgdir(pgdir, (void *)i, 0)))
  105df7:	8b 45 08             	mov    0x8(%ebp),%eax
  105dfa:	31 c9                	xor    %ecx,%ecx
  105dfc:	89 fa                	mov    %edi,%edx
  105dfe:	e8 dd fb ff ff       	call   1059e0 <walkpgdir>
  105e03:	85 c0                	test   %eax,%eax
  105e05:	74 31                	je     105e38 <copyuvm+0xa8>
      panic("copyuvm: pte should exist\n");
    if(!(*pte & PTE_P))
  105e07:	8b 18                	mov    (%eax),%ebx
  105e09:	f6 c3 01             	test   $0x1,%bl
  105e0c:	74 36                	je     105e44 <copyuvm+0xb4>
  105e0e:	66 90                	xchg   %ax,%ax
      panic("copyuvm: page not present\n");
    pa = PTE_ADDR(*pte);
    if(!(mem = kalloc()))
  105e10:	e8 5b c3 ff ff       	call   102170 <kalloc>
  105e15:	85 c0                	test   %eax,%eax
  105e17:	89 c6                	mov    %eax,%esi
  105e19:	75 99                	jne    105db4 <copyuvm+0x24>
      goto bad;
  }
  return d;
...
bad:
  ...
  105e21:	e8 ea fe ff ff       	call   105d10 <freevm>
  105e26:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  return 0;
}
  105e2d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  105e30:	83 c4 1c             	add    $0x1c,%esp
  105e33:	5b                   	pop    %ebx
  105e34:	5e                   	pop    %esi
  105e35:	5f                   	pop    %edi
  105e36:	5d                   	pop    %ebp
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if(!(pte = walkpgdir(pgdir, (void *)i, 0)))
      panic("copyuvm: pte should exist\n");
  105e38:	c7 04 24 2d 6a 10 00 	movl   $0x106a2d,(%esp)
  105e3f:	e8 3c aa ff ff       	call   100880 <panic>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present\n");
  105e44:	c7 04 24 48 6a 10 00 	movl   $0x106a48,(%esp)
  105e4b:	e8 30 aa ff ff       	call   100880 <panic>
...
allocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  105e53:	89 e5                	mov    %esp,%ebp
  105e55:	57                   	push   %edi
  105e56:	56                   	push   %esi
  105e57:	53                   	push   %ebx
  105e58:	83 ec 0c             	sub    $0xc,%esp
  if(newsz > USERTOP)
  105e5b:	81 7d 10 00 00 0a 00 	cmpl   $0xa0000,0x10(%ebp)
  105e62:	0f 87 96 00 00 00    	ja     105efe <allocuvm+0xae>
    return 0;
  char *a = (char *)PGROUNDUP(oldsz);
  105e68:	8b 75 0c             	mov    0xc(%ebp),%esi
  char *last = PGROUNDDOWN(newsz - 1);
  105e6b:	8b 7d 10             	mov    0x10(%ebp),%edi
int
allocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  if(newsz > USERTOP)
    return 0;
  char *a = (char *)PGROUNDUP(oldsz);
  105e6e:	81 c6 ff 0f 00 00    	add    $0xfff,%esi
  char *last = PGROUNDDOWN(newsz - 1);
  105e74:	83 ef 01             	sub    $0x1,%edi
int
allocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  if(newsz > USERTOP)
  ...
  char *last = PGROUNDDOWN(newsz - 1);
  105e7d:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for (; a <= last; a += PGSIZE){
  105e83:	39 fe                	cmp    %edi,%esi
  105e85:	76 45                	jbe    105ecc <allocuvm+0x7c>
  105e87:	eb 7d                	jmp    105f06 <allocuvm+0xb6>
  105e89:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    if(mem == 0){
    ...
    memset(mem, 0, PGSIZE);
  105e90:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  105e97:	00 
  105e98:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  105e9f:	00 
  105ea0:	89 04 24             	mov    %eax,(%esp)
  105ea3:	e8 98 db ff ff       	call   103a40 <memset>
    mappages(pgdir, a, PGSIZE, PADDR(mem), PTE_W|PTE_U);
  105ea8:	89 f2                	mov    %esi,%edx
  105eaa:	b9 00 10 00 00       	mov    $0x1000,%ecx
  105eaf:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
  105eb6:	00 
{
  if(newsz > USERTOP)
    return 0;
  ...
  char *last = PGROUNDDOWN(newsz - 1);
  for (; a <= last; a += PGSIZE){
  105eb7:	81 c6 00 10 00 00    	add    $0x1000,%esi
      cprintf("allocuvm out of memory\n");
      deallocuvm(pgdir, newsz, oldsz);
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, a, PGSIZE, PADDR(mem), PTE_W|PTE_U);
  105ebd:	89 1c 24             	mov    %ebx,(%esp)
  105ec0:	8b 45 08             	mov    0x8(%ebp),%eax
  105ec3:	e8 c8 fb ff ff       	call   105a90 <mappages>
{
  if(newsz > USERTOP)
    return 0;
  char *a = (char *)PGROUNDUP(oldsz);
  char *last = PGROUNDDOWN(newsz - 1);
  for (; a <= last; a += PGSIZE){
  105ec8:	39 f7                	cmp    %esi,%edi
  105eca:	72 3a                	jb     105f06 <allocuvm+0xb6>
    char *mem = kalloc();
  105ecc:	e8 9f c2 ff ff       	call   102170 <kalloc>
    if(mem == 0){
  ...
  for (; a <= last; a += PGSIZE){
    char *mem = kalloc();
  105ed3:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
  105ed5:	75 b9                	jne    105e90 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
  105ed7:	c7 04 24 63 6a 10 00 	movl   $0x106a63,(%esp)
  105ede:	e8 dd a5 ff ff       	call   1004c0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
  105ee3:	8b 45 0c             	mov    0xc(%ebp),%eax
  105ee6:	89 44 24 08          	mov    %eax,0x8(%esp)
  105eea:	8b 45 10             	mov    0x10(%ebp),%eax
  105eed:	89 44 24 04          	mov    %eax,0x4(%esp)
  105ef1:	8b 45 08             	mov    0x8(%ebp),%eax
  105ef4:	89 04 24             	mov    %eax,(%esp)
  105ef7:	e8 84 fd ff ff       	call   105c80 <deallocuvm>
  105efc:	31 c0                	xor    %eax,%eax
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, a, PGSIZE, PADDR(mem), PTE_W|PTE_U);
  }
  ...
  105f09:	3b 45 0c             	cmp    0xc(%ebp),%eax
  105f0c:	73 f0                	jae    105efe <allocuvm+0xae>
  ...
  105f17:	5d                   	pop    %ebp
  105f18:	c3                   	ret    
  105f19:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
loaduvm(pde_t *pgdir, char *addr, struct inode *ip, uint offset, uint sz)
{
  ...
  105f24:	56                   	push   %esi
  105f25:	53                   	push   %ebx
  105f26:	83 ec 1c             	sub    $0x1c,%esp
  105f29:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint)addr % PGSIZE != 0)
  105f2c:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
  105f33:	0f 85 82 00 00 00    	jne    105fbb <loaduvm+0x9b>
    panic("loaduvm: addr must be page aligned\n");
  105f39:	31 f6                	xor    %esi,%esi
  for(i = 0; i < sz; i += PGSIZE){
  105f3b:	85 ff                	test   %edi,%edi
  105f3d:	75 0c                	jne    105f4b <loaduvm+0x2b>
  105f3f:	eb 61                	jmp    105fa2 <loaduvm+0x82>
  105f41:	81 c6 00 10 00 00    	add    $0x1000,%esi
  105f47:	39 f7                	cmp    %esi,%edi
  105f49:	76 57                	jbe    105fa2 <loaduvm+0x82>
    if(!(pte = walkpgdir(pgdir, addr+i, 0)))
  105f4b:	8b 55 0c             	mov    0xc(%ebp),%edx
  105f4e:	31 c9                	xor    %ecx,%ecx
  105f50:	8b 45 08             	mov    0x8(%ebp),%eax
  105f53:	01 f2                	add    %esi,%edx
  105f55:	e8 86 fa ff ff       	call   1059e0 <walkpgdir>
  105f5a:	85 c0                	test   %eax,%eax
  105f5c:	74 51                	je     105faf <loaduvm+0x8f>
      panic("loaduvm: address should exist\n");
    pa = PTE_ADDR(*pte);
  105f5e:	89 fb                	mov    %edi,%ebx
  105f60:	8b 10                	mov    (%eax),%edx
  105f62:	29 f3                	sub    %esi,%ebx
    if(sz - i < PGSIZE) n = sz - i;
  105f64:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
  105f6a:	76 05                	jbe    105f71 <loaduvm+0x51>
  105f6c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    else n = PGSIZE;
    if(readi(ip, (char *)pa, offset+i, n) != n)
  105f71:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  105f75:	8b 4d 14             	mov    0x14(%ebp),%ecx
  105f78:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  105f7e:	89 54 24 04          	mov    %edx,0x4(%esp)
  105f82:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
  105f85:	89 44 24 08          	mov    %eax,0x8(%esp)
  105f89:	8b 45 10             	mov    0x10(%ebp),%eax
  105f8c:	89 04 24             	mov    %eax,(%esp)
  105f8f:	e8 cc b4 ff ff       	call   101460 <readi>
  105f94:	39 d8                	cmp    %ebx,%eax
  105f96:	74 a9                	je     105f41 <loaduvm+0x21>
      return 0;
  }
  return 1;
}
  105f98:	83 c4 1c             	add    $0x1c,%esp
    if(!(pte = walkpgdir(pgdir, addr+i, 0)))
      panic("loaduvm: address should exist\n");
    pa = PTE_ADDR(*pte);
    if(sz - i < PGSIZE) n = sz - i;
  ...
  if((uint)addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned\n");
  for(i = 0; i < sz; i += PGSIZE){
  105fa5:	b8 01 00 00 00       	mov    $0x1,%eax
    else n = PGSIZE;
    if(readi(ip, (char *)pa, offset+i, n) != n)
      return 0;
  }
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if(!(pte = walkpgdir(pgdir, addr+i, 0)))
      panic("loaduvm: address should exist\n");
  105faf:	c7 04 24 b4 6a 10 00 	movl   $0x106ab4,(%esp)
  105fb6:	e8 c5 a8 ff ff       	call   100880 <panic>
{
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint)addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned\n");
  105fbb:	c7 04 24 90 6a 10 00 	movl   $0x106a90,(%esp)
  105fc2:	e8 b9 a8 ff ff       	call   100880 <panic>
  105fc7:	89 f6                	mov    %esi,%esi
  105fc9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
switchuvm(struct proc *p)
{
  ...
  105fd3:	53                   	push   %ebx
  105fd4:	83 ec 04             	sub    $0x4,%esp
  105fd7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
  105fda:	e8 11 d9 ff ff       	call   1038f0 <pushcli>

  // Setup TSS
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
  105fdf:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
  105fe5:	8d 48 08             	lea    0x8(%eax),%ecx
  105fe8:	89 ca                	mov    %ecx,%edx
  105fea:	c1 ea 18             	shr    $0x18,%edx
  105fed:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  105ff3:	89 ca                	mov    %ecx,%edx
  105ff5:	c1 ea 10             	shr    $0x10,%edx
  105ff8:	c6 80 a5 00 00 00 99 	movb   $0x99,0xa5(%eax)
  105fff:	88 90 a4 00 00 00    	mov    %dl,0xa4(%eax)
  106005:	c6 80 a6 00 00 00 40 	movb   $0x40,0xa6(%eax)
  10600c:	66 89 88 a2 00 00 00 	mov    %cx,0xa2(%eax)
  106013:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
  10601a:	67 00 
  cpu->gdt[SEG_TSS].s = 0;
  10601c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
  106022:	80 a0 a5 00 00 00 ef 	andb   $0xef,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
  106029:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
  10602f:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
  106035:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  10603b:	8b 50 08             	mov    0x8(%eax),%edx
  10603e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
  106044:	81 c2 00 10 00 00    	add    $0x1000,%edx
  10604a:	89 50 0c             	mov    %edx,0xc(%eax)
}
...
ltr(ushort sel)
{
  ...
  10604d:	b8 30 00 00 00       	mov    $0x30,%eax
  106052:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);

  if(p->pgdir == 0)
  106055:	8b 43 04             	mov    0x4(%ebx),%eax
  106058:	85 c0                	test   %eax,%eax
  10605a:	74 0d                	je     106069 <switchuvm+0x99>
}
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
  10605c:	0f 22 d8             	mov    %eax,%cr3
    panic("switchuvm: no pgdir\n");

  lcr3(PADDR(p->pgdir));  // switch to new address space
  popcli();
}
  10605f:	83 c4 04             	add    $0x4,%esp
  106062:	5b                   	pop    %ebx
  106063:	5d                   	pop    %ebp
  ...
  lcr3(PADDR(p->pgdir));  // switch to new address space
  popcli();
  106064:	e9 c7 d8 ff ff       	jmp    103930 <popcli>
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
  ltr(SEG_TSS << 3);
  ...
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir\n");
  106069:	c7 04 24 7b 6a 10 00 	movl   $0x106a7b,(%esp)
  106070:	e8 0b a8 ff ff       	call   100880 <panic>
  106075:	8d 74 26 00          	lea    0x0(%esi),%esi
  106079:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
ksegment(void)
{
  ...
  c = &cpus[cpunum()];
  106086:	e8 35 c3 ff ff       	call   1023c0 <cpunum>
  10608b:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
  106091:	05 a0 aa 10 00       	add    $0x10aaa0,%eax
  ...
  106096:	8d 88 b4 00 00 00    	lea    0xb4(%eax),%ecx
  10609c:	89 ca                	mov    %ecx,%edx
  10609e:	c1 ea 18             	shr    $0x18,%edx
  1060a1:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)
  1060a7:	89 ca                	mov    %ecx,%edx
  1060a9:	c1 ea 10             	shr    $0x10,%edx
  1060ac:	88 90 8c 00 00 00    	mov    %dl,0x8c(%eax)
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
  pd[1] = (uint)p;
  1060b2:	8d 50 70             	lea    0x70(%eax),%edx
  // Map virtual addresses to linear addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  ...
  1060b5:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  1060b9:	c6 40 7e cf          	movb   $0xcf,0x7e(%eax)
  1060bd:	c6 40 7d 9a          	movb   $0x9a,0x7d(%eax)
  1060c1:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
  1060c5:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
  1060cb:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  1060d1:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  1060d8:	c6 80 86 00 00 00 cf 	movb   $0xcf,0x86(%eax)
  1060df:	c6 80 85 00 00 00 92 	movb   $0x92,0x85(%eax)
  1060e6:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
  1060ed:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
  1060f4:	00 00 
  1060f6:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
  1060fd:	ff ff 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  1060ff:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  106106:	c6 80 96 00 00 00 cf 	movb   $0xcf,0x96(%eax)
  10610d:	c6 80 95 00 00 00 fa 	movb   $0xfa,0x95(%eax)
  106114:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
  10611b:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
  106122:	00 00 
  106124:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
  10612b:	ff ff 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
  10612d:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)
  106134:	c6 80 9e 00 00 00 cf 	movb   $0xcf,0x9e(%eax)
  10613b:	c6 80 9d 00 00 00 f2 	movb   $0xf2,0x9d(%eax)
  106142:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
  106149:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
  106150:	00 00 
  106152:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
  106159:	ff ff 

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
  10615b:	c6 80 8e 00 00 00 c0 	movb   $0xc0,0x8e(%eax)
  106162:	c6 80 8d 00 00 00 92 	movb   $0x92,0x8d(%eax)
  106169:	66 89 88 8a 00 00 00 	mov    %cx,0x8a(%eax)
  106170:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
  106177:	00 00 
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
  106179:	66 c7 45 fa 37 00    	movw   $0x37,-0x6(%ebp)
  pd[1] = (uint)p;
  10617f:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
  106183:	c1 ea 10             	shr    $0x10,%edx
  106186:	66 89 55 fe          	mov    %dx,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
  10618a:	8d 55 fa             	lea    -0x6(%ebp),%edx
  10618d:	0f 01 12             	lgdtl  (%edx)
}
...
loadgs(ushort v)
{
  ...
  106190:	ba 18 00 00 00       	mov    $0x18,%edx
  106195:	8e ea                	mov    %edx,%gs
  ...
  cpu = c;
  proc = 0;
  106197:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
  10619e:	00 00 00 00 
  ...
  // Initialize cpu-local storage.
  cpu = c;
  1061a2:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
}
  1061a8:	c9                   	leave  
  1061a9:	c3                   	ret    
