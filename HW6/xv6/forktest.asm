...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  39:	c7 44 24 04 c8 03 00 	movl   $0x3c8,0x4(%esp)
  40:	00 
  ...
  50:	74 68                	je     ba <forktest+0x8a>
{
  ...
  8c:	c7 44 24 04 fa 03 00 	movl   $0x3fa,0x4(%esp)
  93:	00 
  ...
  for(; n > 0; n--){
    if(wait() < 0){
      printf(1, "wait stopped early\n");
  a6:	c7 44 24 04 d3 03 00 	movl   $0x3d3,0x4(%esp)
  ad:	00 
  ...
  c6:	00 
  c7:	c7 44 24 04 08 04 00 	movl   $0x408,0x4(%esp)
  ce:	00 
  ...
  if(wait() != -1){
    printf(1, "wait got too many\n");
  e0:	c7 44 24 04 e7 03 00 	movl   $0x3e7,0x4(%esp)
  e7:	00 
